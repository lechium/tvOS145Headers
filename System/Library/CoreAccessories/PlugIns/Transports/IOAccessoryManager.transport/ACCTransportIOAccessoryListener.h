...
@interface ACCTransportIOAccessoryListener : NSObject {
	...
	IONotificationPortRef _ioAccessoryConfigStreamClassNotify;
	unsigned _ioAccessoryConfigStreamClassIteratorArrived;
	unsigned _ioAccessoryConfigStreamClassIteratorTerminated;
...
-(void)_ioAccessoryConfigStreamAttached:(unsigned)arg1 ;
-(void)_ioAccessoryConfigStreamTerminated:(unsigned)arg1 ;
@end
