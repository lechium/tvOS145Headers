...
#import <libobjc.A.dylib/ACCTransportIOAccessoryConfigStreamProtocol.h>
...
-(void)IOAccessoryConfigStreamMessageArrived:(id)arg1 endpointUUID:(id)arg2 ;
-(void)IOAccessoryConfigStreamUpdateAccesssoryInfo:(id)arg1 ;
