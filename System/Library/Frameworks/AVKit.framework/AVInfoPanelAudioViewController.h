...
@protocol AVInfoPanelLanguageDelegate, PBSMediaRemoteServiceInterface;
@class AVInfoPanelAudioCollectionViewController, AVInfoPanelAudioRoutesCollectionViewController, NSLayoutConstraint, AVObservationController, AVSpeakerManager, NSMutableDictionary, NSObject, NSString;
...
@interface AVInfoPanelAudioViewController : AVInfoPanelContentViewController <AVInfoPanelMediaOptionSelectionDelegate, AVInfoPanelAudioRouteSelectionDelegate> {
	...
	NSObject*<PBSMediaRemoteServiceInterface> _pbsMediaRemoteProxy;
...
@property (nonatomic,readonly) NSObject*<PBSMediaRemoteServiceInterface> pbsMediaRemoteProxy;              //@synthesize pbsMediaRemoteProxy=_pbsMediaRemoteProxy - In the implementation block
...
-(NSObject*<PBSMediaRemoteServiceInterface>)pbsMediaRemoteProxy;
@end
