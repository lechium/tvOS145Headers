...
@interface AVInternalPlaybackOptions : NSObject {
	...
	/*^block*/id _skipToNextItem;
	/*^block*/id _skipToPreviousItem;
...
@property (nonatomic,copy) id skipToNextItem;                                                                  //@synthesize skipToNextItem=_skipToNextItem - In the implementation block
@property (nonatomic,copy) id skipToPreviousItem;                                                              //@synthesize skipToPreviousItem=_skipToPreviousItem - In the implementation block
...
-(void)setSkipToNextItem:(id)arg1 ;
-(void)setSkipToPreviousItem:(id)arg1 ;
