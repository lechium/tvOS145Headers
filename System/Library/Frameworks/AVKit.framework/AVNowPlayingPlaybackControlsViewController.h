...
@interface AVNowPlayingPlaybackControlsViewController : AVPlaybackControlsViewController <AVChannelInterstitialContainerDelegate, AVNowPlayingFrameSource, AVFrameSetDelegate, AVInfoPanelNavigationDelegate, AVInfoPanelSubtitlesDelegate, AVInfoPanelLanguageDelegate, AVInfoPanelViewControllerDelegate, UIViewControllerTransitioningDelegate, AVTouchEventForwardingProtocol> {
	...
	BOOL _isPlaybackControlsStateLocked;
	double _lastAccumulatedDistanceRotary;
	...
	AVDigitizerTouchGestureRecognizer* _digitizerTouchGestureRecognizer;
...
@property (nonatomic,retain) _UIRotaryGestureRecognizer * rotaryGestureRecognizer;                                        //@synthesize rotaryGestureRecognizer=_rotaryGestureRecognizer - In the implementation block
@property (nonatomic,retain) AVDigitizerTouchGestureRecognizer * digitizerTouchGestureRecognizer;                         //@synthesize digitizerTouchGestureRecognizer=_digitizerTouchGestureRecognizer - In the implementation block
...
-(void)setDigitizerTouchGestureRecognizer:(AVDigitizerTouchGestureRecognizer *)arg1 ;
...
-(void)clearHintIfMatching:(long long)arg1 ;
-(void)_clearHintIfMatchingNumber:(id)arg1 ;
-(void)clearHintAfterDelay;
-(void)showHintBriefly:(long long)arg1 ;
-(void)updateHintsForEvent:(id)arg1 ;
-(void)setShouldShowInfoHint:(BOOL)arg1 ;
-(void)_updateShowInfoHintForScrubbingState;
...
-(BOOL)shouldShowLeftRightTouchHints;
...
-(BOOL)_shouldTransportBarScrub;
-(void)setRotaryGestureRecognizer:(_UIRotaryGestureRecognizer *)arg1 ;
-(void)rotaryGestureWillBegin:(id)arg1 ;
-(void)rotaryGestureFailedToBegin:(id)arg1 ;
-(void)rotaryGestureDetected:(id)arg1 ;
-(void)_cancelActiveRotaryGesture;
...
-(void)_skipToNextItemIfEnabled;
-(void)_skipToPreviousItemIfEnabled;
...
-(void)_handleLeftRightTouchPressGesture:(id)arg1 ;
...
-(void)_lockPlaybackControlsState;
-(void)_unlockPlaybackControlsState;
...
-(_UIRotaryGestureRecognizer *)rotaryGestureRecognizer;
-(AVDigitizerTouchGestureRecognizer *)digitizerTouchGestureRecognizer;
