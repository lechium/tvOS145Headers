...
@class UIView, UIVisualEffectView, UIImageView, NSLayoutConstraint, UIDynamicAnimator, UIDynamicItemBehavior, UIAttachmentBehavior, UIPushBehavior, AVWheelScrubberView, UIViewPropertyAnimator, _AVPlayerLayerThumbnailView, AVGradientView, UILabel, AVAnimatingLabel, AVSpinnerView, _AVBlockedView, AVPlayer, AVPlayerItem, UIImage, _UIVisualEffectBackdropView, NSDate, NSString, NSArray, AVTransportBarMask, AVDurationTimeFormatter, NSDateFormatter, AVFrameSet;
...
@interface AVNowPlayingTransportBar : UIView {
	...
	NSLayoutConstraint* _scrubNeedleBottom;
	...
	CGPoint _initialScrubGestureInfo;
	CGPoint _lastScrubGestureInfo;
	UIView* _rotaryElapsedTimeMarker;
	AVWheelScrubberView* _rotaryScrubNeedle;
	UIView* _rotaryScrubCenterPunchout;
	double _rotaryScrubNeedleLabelOffset;
	NSLayoutConstraint* _layoutConstraintElapsedTimeLabelTopFromRotaryNeedle;
...
@property (assign,nonatomic) long long scrubMode;                                                                              //@synthesize scrubMode=_scrubMode - In the implementation block
...
-(void)_updateRotaryNeedleElapsedTimeLabelOffset;
-(void)_updateRotaryFingerPositionWithScrubInfo:(CGPoint)arg1 ;
-(CGAffineTransform)_rotaryTransformForInitialScrubInfo:(CGPoint)arg1 currentInfo:(CGPoint)arg2 ;
-(void)scrubBegan;
-(void)scrubMovedWithTranslation:(double)arg1 velocity:(double)arg2 enableSnapping:(BOOL)arg3 gestureInfo:(CGPoint)arg4 ;
-(void)scrubEndedWithTranslation:(double)arg1 velocity:(double)arg2 ;
-(void)_stopScrubNeedleMomentum;
-(void)setHint:(long long)arg1 ;
-(void)setScrubMode:(long long)arg1 ;
-(void)setScrubMode:(long long)arg1 gestureInfo:(CGPoint)arg2 ;
