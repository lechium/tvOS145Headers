...
@class UIWindow, NSString, AVKeyValueObserverCollection, AVDelegateManager, MRPlayerPath, AVMediaRemoteManager, UIView, NSArray, AVInternalPlaybackOptions, AVControlItem, AVxCustomOverlayHostViewController, AVContentRestrictionsViewController, AVContentProposalViewController, AVPlayer, NSTimer, NSNumber, AVPlayerController, AVGestureRecognizerDelegate, AVDigitizerTouchGestureRecognizer, AVScrubbingPanGestureRecognizer, AVNonDigitizerTapRecognizer, AVPermissiveSwipeGestureRecognizer, _UIRotaryGestureRecognizer, UIDigitizerTapGestureRecognizer, UIDigitizerLongPressGestureRecognizer, UITapGestureRecognizer, NSURL, AVPlayerViewControllerTransition, UILayoutGuide, NSLayoutConstraint, NSObject, UIAlertController, NSDictionary, AVGlobalUserSettings, AVPictureInPictureController, AVBehaviorStorage, AVPlayerLayerView, AVNowPlayingPlaybackControlsViewController, UIViewController, AVTransportBarViewController;
...
@interface AVPlayerViewController : UIViewController <AVPictureInPictureContentSource, AVPictureInPictureControllerDelegate, PBSPictureInPicturePlaybackDelegate, _AVFocusContainerDelegate> {
	...
	AVGlobalUserSettings* _globalUserSettings;
...
@property (nonatomic,readonly) AVInternalPlaybackOptions * _playbackOptions;                                                                                                                             //@synthesize playbackOptions=_playbackOptions - In the implementation block
