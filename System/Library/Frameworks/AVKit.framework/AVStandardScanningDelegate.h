...
@property (assign,nonatomic) BOOL hasIFrames;                                                      //@synthesize hasIFrames=_hasIFrames - In the implementation block
@property (assign,getter=isWaitingForPreroll,nonatomic) BOOL waitingForPreroll;                    //@synthesize waitingForPreroll=_waitingForPreroll - In the implementation block
...
-(BOOL)hasIFrames;
-(void)setHasIFrames:(BOOL)arg1 ;
-(BOOL)isWaitingForPreroll;
-(void)setWaitingForPreroll:(BOOL)arg1 ;
