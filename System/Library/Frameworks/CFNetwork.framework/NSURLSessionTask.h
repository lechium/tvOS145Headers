...
@property (assign) BOOL _proxyHandshakePending;                                                          //@synthesize proxyHandshakePending=_proxyHandshakePending - In the implementation block
...
@property (assign) BOOL _assumesHTTP3Capable;                                                            //@synthesize assumesHTTP3Capable=_assumesHTTP3Capable - In the implementation block
