...
-(void)_setPreAuthorizeDiagnosisKeysEnabled:(BOOL)arg1 region:(id)arg2 metadata:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)setPreAuthorizeDiagnosisKeysEnabled:(BOOL)arg1 region:(id)arg2 metadata:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)didEnterLegalConsentPage:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)sendChaffTestVerificationRequestForRegion:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)setDeveloperServerConfiguration:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)verifyTextMessage:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
