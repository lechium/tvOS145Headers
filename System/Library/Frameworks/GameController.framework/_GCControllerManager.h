...
@property (assign,nonatomic) BOOL shouldMonitorBackgroundEvents;                                 //@synthesize shouldMonitorBackgroundEvents=_shouldMonitorBackgroundEvents - In the implementation block
