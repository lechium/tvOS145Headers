...
@property (assign,nonatomic) BOOL supportsAudioReturnChannel;                                              //@synthesize supportsAudioReturnChannel=_supportsAudioReturnChannel - In the implementation block
...
-(void)updateShouldProcessTransactionRemovalWithValue:(BOOL)arg1 completion:(/*^block*/id)arg2 ;
-(BOOL)isBridged;
