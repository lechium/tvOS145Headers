...
-(BOOL)_handleActionSetRenameFromPayload:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_addAction:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(BOOL)_doAddAction:(id)arg1 uuid:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(BOOL)_addActionFromResponse:(id)arg1 withAction:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)_removeAction:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(BOOL)_doRemoveActionWithUUID:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(BOOL)_handleActionRemovedFromPayload:(id)arg1 completion:(/*^block*/id)arg2 ;
-(BOOL)_handleActionUpdatedFromResponse:(id)arg1 completion:(/*^block*/id)arg2 ;
