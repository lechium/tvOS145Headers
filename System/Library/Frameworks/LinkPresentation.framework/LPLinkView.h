...
@class LPLinkMetadata, NSArray, LPTheme, NSMutableArray, UIView, LPCaptionBarPresentationProperties, LPCaptionButtonPresentationProperties, LPImage, LPImagePresentationProperties, NSString, LPVideo, UIColor, LPInlineMediaPlaybackInformation, LPLinkViewComponents, LPAnimationMaskView, NSURL;
...
@property (assign,setter=_setAllowsOpeningSensitiveURLs:,nonatomic) BOOL _allowsOpeningSensitiveURLs;                                                //@synthesize allowsOpeningSensitiveURLs=_allowsOpeningSensitiveURLs - In the implementation block
