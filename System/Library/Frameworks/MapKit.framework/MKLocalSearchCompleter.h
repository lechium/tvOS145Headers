...
@property (getter=_shouldEnableGrayscaleHighlighting,nonatomic,readonly) BOOL shouldEnableGrayscaleHighlighting;                                                                         //@synthesize shouldEnableGrayscaleHighlighting=_shouldEnableGrayscaleHighlighting - In the implementation block
@property (getter=_shouldUseDistanceFeatureServerResults,nonatomic,readonly) BOOL shouldUseDistanceFeatureServerResults;                                                                 //@synthesize shouldUseDistanceFeatureServerResults=_shouldUseDistanceFeatureServerResults - In the implementation block
