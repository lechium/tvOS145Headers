...
@property (assign,nonatomic) BOOL sortUsingAllowedItemIdentifiers;                        //@synthesize sortUsingAllowedItemIdentifiers=_sortUsingAllowedItemIdentifiers - In the implementation block
