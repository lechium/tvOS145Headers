...
typedef struct {
	SCD_Struct_MT19 field1;
	SCD_Struct_MT19 field2;
} SCD_Struct_MT44;
...
typedef struct MTLRenderPassDescriptorPrivate {
	...
	SCD_Struct_MT79 customSamplePositions[4];
