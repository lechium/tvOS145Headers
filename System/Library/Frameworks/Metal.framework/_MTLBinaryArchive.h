...
+(BOOL)deserializeBinaryArchiveHeader:(SCD_Struct_MT16*)arg1 fileData:(id)arg2 device:(id)arg3 ;
+(BOOL)deserializeBinaryArchiveDescriptorMachO:(SCD_Struct_MT16*)arg1 fileData:(id)arg2 ;
...
-(id)materializeFromFileOffset:(unsigned long long)arg1 hash:(SCD_Struct_MT8*)arg2 ;
...
-(void)materializeAll;
-(id)materializeFromHash:(SCD_Struct_MT8*)arg1 ;
