...
@property (assign,nonatomic) BOOL hasQuicExperimentEnabled; 
@property (assign,nonatomic) BOOL quicExperimentEnabled;                                  //@synthesize quicExperimentEnabled=_quicExperimentEnabled - In the implementation block
