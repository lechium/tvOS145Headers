...
@property (assign,nonatomic) BOOL requiresFirmwareUpdate;                                         //@synthesize requiresFirmwareUpdate=_requiresFirmwareUpdate - In the implementation block
...
-(void)_updateRequiresFirmwareUpdateState;
-(BOOL)_deviceRequiresFirmwareUpdate;
-(void)setRequiresFirmwareUpdate:(BOOL)arg1 ;
