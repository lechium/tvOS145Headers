...
-(id)initWithFrame:(CGRect)arg1 processPool:(NakedRef<WebKit::WebProcessPool>*)arg2 configuration:(Ref<API::PageConfiguration, WTF::RawPtrTraits<API::PageConfiguration>>*)arg3 webView:(id)arg4 ;
...
-(void)didUpdateVisibleRect:(CGRect)arg1 unobscuredRect:(CGRect)arg2 contentInsets:(UIEdgeInsets)arg3 unobscuredRectInScrollViewCoordinates:(CGRect)arg4 obscuredInsets:(UIEdgeInsets)arg5 unobscuredSafeAreaInsets:(UIEdgeInsets)arg6 inputViewBounds:(CGRect)arg7 scale:(double)arg8 minimumScale:(double)arg9 viewStability:(OptionSet<WebKit::ViewStabilityFlag>)arg10 enclosedInScrollableAncestorView:(BOOL)arg11 sendEvenIfUnchanged:(BOOL)arg12 ;
...
-(void)_showContactPicker:(const ContactsRequestDataRef)arg1 completionHandler:(CompletionHandler<void (WTF::Optional<WTF::Vector<WebCore::ContactInfo, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>> &&)>*)arg2 ;
...
-(id)_commonInitializationWithProcessPool:(WebProcessPool*)arg1 configuration:(Ref<API::PageConfiguration, WTF::RawPtrTraits<API::PageConfiguration>>*)arg2 ;
