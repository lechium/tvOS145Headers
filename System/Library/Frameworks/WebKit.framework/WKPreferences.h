...
@property (assign,setter=_setLegacyLineLayoutVisualCoverageEnabled:,nonatomic) BOOL _legacyLineLayoutVisualCoverageEnabled; 
...
@property (assign,setter=_setSpeechRecognitionEnabled:,nonatomic) BOOL _speechRecognitionEnabled; 
@property (assign,setter=_setPrivateClickMeasurementEnabled:,nonatomic) BOOL _privateClickMeasurementEnabled; 
...
@property (assign,nonatomic) BOOL textInteractionEnabled; 
