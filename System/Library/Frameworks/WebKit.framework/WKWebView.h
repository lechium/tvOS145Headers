...
@class WKBrowsingContextHandle, NSURL, NSArray, NSString, NSData, _WKSessionState, _WKInspector, _WKFrameHandle, WKPasswordView, WKWebViewContentProviderRegistry, _UIEventAttribution, UIView, _WKWebViewPrintFormatter, NSNumber, WKWebViewConfiguration, WKBackForwardList, UIScrollView;
...
@property (assign,setter=_setHasBlankOverlay:,nonatomic) BOOL _hasBlankOverlay; 
...
-(void)_setHasBlankOverlay:(BOOL)arg1 ;
...
-(void)_setPrivateClickMeasurementOverrideTimerForTesting:(BOOL)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(OptionSet<WebKit::ViewStabilityFlag>)_viewStabilityState:(id)arg1 ;
...
-(RefPtr<WebKit::ViewSnapshot, WTF::RawPtrTraits<WebKit::ViewSnapshot>, WTF::DefaultRefDerefTraits<WebKit::ViewSnapshot>>*)_takeViewSnapshot;
...
-(void)_zoomToFocusRect:(const FloatRect*)arg1 selectionRect:(const FloatRect*)arg2 fontSize:(float)arg3 minimumScale:(double)arg4 maximumScale:(double)arg5 allowScaling:(BOOL)arg6 forceScroll:(BOOL)arg7 ;
