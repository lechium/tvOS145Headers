...
@property (assign,nonatomic) BOOL limitsNavigationsToAppBoundDomains;                                                                                                          //@synthesize limitsNavigationsToAppBoundDomains=_limitsNavigationsToAppBoundDomains - In the implementation block
