...
@class AVWeakReference, AVPixelBufferAttributeMediator, NSObject, AVAudioSessionMediaPlayerOnly, NSError, AVPlayerItem, NSMutableSet, NSArray, NSMutableDictionary, AVAudioSession, NSDictionary, AVOutputContext, NSMutableArray, NSString, NSNumber, NSHashTable, AVQueuePlayer;
