...
@class AVPlayerItemInternal, AVMusicAppBehaviorContext, NSArray, AVMediaContentRating, NSString, MPAVItem, MPQueuePlayer, AVPlayerItemTrack, NSDate, NSError;
...
@property (assign,nonatomic) BOOL automaticallyHandlesInterstitialEvents; 
...
-(void)mpc_setupWithPlayerAudioFormat:(id)arg1 forceSpatial:(BOOL)arg2 ;
...
-(void)setAvkit_musicAppBehaviorContext:(AVMusicAppBehaviorContext *)arg1 ;
