...
@class NSURL, NSObject, AVWeakReference, NSArray, AVAsset, NSMutableArray, NSMutableDictionary, AVAudioMix, NSError, AVPlayerItemInterstitialEventCollector, NSDictionary, NSString, NSDate, AVMediaSelection, AVPlayerItem, AVPlayerConnection, AVVideoComposition, AVCustomVideoCompositorSession;
