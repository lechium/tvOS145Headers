...
@property (nonatomic,readonly) ATStoreDownloadOperationResult * assetsOperationResult;              //@synthesize assetsOperationResult=_assetsOperationResult - In the implementation block
-(void)execute;
