...
@class UIViewController, AMSUIWebAppearance, NSDictionary, AMSUIWebClientContext, UINavigationItem, AMSUIWebNavigationBarModel, NSString;
...
@property (assign,nonatomic,__weak) UINavigationItem * lastNavigationItem;                                                                 //@synthesize lastNavigationItem=_lastNavigationItem - In the implementation block
...
-(void)setLastNavigationItem:(UINavigationItem *)arg1 ;
