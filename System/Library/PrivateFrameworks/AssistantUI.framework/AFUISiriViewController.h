...
@property (assign,setter=_setSiriRemoteViewControllerIsEditing:,getter=_siriRemoteViewControllerIsEditing,nonatomic) BOOL siriRemoteViewControllerIsEditing;                 //@synthesize siriRemoteViewControllerIsEditing=_siriRemoteViewControllerIsEditing - In the implementation block
...
@property (assign,setter=_setStatusViewHidden:,getter=_statusViewHidden,nonatomic) BOOL statusViewHidden;                                                                    //@synthesize statusViewHidden=_statusViewHidden - In the implementation block
...
-(void)siriRemoteViewController:(id)arg1 requestsKeyboardWithCompletion:(/*^block*/id)arg2 ;
