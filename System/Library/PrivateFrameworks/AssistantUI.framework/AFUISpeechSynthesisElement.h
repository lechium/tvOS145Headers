...
@class NSString, SAUIAudioData, VSSpeechRequest, VSPresynthesizedAudioRequest, NSError, NSDictionary;
...
@property (nonatomic,retain) NSError * synthesisError;                                                                                 //@synthesize synthesisError=_synthesisError - In the implementation block
...
-(void)setSynthesisError:(NSError *)arg1 ;
