...
@interface BWFigVideoCaptureDevice : NSObject <BWZoomCompletionDelegate, BWSupplementalPointCloudCaptureDeviceDelegate> {
	...
	SCD_Struct_Fi116 _deviceWhiteBalanceGains;
	SCD_Struct_Fi116 _grayWorldWhiteBalanceGains;
...
@property (assign,nonatomic) BOOL cinematicFramingSupported;                    //@synthesize cinematicFramingSupported=_cinematicFramingSupported - In the implementation block
@property (assign,nonatomic) BOOL cinematicFramingEnabled;                      //@synthesize cinematicFramingEnabled=_cinematicFramingEnabled - In the implementation block
...
-(SCD_Struct_Fi116)deviceWhiteBalanceGains;
-(SCD_Struct_Fi116)grayWorldDeviceWhiteBalanceGains;
...
-(void)setSmartCameraVersion:(SCD_Struct_BW53)arg1 ;
...
-(id)initWithCaptureDevice:(id)arg1 attributes:(id)arg2 synchronizedStreamsAttributes:(id)arg3 multiCamEnabled:(BOOL)arg4 applicationID:(id)arg5 clientAuditToken:(SCD_Struct_Fi72)arg6 error:(int*)arg7 ;
...
-(int)setWhiteBalanceModeLockedWithGains:(SCD_Struct_Fi116)arg1 requestID:(int)arg2 ;
