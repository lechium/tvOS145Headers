...
@property (assign,nonatomic) SCD_Struct_BW2 postGDCCropDimensions;                                                   //@synthesize postGDCCropDimensions=_postGDCCropDimensions - In the implementation block
...
-(void)setPostGDCCropDimensions:(SCD_Struct_BW2)arg1 ;
