...
typedef struct {
	SCD_Struct_BW48 lastWideSpherePos;
	SCD_Struct_BW48 lastTeleSpherePos;
	SCD_Struct_BW48 currentTeleSpherePos;
	SCD_Struct_BW48 previousTeleSpherePos;
...
typedef struct {
	SCD_Struct_BW58 modelInfo;
	unsigned frameId;
	unsigned numFaces;
	SCD_Struct_BW60 faces[10];
	unsigned numObjects;
	SCD_Struct_BW61 objects[10];
	unsigned numSaliencyObjects;
	SCD_Struct_BW61 saliencyObjects[1];
	SCD_Struct_BW59 saliencyHeatMap;
} SCD_Struct_BW62;
...
typedef struct {
	SCD_Struct_BW95 netInputBufferDesc[3];
	SCD_Struct_BW95 netOutputBufferDescs[3][24];
...
typedef struct {
	SCD_Struct_BW86 field1;
	SCD_Struct_Fi116 field2;
	SCD_Struct_Fi116 field3;
	SCD_Struct_Fi116 field4;
	int field5;
	BOOL field6;
	BOOL field7;
	BOOL field8;
