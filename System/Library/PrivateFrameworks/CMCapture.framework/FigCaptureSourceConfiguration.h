...
@property (assign,getter=isCinematicFramingSupported,nonatomic) BOOL cinematicFramingSupported;              //@synthesize cinematicFramingSupported=_cinematicFramingSupported - In the implementation block
