...
-(int)_buildVisionDataSinkPipeline:(id)arg1 videoDataConnectionConfiguration:(id)arg2 graph:(id)arg3 visionCaptureOutput:(id)arg4 clientAuditToken:(SCD_Struct_Fi72)arg5 delegate:(id)arg6 ;
-(void)triggerVisionDataBurst;
-(id)initWithVisionDataConnectionConfiguration:(id)arg1 videoDataConnectionConfiguration:(id)arg2 graph:(id)arg3 name:(id)arg4 visionCaptureOutput:(id)arg5 captureDevice:(id)arg6 clientAuditToken:(SCD_Struct_Fi72)arg7 delegate:(id)arg8 ;
@end
