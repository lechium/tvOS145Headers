...
#import <libobjc.A.dylib/COAlarmManagerConnectionProvider.h>
...
@property (nonatomic,readonly) NSXPCConnection * alarmManagerServiceConnection;              //@synthesize alarmManagerServiceConnection=_alarmManagerServiceConnection - In the implementation block
