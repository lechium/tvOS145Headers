...
@class CSAsset, NSObject, EARCaesuraSilencePosteriorGenerator, EARClientSilenceFeatures, _EAREndpointer, NSString, CSServerEndpointFeatures, NSMutableArray, NSDate, CSAudioRecordContext;
