...
-(vector<quasar::Token, std::__1::allocator<quasar::Token>>*)formatWords:(const vector<quasar::Token, std::__1::allocator<quasar::Token>>*)arg1 task:(id)arg2 language:(id)arg3 leftContext:(const vector<quasar::Token, std::__1::allocator<quasar::Token>>*)arg4 separateAutoEndPunctuation:(BOOL)arg5 partialResults:(vector<quasar::Token, std::__1::allocator<quasar::Token>>*)arg6 timestampOffset:(unsigned)arg7 zeroTimestamp:(BOOL)arg8 ;
