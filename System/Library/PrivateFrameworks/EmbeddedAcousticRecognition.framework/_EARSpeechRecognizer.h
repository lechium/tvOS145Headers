...
@property (assign,nonatomic) BOOL allowUtteranceDelay;                                   //@synthesize allowUtteranceDelay=_allowUtteranceDelay - In the implementation block
@property (assign,nonatomic) BOOL formatAcrossUtterances;                                //@synthesize formatAcrossUtterances=_formatAcrossUtterances - In the implementation block
