...
@interface ENTestResultChaffRequest : ENTestResultNetworkRequest {
	...
	NSString* _chaffValue;

}

@property (nonatomic,copy) NSString * chaffValue;              //@synthesize chaffValue=_chaffValue - In the implementation block
-(id)additionalRequestHeaders;
-(NSString *)chaffValue;
-(void)setChaffValue:(NSString *)arg1 ;
@end
