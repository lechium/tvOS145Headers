...
@property (nonatomic,retain) GKDashboardChallengesTurnsDataSource * challengesTurnsDataSource;              //@synthesize challengesTurnsDataSource=_challengesTurnsDataSource - In the implementation block
@property (nonatomic,retain) GKDashboardLeaderboardSetDataSource * leaderboardSetDataSource;                //@synthesize leaderboardSetDataSource=_leaderboardSetDataSource - In the implementation block
@property (nonatomic,retain) GKDashboardLeaderboardListDataSource * leaderboardListDataSource;              //@synthesize leaderboardListDataSource=_leaderboardListDataSource - In the implementation block
@property (nonatomic,retain) GKAchievementDataSource * achievementDataSource;                               //@synthesize achievementDataSource=_achievementDataSource - In the implementation block
