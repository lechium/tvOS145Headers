...
@property (assign,nonatomic) BOOL useShortBanner;                                        //@synthesize useShortBanner=_useShortBanner - In the implementation block
...
-(id)initWithTitle:(id)arg1 player:(id)arg2 imageView:(id)arg3 message:(id)arg4 useShortBanner:(BOOL)arg5 ;
