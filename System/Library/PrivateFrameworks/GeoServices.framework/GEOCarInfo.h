...
@property (assign,nonatomic) BOOL hasIsInstrumentClusterEnabled; 
@property (assign,nonatomic) BOOL isInstrumentClusterEnabled; 
@property (assign,nonatomic) BOOL hasIsInstructionCardEnabled; 
@property (assign,nonatomic) BOOL isInstructionCardEnabled; 
@property (assign,nonatomic) BOOL hasIsMapviewEnabled; 
@property (assign,nonatomic) BOOL isMapviewEnabled; 
