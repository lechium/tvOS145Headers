...
@property (assign,nonatomic) BOOL hasDistanceToSuggestionFromViewportCenter; 
@property (assign,nonatomic) double distanceToSuggestionFromViewportCenter; 
@property (assign,nonatomic) BOOL hasTimeSinceLastInteractedSeconds; 
@property (assign,nonatomic) double timeSinceLastInteractedSeconds; 
@property (assign,nonatomic) BOOL hasIsContainedInViewport; 
@property (assign,nonatomic) BOOL isContainedInViewport; 
@property (assign,nonatomic) BOOL hasTimeSinceMapViewportChangedSeconds; 
