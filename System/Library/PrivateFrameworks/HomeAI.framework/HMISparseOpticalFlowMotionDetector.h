...
-(BOOL)applyActivityZoneFilteringOnSourcePoint:(CGPoint)arg1 destinationPoint:(CGPoint)arg2 activityZones:(id)arg3 ;
-(id)_computeOpticalFlow:(CVBufferRef)arg1 with:(CVBufferRef)arg2 globalMotionScore:(float*)arg3 activityZones:(id)arg4 ;
@end
