...
@property (assign,nonatomic) BOOL hasNumBSPs; 
@property (assign,nonatomic) unsigned numBSPs;                                                             //@synthesize numBSPs=_numBSPs - In the implementation block
@property (assign,nonatomic) BOOL hasNumOfParticipantsHaveAccepted; 
...
@property (assign,nonatomic) BOOL hasNumOfParticipantsHaveCloudShareIDAndHaveAccepted; 
...
@property (assign,nonatomic) BOOL hasNumOfParticipantsHaveCloudShareIDButNotAccepted; 
...
@property (assign,nonatomic) BOOL hasNumOfNonAcceptedParticipantsWithKnownCapability; 
