...
@property (assign) BOOL shouldProcessTransactionRemoval;                                                   //@synthesize shouldProcessTransactionRemoval=_shouldProcessTransactionRemoval - In the implementation block
