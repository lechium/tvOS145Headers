...
#import <libobjc.A.dylib/HMDAppleMediaAccessoriesStateManagerFactory.h>
#import <libobjc.A.dylib/HMDAppleMediaAccessoriesStateManagerDataSource.h>
...
#import <libobjc.A.dylib/HMDAppleMediaAccessoriesStateManagerMetricsDispatcherFactory.h>
...
@property (assign) BOOL isNetworkAvailable;                                                                              //@synthesize isNetworkAvailable=_isNetworkAvailable - In the implementation block
...
@property (retain) HMDAppleMediaAccessoriesStateManager * appleMediaAccessoriesStateManager;                             //@synthesize appleMediaAccessoriesStateManager=_appleMediaAccessoriesStateManager - In the implementation block
...
-(void)_getRunTimeStateUpdateWithOptions:(unsigned long long)arg1 includeMediaAccessorySessionState:(BOOL)arg2 includeResidentDeviceState:(BOOL)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)getRunTimeStateUpdateWithOptions:(unsigned long long)arg1 includeMediaAccessorySessionState:(BOOL)arg2 includeResidentDeviceState:(BOOL)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)setAppleMediaAccessoriesStateManager:(HMDAppleMediaAccessoriesStateManager *)arg1 ;
