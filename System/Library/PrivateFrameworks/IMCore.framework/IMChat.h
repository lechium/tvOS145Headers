...
@class NSString, NSArray, IMAccount, NSData, NSMutableDictionary, IMMessage, NSMutableArray, NSMutableSet, NSNumber, IMTimingCollection, IMScheduledUpdater, IMSendProgress, IMInlineReplyController, NSSet, NSDictionary, IMOrderingTools, NSDate, MKMapItem, IMHandle, IMChatRegistry, IMMessageItem;
