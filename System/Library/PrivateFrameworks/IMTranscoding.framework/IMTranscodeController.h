...
-(void)_generateMetadata:(id)arg1 metadataURL:(id)arg2 constraints:(IMPreviewConstraints)arg3 retries:(unsigned long long)arg4 completionBlock:(/*^block*/id)arg5 blockUntilReply:(BOOL)arg6 ;
...
-(void)generateMetadata:(id)arg1 metadataURL:(id)arg2 constraints:(IMPreviewConstraints)arg3 completionBlock:(/*^block*/id)arg4 blockUntilReply:(BOOL)arg5 ;
