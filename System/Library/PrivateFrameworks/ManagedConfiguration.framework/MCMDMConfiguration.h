...
@class NSString, NSDictionary, NSURL, NSObject, NSNumber;
...
@property (nonatomic,retain) NSNumber * memberQueuePollingInterval;                        //@synthesize memberQueuePollingInterval=_memberQueuePollingInterval - In the implementation block
...
-(void)setMemberQueuePollingInterval:(NSNumber *)arg1 ;
