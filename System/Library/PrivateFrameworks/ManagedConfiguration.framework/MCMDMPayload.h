...
@property (nonatomic,retain,readonly) NSNumber * pollingIntervalMinutes;                       //@synthesize pollingIntervalMinutes=_pollingIntervalMinutes - In the implementation block
+(id)typeStrings;
