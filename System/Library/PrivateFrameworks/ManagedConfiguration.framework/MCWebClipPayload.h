...
@property (nonatomic,retain) NSString * targetApplicationBundleIdentifier;              //@synthesize targetApplicationBundleIdentifier=_targetApplicationBundleIdentifier - In the implementation block
...
-(void)setTargetApplicationBundleIdentifier:(NSString *)arg1 ;
