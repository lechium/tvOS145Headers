...
-(SCD_Struct_MP11*)playerViewController:(id)arg1 timeToSeekAfterUserNavigatedFromTime:(SCD_Struct_MP11)arg2 toTime:(SCD_Struct_MP11)arg3;
-(void)playerViewController:(id)arg1 willResumePlaybackAfterUserNavigatedFromTime:(SCD_Struct_MP11)arg2 toTime:(SCD_Struct_MP11)arg3;
