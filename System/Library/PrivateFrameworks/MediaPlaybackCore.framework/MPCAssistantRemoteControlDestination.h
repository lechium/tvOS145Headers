...
@property (nonatomic,readonly) NSString * originatingOutputDeviceUID;              //@synthesize originatingOutputDeviceUID=_originatingOutputDeviceUID - In the implementation block
...
-(void)resolveWithHashedRouteIdentifiers:(id)arg1 audioRoutingInfo:(SCD_Struct_MP9)arg2 completion:(/*^block*/id)arg3 ;
-(void)resolveWithQueue:(id)arg1 hashedRouteIdentifiers:(id)arg2 localPlaybackPermitted:(BOOL)arg3 audioRoutingInfo:(SCD_Struct_MP9)arg4 completion:(/*^block*/id)arg5 ;
-(void)resolveWithRouteIdentifiers:(id)arg1 audioRoutingInfo:(SCD_Struct_MP9)arg2 completion:(/*^block*/id)arg3 ;
-(void)resolveWithQueue:(id)arg1 routeIdentifiers:(id)arg2 localPlaybackPermitted:(BOOL)arg3 audioRoutingInfo:(SCD_Struct_MP9)arg4 completion:(/*^block*/id)arg5 ;
