...
@interface MPCPlayerRequest : MPRequest <MPCMediaRemoteMiddlewareMetadataOperationConfiguration> {
	...
	SCD_Struct_MP10 _tracklistRange;
...
@property (assign,nonatomic) SCD_Struct_MP10 tracklistRange;                          //@synthesize tracklistRange=_tracklistRange - In the implementation block
...
-(SCD_Struct_MP10)tracklistRange;
...
-(void)setTracklistRange:(SCD_Struct_MP10)arg1 ;
