...
@class MPAVItem, NSString, MPCPlaybackEngine, NSError, NSMutableDictionary, MPSectionedIdentifierListPosition, MPIdentifierSet, NSArray, MPShuffleableSectionedIdentifierList, MPSectionedIdentifierList;
...
@property (nonatomic,copy) MPIdentifierSet * missingIdentifierSetForDebugging;                             //@synthesize missingIdentifierSetForDebugging=_missingIdentifierSetForDebugging - In the implementation block
@property (nonatomic,copy) NSArray * previousSectionIDsForDebugging;                                       //@synthesize previousSectionIDsForDebugging=_previousSectionIDsForDebugging - In the implementation block
...
-(MPIdentifierSet *)missingIdentifierSetForDebugging;
-(void)setMissingIdentifierSetForDebugging:(MPIdentifierSet *)arg1 ;
-(NSArray *)previousSectionIDsForDebugging;
-(void)setPreviousSectionIDsForDebugging:(NSArray *)arg1 ;
