...
@property (nonatomic,readonly) SCD_Struct_MT7 viewport; 
@property (nonatomic,readonly) SCD_Struct_MT8 scissorRect; 
...
-(void)setViewports:(const SCD_Struct_MT7*)arg1 count:(unsigned long long)arg2 ;
...
-(void)setScissorRect:(SCD_Struct_MT8)arg1 ;
-(void)setScissorRects:(const SCD_Struct_MT8*)arg1 count:(unsigned long long)arg2 ;
