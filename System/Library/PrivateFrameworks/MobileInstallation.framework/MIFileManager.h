...
-(BOOL)stageURLByMoving:(id)arg1 toItemName:(id)arg2 inStagingDir:(id)arg3 settingUID:(unsigned)arg4 gid:(unsigned)arg5 dataProtectionClass:(int)arg6 hasSymlink:(BOOL*)arg7 error:(id*)arg8 ;
