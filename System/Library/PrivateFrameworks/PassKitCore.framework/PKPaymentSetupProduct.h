...
@property (assign,nonatomic) BOOL preventsFeatureApplication;                                        //@synthesize preventsFeatureApplication=_preventsFeatureApplication - In the implementation block
