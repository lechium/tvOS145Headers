...
@property (nonatomic,copy) NSDictionary * additionalEventAnalyticsOnButtonPress;              //@synthesize additionalEventAnalyticsOnButtonPress=_additionalEventAnalyticsOnButtonPress - In the implementation block
...
-(void)setAdditionalEventAnalyticsOnButtonPress:(NSDictionary *)arg1 ;
@end
