...
@class PKPassGroupView, PKGroup, PKPaymentPass, PKTransactionSourceCollection, NSArray, PKPeerPaymentAssociatedAccountsController, PKDashboardTransactionFetcher, NSObject, NSDate, PKPeerPaymentAccount, PKContactResolver, PKPeerPaymentWebService, PKPeerPaymentAccountResolutionController, PKTransitBalanceModel, PKPaymentDefaultDataProvider, PKPaymentVerificationController, PKSecureElement, NSOrderedSet, NSDateFormatter, NSMutableArray, PKPassPresentationContext, PKAccount, PKPhysicalCardController, PKCreditAccountStatement, PKSpendingSummaryFetcher, PKSpendingSummary, NSError, PKAccountServiceAccountResolutionController, NSMutableSet, NSMutableDictionary, NSString, PKAMPEnrollmentManager, PKLinkedApplication, PKAccountUserCollection, PKFamilyMemberCollection, PKContactAvatarManager;
...
@property (nonatomic,readonly) NSArray * accountUserInvitations;                                //@synthesize accountUserInvitations=_accountUserInvitations - In the implementation block
...
@property (nonatomic,readonly) PKContactAvatarManager * avatarManager;                          //@synthesize avatarManager=_avatarManager - In the implementation block
...
-(void)reloadTransactionSourceCollectionAndForceReloadContent:(BOOL)arg1 ;
-(BOOL)_canDisplayBalance;
...
-(SCD_Struct_PK24)_peerPaymentDashboardCondition;
...
-(void)_presentPassDetailsWithHandler:(/*^block*/id)arg1 ;
