...
@class PKTransactionSourceCollection, NSObject, PKMerchant, NSSet, PKInstallmentPlan, NSArray, PKCurrencyAmount, NSDecimalNumber, PKPaymentPass, NSString, NSDictionary, NSDate;
...
@property (nonatomic,readonly) id<PKPaymentDataProvider> paymentDataProvider;                        //@synthesize paymentDataProvider=_paymentDataProvider - In the implementation block
