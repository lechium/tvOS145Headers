...
@class PKStackedTextItemGroup, PKStackedTextItemGroupView, UIView, UIImageView, PKContinuousButton, PKPaymentPassAction, PKPaymentPass, PKPaymentTransaction, PKTransitBalanceModel, NSArray, PKContactResolver, NSString;
...
@property (nonatomic,readonly) PKContactResolver * peerPaymentContactResolver;              //@synthesize peerPaymentContactResolver=_peerPaymentContactResolver - In the implementation block
...
-(PKContactResolver *)peerPaymentContactResolver;
