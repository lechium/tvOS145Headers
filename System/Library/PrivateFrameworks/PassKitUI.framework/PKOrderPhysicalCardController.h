...
@class PKAccountService, PKPaymentWebService, PKAccount, PKAccountUser, PKPhysicalCard, NSArray, PKAccountWebServiceRequestPhysicalCardRequest, PKAccountWebServicePhysicalCardActionRequest, PKPaymentPass, NSString, PKPhysicalCardArtworkOption, CNPostalAddress;
