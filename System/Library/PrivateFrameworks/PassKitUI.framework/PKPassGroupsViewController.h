...
#import <libobjc.A.dylib/PKInboxDataSourceDelegate.h>
...
-(void)presentPassWithAssociatedAccountIdentifier:(id)arg1 animated:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)presentInvitationsInboxAnimated:(BOOL)arg1 completion:(/*^block*/id)arg2 ;
-(void)presentCreateAccountUserInvitationWithCompletion:(/*^block*/id)arg1 ;
-(void)presentInvitationWithIdentifier:(id)arg1 forAccountWithIdentifier:(id)arg2 completion:(/*^block*/id)arg3 ;
