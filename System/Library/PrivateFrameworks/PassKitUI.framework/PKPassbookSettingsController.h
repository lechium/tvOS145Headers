...
@class PKPaymentPreferencesViewController, PKPaymentPreference, PKPaymentPreferenceCard, PKPaymentVerificationController, PKPaymentWebService, PKContactAvatarManager, PKPeerPaymentAssociatedAccountsController, PKInboxDataSource, NSString, NSArray, PSSpecifier, PKPeerPaymentWebService, PKPeerPaymentAccountResolutionController, PKPeerPaymentAccount, PKExpressPassController, PKAccountService, NSMutableDictionary, LAContext, PKContactFormatValidator;
