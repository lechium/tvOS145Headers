...
@protocol PKPassLibraryDataProvider, OS_dispatch_source, PKGroupDelegate, OS_dispatch_group, PKPassDeleteHandler, PKPaymentDataProvider;
@class NSObject, PKPaymentPass, PKGroupsController, PKGroup, PKTransactionSourceCollection, PKLinkedApplication, PKPaymentApplication, PKPaymentWebService, PKPaymentVerificationController, PKPaymentPassDetailActivationFooterView, PKFooterHyperlinkView, PKSettingTableCell, PKPaymentTransactionCellController, NSArray, NSDateFormatter, NSNumberFormatter, PKDashboardTransactionFetcher, PKSharedCredentialsGroupController, LAContext, PKExpressPassController, PKTransitPassProperties, PKPaymentBalanceReminder, NSDictionary, NSMutableDictionary, UITableViewHeaderFooterView, UIImageView, PKPassHeaderView, UISegmentedControl, UIView, PKAnimatedNavigationBarTitleView, PKPassFaceViewRendererState, PKPeerPaymentWebService, PKPeerPaymentAccount, PKPeerPaymentPreferences, PKSpinnerHeaderView, PKPeerPaymentActionViewController, PKPaymentTransactionDetailsFactory, PKAccountServiceAccountResolutionController, PKPhysicalCardController, PKPhysicalCardActionController, PKPeerPaymentAccountResolutionController, NSIndexPath, PKTransitBalanceModel, CNContact, CLInUseAssertion, NSMutableArray, PKPassPresentationContext, PKContactFormatValidator, PKPeerPaymentAssociatedAccountsController, PKFamilyMember, UIColor, PKAccountUserCollection, PKApplyController, PKContactResolver, PKContactAvatarManager, PKAccountService, PKAccount, PKFamilyMemberCollection, NSString;
...
@property (nonatomic,copy) NSArray * accountUserInvitations;                                     //@synthesize accountUserInvitations=_accountUserInvitations - In the implementation block
@property (assign,getter=isRemovingAccountUser,nonatomic) BOOL removingAccountUser;              //@synthesize removingAccountUser=_removingAccountUser - In the implementation block
@property (nonatomic,retain) PKApplyController * applyController;                                //@synthesize applyController=_applyController - In the implementation block
@property (nonatomic,retain) PKPaymentPass * pass;                                               //@synthesize pass=_pass - In the implementation block
@property (assign,nonatomic) long long detailViewStyle;                                          //@synthesize detailViewStyle=_detailViewStyle - In the implementation block
...
@property (nonatomic,retain) id<PKPaymentDataProvider> paymentServiceDataProvider;               //@synthesize paymentServiceDataProvider=_paymentServiceDataProvider - In the implementation block
@property (nonatomic,retain) PKAccountService * accountService;                                  //@synthesize accountService=_accountService - In the implementation block
...
@property (nonatomic,copy) NSArray * sortedFamilyMemberRowModels;                                //@synthesize sortedFamilyMemberRowModels=_sortedFamilyMemberRowModels - In the implementation block
...
-(void)_presentInvitation:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)_accountUsersForAccountIdentifier:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)setAccountUserInvitations:(NSArray *)arg1 ;
-(void)_pendingInvitationsForAccountIdentifier:(id)arg1 completion:(/*^block*/id)arg2 ;
-(id)_linkCellWithText:(id)arg1 forTableView:(id)arg2 ;
-(void)setApplyController:(PKApplyController *)arg1 ;
...
-(void)loadAccountUsersWithCompletion:(/*^block*/id)arg1 ;
-(void)loadPendingAccountUserInvitationsWithCompletion:(/*^block*/id)arg1 ;
...
-(void)_loadFamilyCollectionIfNecessaryWithCompletion:(/*^block*/id)arg1 ;
-(void)_reloadView;
-(void)_updateCashbackPeerPaymentResolutionSection;
-(void)_loadAdditionalAccountDataWithCompletion:(/*^block*/id)arg1 ;
...
-(void)setPaymentServiceDataProvider:(id<PKPaymentDataProvider>)arg1 ;
-(void)setAccountService:(PKAccountService *)arg1 ;
-(void)setSortedFamilyMemberRowModels:(NSArray *)arg1 ;
@end
