...
@class PKPaymentPass, PKPeerPaymentTermsController, PKSecurityCapabilitiesController, PKPeerPaymentConfirmNameViewController, UIViewController, PKPeerPaymentCredential, PKPaymentProvisioningController, PKPeerPaymentWebService, PKPaymentWebService, PKPeerPaymentService, PKPeerPaymentAccount, PKDeviceSharingCapabilitiesManager, UIImage, NSString;
