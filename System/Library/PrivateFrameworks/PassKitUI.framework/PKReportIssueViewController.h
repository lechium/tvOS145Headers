...
@class PKPaymentTransaction, PKTransactionSourceCollection, PKAccount, PKAccountUserCollection, PKPaymentService, PKPaymentTransactionCellController, PKBusinessChatController, PKFamilyMemberCollection, UIBarButtonItem, UIActivityIndicatorView, NSString, UITableViewHeaderFooterView, UIImageView, PKPaymentWebService;
...
+(BOOL)canReportIssueForTransaction:(id)arg1 transactionSourceCollection:(id)arg2 ;
-(void)viewDidLoad;
...
-(void)_reprocessTransactionMerchantWithIssueReportIdentifier:(id)arg1 completion:(/*^block*/id)arg2 ;
