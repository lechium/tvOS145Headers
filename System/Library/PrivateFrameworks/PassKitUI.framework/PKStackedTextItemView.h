...
@interface PKStackedTextItemView : UIView {
	...
	SCD_Struct_PK26 _contentConstraints;
...
@property (assign,nonatomic) SCD_Struct_PK26 contentConstraints;              //@synthesize contentConstraints=_contentConstraints - In the implementation block
...
-(SCD_Struct_PK27)_titleFontMetrics;
...
-(SCD_Struct_PK26)boundingMetricForWidth:(double)arg1 ;
-(void)setContentConstraints:(SCD_Struct_PK26)arg1 ;
-(SCD_Struct_PK26)contentConstraints;
@end
