...
@class PKPaymentTransactionCollectionViewCell, UIFont, UIImage, NSCache, NSDateFormatter, PKPaymentTransactionIconGenerator, PKMapsSnapshotManager, PKContactResolver, PKContactAvatarManager, NSString;
