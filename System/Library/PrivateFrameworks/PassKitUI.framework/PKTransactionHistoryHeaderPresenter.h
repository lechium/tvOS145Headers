...
@class PKObjectDownloader, PKPaymentService, UICollectionViewCell, UIImage, PKMapsSnapshotManager, PKContactResolver, PKContactAvatarManager, UIVisualEffect, UIColor, NSString;
