...
@property (assign,nonatomic) BOOL shouldDisableAutomaticPixelBufferUpdates;                    //@synthesize shouldDisableAutomaticPixelBufferUpdates=_shouldDisableAutomaticPixelBufferUpdates - In the implementation block
