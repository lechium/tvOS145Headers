...
@property (assign,nonatomic) BOOL shouldEnableEARC;                                  //@synthesize shouldEnableEARC=_shouldEnableEARC - In the implementation block
+(BOOL)supportsSecureCoding;
+(id)upgradeAttemptRequestFromSource:(long long)arg1 ;
+(id)cableCheckRequestFromSource:(long long)arg1 ;
+(id)eARCRequestFromSource:(long long)arg1 shouldEnable:(BOOL)arg2 ;
...
-(long long)source;
-(long long)kind;
-(id)initWithSourceDisplayMode:(id)arg1 destinationDisplayMode:(id)arg2 kind:(long long)arg3 source:(long long)arg4 shouldEnableEARC:(BOOL)arg5 ;
...
-(void)setShouldEnableEARC:(BOOL)arg1 ;
