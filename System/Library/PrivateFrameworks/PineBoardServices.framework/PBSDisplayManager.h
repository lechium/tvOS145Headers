...
@interface PBSDisplayManager : NSObject <PBSDisplayState_Private, PBSDisplayState> {
	...
	NSDictionary* _colorCalibrations;
...
@property (nonatomic,retain) NSDictionary * colorCalibrations;                            //@synthesize colorCalibrations=_colorCalibrations - In the implementation block
...
@property (assign,nonatomic) long long eARCStatus;                                        //@synthesize eARCStatus=_eARCStatus - In the implementation block
...
-(void)setColorCalibrations:(NSDictionary *)arg1 ;
-(void)setColorGains:(id)arg1 ;
-(void)setAudioLatency:(double)arg1 forDisplayMode:(id)arg2 ;
-(void)setColorCalibration:(id)arg1 forDisplayMode:(id)arg2 ;
...
-(void)setEARCStatus:(long long)arg1 ;
@end
