...
@interface PBSExternalControlSettings : NSObject {
	...
	BOOL _cachedPauseMediaOnResignActiveSource;
...
@property (assign,nonatomic) BOOL shouldPauseMediaOnResignActiveSource; 
...
-(BOOL)shouldPauseMediaOnResignActiveSource;
-(void)setShouldPauseMediaOnResignActiveSource:(BOOL)arg1 ;
