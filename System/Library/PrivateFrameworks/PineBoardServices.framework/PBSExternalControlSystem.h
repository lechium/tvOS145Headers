...
@interface PBSExternalControlSystem : NSObject <PBSEARCObserver, CoreControlDelegate> {

	BOOL _holdVolumeDownForMute;
	BOOL _isActiveSource;
	BOOL _isAppleIRRemotePaired;
	BOOL _needToUpdateCachedState;
	BOOL _usingARCAudio_cached;
	...
	long long _volumeControlTargetDeviceType;
...
@property (assign,nonatomic) long long volumeControlTargetDeviceType;                                          //@synthesize volumeControlTargetDeviceType=_volumeControlTargetDeviceType - In the implementation block
...
@property (assign,nonatomic) BOOL usingARCAudio_cached;                                                        //@synthesize usingARCAudio_cached=_usingARCAudio_cached - In the implementation block
...
-(void)_SYNC_setVolumeIRCommandsAllowed;
...
-(void)setUsingARCAudio_cached:(BOOL)arg1 ;
...
-(BOOL)usingARCAudio_cached;
-(void)setVolumeControlTargetDeviceType:(long long)arg1 ;
...
-(void)_setCoreControlVolumeStatus;
-(void)_setCoreControlMuteStatus;
-(float)_routeCurrentVolumeLevel;
