...
@property (nonatomic,readonly) BOOL previous_solution_is_bad;                //@synthesize previous_solution_is_bad=_previous_solution_is_bad - In the implementation block
@property (nonatomic,readonly) BOOL track_score_valid;                       //@synthesize track_score_valid=_track_score_valid - In the implementation block
@property (nonatomic,readonly) double track_score;                           //@synthesize track_score=_track_score - In the implementation block
@property (nonatomic,readonly) BOOL sweep_angle_valid;                       //@synthesize sweep_angle_valid=_sweep_angle_valid - In the implementation block
@property (nonatomic,readonly) double sweep_angle_deg;                       //@synthesize sweep_angle_deg=_sweep_angle_deg - In the implementation block
