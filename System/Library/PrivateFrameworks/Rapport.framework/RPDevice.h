...
@property (nonatomic,readonly) BOOL idsDeviceIdentifierConflict;                 //@synthesize idsDeviceIdentifierConflict=_idsDeviceIdentifierConflict - In the implementation block
