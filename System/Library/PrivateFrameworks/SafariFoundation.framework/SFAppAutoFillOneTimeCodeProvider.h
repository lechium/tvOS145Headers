...
-(BOOL)hasOneTimeCode;
-(id)currentOneTimeCodesWithAuditToken:(SCD_Struct_SF1)arg1 website:(id)arg2 usernameHint:(id)arg3 fieldClassification:(long long)arg4 ;
-(id)_secureURLWithDomain:(id)arg1 ;
-(BOOL)_appWithAuditTokenIsWebBrowser:(SCD_Struct_SF1)arg1 ;
...
-(BOOL)hasOneTimeCodeForAppWithAuditToken:(SCD_Struct_SF1)arg1 ;
