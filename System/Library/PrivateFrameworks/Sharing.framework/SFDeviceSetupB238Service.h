...
@class NSData, APCPlayer, RPCompanionLinkClient, NSObject, SFClient, SFService, SFSession, SFSiriClient, SFSiriDeviceSetupGreetingDetails, SFDeviceOperationHandlerCDPSetup, HMDeviceSetupOperationHandler, SFDeviceOperationHandlerWiFiSetup, CUAudioPlayer, NSString, NSDate, SUICDefaultVoicePreviewer;
...
-(void)_handleVoicePreviewRequest:(id)arg1 responseHandler:(/*^block*/id)arg2 ;
