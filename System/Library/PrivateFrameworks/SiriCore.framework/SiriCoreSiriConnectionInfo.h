...
@property (assign,getter=isForceOnDeviceOnlyDictationEnabled,nonatomic) BOOL forceOnDeviceOnlyDictation;              //@synthesize forceOnDeviceOnlyDictation=_forceOnDeviceOnlyDictation - In the implementation block
-(id)description;
