...
@property (setter=_setShouldDeferWake:,getter=_shouldDeferWake) BOOL shouldDeferWake;                                                                           //@synthesize shouldDeferWake=_shouldDeferWake - In the implementation block
