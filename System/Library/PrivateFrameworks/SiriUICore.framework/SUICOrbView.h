...
@interface SUICOrbView : UIView {
	...
	SCD_Struct_SU8 _mpsChipBlurOffset;
	...
	SCD_Struct_SU9 _projectionMatrix;
	SCD_Struct_SU10 _sphereUniforms;
	SCD_Struct_SU11 _bubbleSpring;
	SCD_Struct_SU11 _energySpring;
	SCD_Struct_SU11 _volumeSpring;
	SCD_Struct_SU11 _chipsSpring;
	SCD_Struct_SU11 _specularSpring;
	SCD_Struct_SU11 _thinkingSpring;
	SCD_Struct_SU11 _speakingSpring;
	SCD_Struct_SU11 _glowSpring;
	SCD_Struct_SU11 _onSpring;
	SCD_Struct_SU11 _chipSpring[6];
	 _setupRasterSize;
...
-(void)_setupSpring:(SCD_Struct_SU11*)arg1 withType:(unsigned long long)arg2 initialValue:(float)arg3 ;
