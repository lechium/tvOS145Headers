...
-(void)synthesizeRequest:(id)arg1 audioChunkHandler:(/*^block*/id)arg2 taskTracker:(id)arg3 analyticsContext:(id)arg4 completion:(/*^block*/id)arg5 ;
-(void)prewarmRequest:(id)arg1 ;
-(void)enqueueRequest:(id)arg1 languageCode:(id)arg2 voiceName:(id)arg3 gender:(long long)arg4 audioSessionID:(unsigned)arg5 preparation:(/*^block*/id)arg6 finalization:(/*^block*/id)arg7 taskTracker:(id)arg8 analyticsContext:(id)arg9 ;
