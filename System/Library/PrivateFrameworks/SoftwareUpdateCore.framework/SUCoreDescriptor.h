...
@property (assign,nonatomic) BOOL promoteAlternateUpdate;                                     //@synthesize promoteAlternateUpdate=_promoteAlternateUpdate - In the implementation block
@property (assign,nonatomic) BOOL enableAlternateAssetAudience;                               //@synthesize enableAlternateAssetAudience=_enableAlternateAssetAudience - In the implementation block
