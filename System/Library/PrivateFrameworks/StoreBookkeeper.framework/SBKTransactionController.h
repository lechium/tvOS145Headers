...
#import <libobjc.A.dylib/SBKTransactionURLOperationDelegate.h>

@protocol SBKTransactionControllerDelegate, OS_dispatch_queue;
@class SSAccount, NSString, NSURL, SBKStoreAuthenticationController, SBKTransaction, NSObject, NSOperationQueue, NSMutableArray, SBKTaskAssertion, NSNumber;
...
@property (readonly) SSAccount * account;                                                               //@synthesize account=_account - In the implementation block
