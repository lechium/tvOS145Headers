...
+(void)relayAudioVideoStatus:(unsigned)arg1 rxThroughput:(double)arg2 txThroughput:(double)arg3 reset:(BOOL)arg4 ;
...
-(void)_relayAudioVideoStatus:(unsigned)arg1 rxThroughput:(double)arg2 txThroughput:(double)arg3 reset:(BOOL)arg4 ;
