...
@class TVHKCollectionObjectIdentifier, TVHKMediaServerIdentifier, TVHKMediaEntityType, TVHKMediaEntityIdentifier, TVHKDMAPMediaEntityIdentifier, TVHKMediaEntityKind, NSSet, NSString, NSNumber, NSDate, NSArray;

@interface TVHKMediaEntity : NSObject <BSDescriptionProviding, TVHKMediaObject> {

	BOOL _localChanges;
	TVHKCollectionObjectIdentifier* _collectionObjectIdentifier;
...
@property (nonatomic,retain) TVHKCollectionObjectIdentifier * collectionObjectIdentifier;               //@synthesize collectionObjectIdentifier=_collectionObjectIdentifier - In the implementation block
+(id)new;
...
-(TVHKCollectionObjectIdentifier *)collectionObjectIdentifier;
-(void)setCollectionObjectIdentifier:(TVHKCollectionObjectIdentifier *)arg1 ;
-(id)_DMAPIdentifier;
