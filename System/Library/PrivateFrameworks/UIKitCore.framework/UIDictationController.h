...
@property (assign,getter=isSendButtonPressedDuringDictation,nonatomic) BOOL sendButtonPressedDuringDictation;              //@synthesize sendButtonPressedDuringDictation=_sendButtonPressedDuringDictation - In the implementation block
