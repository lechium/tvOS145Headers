...
@class _UIFocusGroupMap, _UIFocusItemInfo, _UIFocusGroup, UIImage, _UIFocusMovementInfo, _UIFocusMapSearchInfo, NSArray, _UIDebugLogReport, _UIDebugIssueReport, UIFocusGuide, UIView;
...
@property (getter=_previouslyFocusedGroup,nonatomic,readonly) _UIFocusGroup * previouslyFocusedGroup;                                                                           //@synthesize previouslyFocusedGroup=_previouslyFocusedGroup - In the implementation block
@property (getter=_nextFocusedGroup,nonatomic,readonly) _UIFocusGroup * nextFocusedGroup;                                                                                       //@synthesize nextFocusedGroup=_nextFocusedGroup - In the implementation block
