...
@property (assign,nonatomic) BOOL restoringInputViews;                                                                 //@synthesize restoringInputViews=_restoringInputViews - In the implementation block
@property (assign,nonatomic) BOOL takingSnapshot;                                                                      //@synthesize takingSnapshot=_takingSnapshot - In the implementation block
