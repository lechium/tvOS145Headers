...
@property (nonatomic,copy) NSString * controlKeyBackgroundName;                                                //@synthesize controlKeyBackgroundName=_controlKeyBackgroundName - In the implementation block
@property (nonatomic,copy) NSString * activatedKeyplaneSwitchControlKeyBackgroundName;                         //@synthesize activatedKeyplaneSwitchControlKeyBackgroundName=_activatedKeyplaneSwitchControlKeyBackgroundName - In the implementation block
...
@property (nonatomic,retain,readonly) _UIButtonBarButtonVisualProvider * buttonBarVisualProvider;              //@synthesize buttonBarVisualProvider=_buttonBarVisualProvider - In the implementation block
+(id)defaultConfig;
