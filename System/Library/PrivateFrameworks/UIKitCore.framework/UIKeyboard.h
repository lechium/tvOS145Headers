...
@class UIView, UITextInputTraits, NSMutableDictionary, _UIKeyboardPasscodeObscuringInteraction, UITapGestureRecognizer, UITextCursorAssertionController, NSString;
