...
@property (assign,nonatomic) BOOL disablesUpdateLastUsedInputModeTimer;                               //@synthesize disablesUpdateLastUsedInputModeTimer=_disablesUpdateLastUsedInputModeTimer - In the implementation block
