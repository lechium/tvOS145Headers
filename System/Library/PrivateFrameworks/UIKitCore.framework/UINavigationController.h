...
@interface UINavigationController : UIViewController <GKContentRefresh, GKURLHandling, UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIToolbarDelegateInternal, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate> {
	...
	SCD_Struct_UI59 _interactiveScrollNavBarIntrinsicHeightRange;
...
-(double)_navigationBar:(id)arg1 preferredHeightForTransitionToHeightRange:(SCD_Struct_UI59)arg2 ;
...
-(SCD_Struct_UI60)_calculateTopLayoutInfoForViewController:(id)arg1 ;
...
-(SCD_Struct_UI59)_intrinsicNavigationBarHeightRangeForNavItem:(id)arg1 ;
...
-(SCD_Struct_UI59)_heightRangeOfTopViews;
