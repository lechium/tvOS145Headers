...
-(void)_setFocusFastScrollingRestorationRect:(CGRect)arg1 ;
...
-(CGRect)_focusFastScrollingRestorationRect;
-(BOOL)_contentOffsetWithinFastScrollFocusRestorationRange:(CGRect)arg1 ;
