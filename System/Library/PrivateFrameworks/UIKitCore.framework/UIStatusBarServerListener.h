...
@interface UIStatusBarServerListener : NSObject {
	...
	SCD_Struct_UI124 _statusBarData;
	SCD_Struct_UI124 _composedStatusBarData;
	SCD_Struct_UI125 _overrides;
...
-(void)_postStatusBarData:(SCD_Struct_UI124*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
