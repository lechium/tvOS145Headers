...
@property (assign,nonatomic) double minimumPrimaryMovementRate;                       //@synthesize minimumPrimaryMovementRate=_minimumPrimaryMovementRate - In the implementation block
...
-(BOOL)_checkForSwipeWithDelta:(CGPoint)arg1 time:(double)arg2 currentPositionChange:(CGPoint)arg3 currentTimeChange:(double)arg4 ;
...
-(double)minimumPrimaryMovementRate;
-(void)setMinimumPrimaryMovementRate:(double)arg1 ;
