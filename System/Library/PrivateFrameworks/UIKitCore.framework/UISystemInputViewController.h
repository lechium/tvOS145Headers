...
@property (assign,nonatomic) long long resolvedKeyboardStyle;                                                        //@synthesize resolvedKeyboardStyle=_resolvedKeyboardStyle - In the implementation block
...
@property (assign,nonatomic) BOOL notifyKeyboardOnScreenOnFocusOnly;                                                 //@synthesize notifyKeyboardOnScreenOnFocusOnly=_notifyKeyboardOnScreenOnFocusOnly - In the implementation block
