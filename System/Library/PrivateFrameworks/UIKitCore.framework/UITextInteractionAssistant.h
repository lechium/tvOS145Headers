...
@class _UIKeyboardTextSelectionController, UITextCursorAssertionController, UIResponder, UITextSelectionView, UITextChecker, UITextRange, UITextLinkInteraction, UITextInteraction, _UITextInteractionAssistantGestureState, NSNumber, UILongPressGestureRecognizer, UITapGestureRecognizer, UIGestureRecognizer, UIScrollView, NSString, UIFieldEditor;
