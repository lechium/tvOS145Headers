...
@interface UIViewController : UIResponder <IMMetricsDataSource, GKContentRefresh, GKURLHandling, PXDiagnosticsEnvironment, PXAnonymousViewController, PXProgrammaticNavigationParticipant, PXProgrammaticNavigationUpdateTarget, MKInfoCardThemeListener, BSTraitEnvironment, NSExtensionRequestHandling, _UIFallbackEnvironment, _UIViewServiceDeputy, UIWindowDelegate, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, _UIStatusBarAnimationProviding, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
	...
	SCD_Struct_UI65 _presentationSizeClassPair;
...
@property (nonatomic,readonly) SCD_Struct_UI65 __sizeClassPair; 
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI65 presentationSizeClassPair;                                                    //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(void)visitChildenViewControllers:(/*^block*/id)arg1 ;
...
-(SCD_Struct_UI66)_hostAuditToken;
...
-(SCD_Struct_UI65)__sizeClassPair;
...
-(id)_rootAncestorViewControllerInWindow:(BOOL)arg1 ;
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI65)arg1 ;
...
-(SCD_Struct_UI67)_cumulativeOverlayInsetsInView:(id)arg1 ;
...
-(void)_setHostAuditToken:(SCD_Struct_UI66)arg1 ;
