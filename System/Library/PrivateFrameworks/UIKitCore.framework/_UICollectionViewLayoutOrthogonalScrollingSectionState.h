...
@property (nonatomic,readonly) NSDirectionalEdgeInsets environmentInsets; 
@required
-(CGSize)contentSize;
...
-(NSDirectionalEdgeInsets)environmentInsets;
...
@interface _UICollectionViewLayoutOrthogonalScrollingSectionState : NSObject <_UICollectionViewLayoutOrthogonalScrollingSectionState, NSCopying> {
	...
	NSDirectionalEdgeInsets _environmentInsets;
...
@property (nonatomic,readonly) NSDirectionalEdgeInsets environmentInsets;              //@synthesize environmentInsets=_environmentInsets - In the implementation block
