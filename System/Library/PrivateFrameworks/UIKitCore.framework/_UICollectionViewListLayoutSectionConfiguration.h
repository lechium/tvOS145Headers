...
@property (setter=_setItemSeparatorHandler:,getter=_itemSeparatorHandler,nonatomic,copy) id _itemSeparatorHandler;                                                 //@synthesize itemSeparatorHandler=_itemSeparatorHandler - In the implementation block
...
-(void)_setItemSeparatorHandler:(/*^block*/id)arg1 ;
