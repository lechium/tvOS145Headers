...
@class UICollectionView, NSMapTable, NSHashTable, NSIndexSet, _UICollectionViewOrthogonalScrollerEmbeddedScrollView, NSUUID, NSString;
...
@property (nonatomic,retain) NSUUID * lastUpdateIdentifier;                                                                           //@synthesize lastUpdateIdentifier=_lastUpdateIdentifier - In the implementation block
@property (assign,nonatomic) BOOL shouldPreventFocusScrollPastContentSize;                                                            //@synthesize shouldPreventFocusScrollPastContentSize=_shouldPreventFocusScrollPastContentSize - In the implementation block
...
-(void)setLastUpdateIdentifier:(NSUUID *)arg1 ;
