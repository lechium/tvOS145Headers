...
@class UIScrollView, UIPanGestureRecognizer, NSArray, _UIFocusEngineJoystickGestureRecognizer, _UIRotaryGestureRecognizer, NSMutableArray, CADisplayLink, _UIDynamicValueAnimation, _UIDynamicAnimationGroup, NSTimer, _UIFocusFastScrollingIndexBarView, _UIFocusFastScrollingIndexBarEntry;
...
-(CGSize)_velocityOfRotaryGesture:(id)arg1 inView:(id)arg2 ;
-(CGPoint)_translationOfRotaryGesture:(id)arg1 inView:(id)arg2 ;
-(CGPoint)_rotaryTranslatedOffsetForCurrentOffset:(CGPoint)arg1 translation:(CGPoint)arg2 ;
-(CGPoint)_rotaryRubberbandedOffsetForTranslatedOffset:(CGPoint)arg1 ;
-(BOOL)_updateRotaryDirection:(id)arg1 ;
-(void)_startFullContentRotaryGesture;
-(void)_updateFullContentRotaryGesture;
-(CGPoint)_lerpRotaryGestureAccumulatedDistanceToDigitizerLocation;
