...
@property (assign,setter=_setGroupFilter:,getter=_groupFilter,nonatomic) long long groupFilter;                                                                          //@synthesize groupFilter=_groupFilter - In the implementation block
...
-(long long)_groupFilter;
-(CGRect)_fallbackMovementOriginatingFrame;
-(id)initWithHeading:(unsigned long long)arg1 velocity:(CGVector)arg2 isInitial:(BOOL)arg3 shouldLoadScrollableContainer:(BOOL)arg4 groupFilter:(long long)arg5 ;
