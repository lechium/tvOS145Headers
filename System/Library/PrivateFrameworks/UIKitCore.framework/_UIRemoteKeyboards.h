...
@property (retain) _UIKeyboardChangedInformation * backupState;                       //@synthesize backupState=_backupState - In the implementation block
...
-(void)setBackupState:(_UIKeyboardChangedInformation *)arg1 ;
