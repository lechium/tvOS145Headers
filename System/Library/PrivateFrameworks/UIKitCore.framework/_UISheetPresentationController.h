...
@property (assign,nonatomic) BOOL _forceSheetSemanticContext;                                                                                                                //@synthesize _forceSheetSemanticContext=__forceSheetSemanticContext - In the implementation block
