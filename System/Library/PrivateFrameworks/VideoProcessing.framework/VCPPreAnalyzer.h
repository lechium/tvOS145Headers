...
-(int)_performAnalysis:(id*)arg1 isPano:(BOOL)arg2 isSDOF:(BOOL)arg3 forAsset:(id)arg4 withRequestHandler:(id)arg5 andLumaPixelBuffer:(CVBufferRef)arg6 ;
-(void)analyzeWithImageURL:(id)arg1 isPano:(BOOL)arg2 isSDOF:(BOOL)arg3 forAsset:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
