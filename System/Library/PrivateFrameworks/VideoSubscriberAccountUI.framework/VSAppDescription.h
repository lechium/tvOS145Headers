...
@property (assign,getter=isDefaultAppForProvider,nonatomic) BOOL defaultAppForProvider;              //@synthesize defaultAppForProvider=_defaultAppForProvider - In the implementation block
