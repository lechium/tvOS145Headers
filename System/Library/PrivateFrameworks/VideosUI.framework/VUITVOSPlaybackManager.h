...
@class VUIPlaybackInfo, UIAlertController, TVPStateMachine, NSTimer, NSObject, NSString;
...
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> audioSessionSerialQueue;                                       //@synthesize audioSessionSerialQueue=_audioSessionSerialQueue - In the implementation block
...
-(NSObject*<OS_dispatch_queue>)audioSessionSerialQueue;
...
-(void)setAudioSessionSerialQueue:(NSObject*<OS_dispatch_queue>)arg1 ;
@end
