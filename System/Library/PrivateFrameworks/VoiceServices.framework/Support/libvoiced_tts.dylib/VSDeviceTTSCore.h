...
@class VSSpeechRequest, VSInstrumentMetrics, NSError, VSAudioData, VSStreamAudioData, VSSpeechEngine, VSCachingService, VSPrewarmService, VSVoiceAssetSelection, VSVoiceResourceAsset, VSVoiceBooster;
