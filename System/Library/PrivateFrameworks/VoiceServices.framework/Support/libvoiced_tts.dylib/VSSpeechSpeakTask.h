...
@class VSSpeechRequest, NSArray, VSSpeechEngine, VSVoiceBooster, VSAudioPlaybackService, VSVoiceAssetSelection, VSVoiceResourceAsset, VSCachingService, VSPrewarmService, VSInstrumentMetrics, VSAudioData, VSStreamAudioData, NSError, NSObject, NSString;

@interface VSSpeechSpeakTask : NSOperation <VSSpeechSpeakableProtocol> {

	BOOL _synthesisHasIssue;
...
@property (nonatomic,retain) VSPrewarmService * prewarmService;                            //@synthesize prewarmService=_prewarmService - In the implementation block
@property (assign,nonatomic) BOOL synthesisHasIssue;                                       //@synthesize synthesisHasIssue=_synthesisHasIssue - In the implementation block
...
-(void)setSynthesisHasIssue:(BOOL)arg1 ;
-(NSArray *)timingInfos;
...
-(void)setPrewarmService:(VSPrewarmService *)arg1 ;
