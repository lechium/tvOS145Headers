...
@property (assign) long long serverFirstPacketTimestamp;                     //@synthesize serverFirstPacketTimestamp=_serverFirstPacketTimestamp - In the implementation block
@property (assign) long long serverLastPacketTimestamp;                      //@synthesize serverLastPacketTimestamp=_serverLastPacketTimestamp - In the implementation block
@property (assign) double serverStreamedAudioDuration;                       //@synthesize serverStreamedAudioDuration=_serverStreamedAudioDuration - In the implementation block
...
@property (assign) BOOL neuralAudioClick;                                    //@synthesize neuralAudioClick=_neuralAudioClick - In the implementation block
