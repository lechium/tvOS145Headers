...
@class NSString, NSURL, NSDictionary, NSArray, NSAttributedString, NSUUID;
...
@property (assign,nonatomic) BOOL shouldStreamAudioData;                              //@synthesize shouldStreamAudioData=_shouldStreamAudioData - In the implementation block
...
@property (nonatomic,copy) NSUUID * accessoryID;                                      //@synthesize accessoryID=_accessoryID - In the implementation block
...
@property (assign,nonatomic) BOOL shouldWaitCurrentSpeaking;                          //@synthesize shouldWaitCurrentSpeaking=_shouldWaitCurrentSpeaking - In the implementation block
...
@property (assign,nonatomic) BOOL shouldWhisper;                                      //@synthesize shouldWhisper=_shouldWhisper - In the implementation block
