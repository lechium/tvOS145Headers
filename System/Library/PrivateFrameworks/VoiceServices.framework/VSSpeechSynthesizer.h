...
@class NSString, NSUUID, NSObject, VSSpeechConnection, NSMutableDictionary;
...
@interface VSSpeechSynthesizer : NSObject <VSSpeechConnectionDelegate> {
	...
	struct {
		...
		unsigned delegateStreamSynthesisAudioData : 1;
...
+(BOOL)playVoicePreviewForLanguageCode:(id)arg1 voiceName:(id)arg2 previewType:(long long)arg3 completion:(/*^block*/id)arg4 ;
...
+(BOOL)playVoicePreviewForLanguageCode:(id)arg1 voiceName:(id)arg2 completion:(/*^block*/id)arg3 ;
-(id)init;
...
-(void)playVoicePreviewForLanguageCode:(id)arg1 gender:(long long)arg2 completion:(/*^block*/id)arg3 ;
-(void)playVoicePreviewForLanguageCode:(id)arg1 voiceName:(id)arg2 previewType:(long long)arg3 completion:(/*^block*/id)arg4 ;
-(void)stopPlayingVoicePreview;
