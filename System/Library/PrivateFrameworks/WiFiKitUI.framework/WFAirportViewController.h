...
@interface WFAirportViewController : WFInsetViewController <UITableViewDataSource, UITableViewDelegate, WFNetworkListing> {
	...
	id<WFNetworkListRecord> _pendingCurrentNetwork;
...
@property (nonatomic,retain) id<WFNetworkListRecord> pendingCurrentNetwork;                          //@synthesize pendingCurrentNetwork=_pendingCurrentNetwork - In the implementation block
...
-(id<WFNetworkListRecord>)pendingCurrentNetwork;
-(void)setPendingCurrentNetwork:(id<WFNetworkListRecord>)arg1 ;
