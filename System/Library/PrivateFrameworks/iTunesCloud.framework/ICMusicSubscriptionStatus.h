...
@property (getter=isPartOfBundle,nonatomic,readonly) BOOL partOfBundle;                                      //@synthesize partOfBundle=_partOfBundle - In the implementation block
@property (getter=isBundleOnwer,nonatomic,readonly) BOOL bundleOwner;                                        //@synthesize bundleOwner=_bundleOwner - In the implementation block
