...
@property (assign,nonatomic) BOOL hasTotalConfiguredBw; 
...
@property (assign,nonatomic) BOOL hasTotalConfiguredMimoLayers; 
...
@property (assign,nonatomic) BOOL hasLteMaxScheduledMimoLayersInACell; 
...
@property (assign,nonatomic) BOOL hasNrMaxDlModulation; 
