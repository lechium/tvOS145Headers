...
- (void).cxx_destruct;	// IMP=0x00000001000023d8
...
- (_Bool)wait:(double)arg1;	// IMP=0x0000000100002280
- (CDUnknownBlockType)createSwitcher;	// IMP=0x000000010000204c
- (id)init;	// IMP=0x0000000100001fe4
