...
- (void).cxx_destruct;	// IMP=0x00000001000153b0
...
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00000001000151ec
- (void)receiveMessage:(char *)arg1 length:(long long)arg2;	// IMP=0x0000000100014f64
- (void)sendNextQueuedMessage;	// IMP=0x0000000100014cfc
- (void)sendMessage:(id)arg1;	// IMP=0x0000000100014ba8
- (void)dealloc;	// IMP=0x00000001000149b4
- (id)initWithDelegate:(id)arg1 pipe:(id)arg2;	// IMP=0x0000000100014750
