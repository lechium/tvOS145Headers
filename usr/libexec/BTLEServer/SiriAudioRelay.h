...
- (void).cxx_destruct;	// IMP=0x000000010000f5d8
...
- (void)sendMsg:(const char *)arg1 args:(id)arg2;	// IMP=0x000000010000f458
- (void)stopStream:(CDUnknownBlockType)arg1;	// IMP=0x000000010000f3ac
- (void)startStream:(CDUnknownBlockType)arg1;	// IMP=0x000000010000f300
- (void)handleResetStream;	// IMP=0x000000010000f27c
- (void)handleStopStream;	// IMP=0x000000010000f0f8
- (void)handleStartStream;	// IMP=0x000000010000ef74
- (void)publish;	// IMP=0x000000010000edac
- (void)cancelStream;	// IMP=0x000000010000ed28
- (void)invalidate;	// IMP=0x000000010000eca4
- (void)sendAudioFrame:(id)arg1;	// IMP=0x000000010000ebb4
- (_Bool)isHubConnected;	// IMP=0x000000010000eb68
- (id)initWithIdentifier:(id)arg1 properties:(id)arg2 codecType:(unsigned char)arg3 hub:(id)arg4;	// IMP=0x000000010000ea8c
