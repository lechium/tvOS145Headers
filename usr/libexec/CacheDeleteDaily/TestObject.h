...
+ (id)testObjectWithInfo:(id)arg1;	// IMP=0x00000001000077c4
...
- (unsigned long long)deletes;	// IMP=0x0000000100007b54
- (void)addDeletes:(unsigned long long)arg1;	// IMP=0x0000000100007a88
- (void)addTerminationFailure:(id)arg1;	// IMP=0x00000001000079c0
- (void)addRemoveFailure:(id)arg1;	// IMP=0x00000001000078f8
- (id)description;	// IMP=0x0000000100007818
- (id)initWithInfo:(id)arg1;	// IMP=0x00000001000074a8
