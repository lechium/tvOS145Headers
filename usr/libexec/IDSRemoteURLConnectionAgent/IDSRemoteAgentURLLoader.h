...
+ (_Bool)shouldAssertWiFi;	// IMP=0x00000001000056ec
- (void).cxx_destruct;	// IMP=0x0000000100005ed8
...
- (void)cancel;	// IMP=0x0000000100005cd4
- (void)load;	// IMP=0x0000000100005a58
- (void)dealloc;	// IMP=0x0000000100005a24
- (id)initWithURLRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100005804
