...
- (void).cxx_destruct;	// IMP=0x00000001000048d8
- (void)submitWithOptions:(id)arg1 resultsCallback:(CDUnknownBlockType)arg2;	// IMP=0x0000000100003c08
- (void)_setupScheduler;	// IMP=0x0000000100003aa8
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000039c4
- (void)handleOptInChange;	// IMP=0x0000000100003668
- (void)handleWatchDog;	// IMP=0x00000001000034c0
- (void)handleUnlock;	// IMP=0x0000000100003440
- (id)init;	// IMP=0x00000001000031b0
