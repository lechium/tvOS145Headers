...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000100081a38
- (void)setServiceDelegate:(id)arg1;	// IMP=0x00000001000819b4
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x00000001000813f8
- (void)invalidate;	// IMP=0x00000001000813e4
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x0000000100080f34
- (id)init;	// IMP=0x0000000100080efc
