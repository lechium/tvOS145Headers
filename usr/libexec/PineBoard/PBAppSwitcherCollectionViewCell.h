...
- (void).cxx_destruct;	// IMP=0x0000000100166a6c
...
- (void)_setShadowRadius:(double)arg1 alpha:(double)arg2;	// IMP=0x00000001001666d4
- (void)_setDimingAlpha:(double)arg1;	// IMP=0x0000000100166658
- (void)_setContentAlpha:(double)arg1;	// IMP=0x00000001001665f0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001001663ac
- (void)layoutSubviews;	// IMP=0x0000000100165da0
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x00000001001658f0
- (void)dealloc;	// IMP=0x0000000100165890
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100165234
