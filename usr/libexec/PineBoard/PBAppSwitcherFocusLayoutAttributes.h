...
- (id)description;	// IMP=0x000000010010192c
- (unsigned long long)hash;	// IMP=0x00000001001015b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100100fd8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100100c88
