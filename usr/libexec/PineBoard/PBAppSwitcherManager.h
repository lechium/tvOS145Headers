...
+ (id)defaultManager;	// IMP=0x00000001000cc0a0
- (void).cxx_destruct;	// IMP=0x00000001000cd6c4
...
- (_Bool)dismissAppSwitcherToBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000ccda4
- (void)presentAppSwitcherWithFocusedBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000cc494
- (void)invalidateSceneHosting;	// IMP=0x00000001000cc480
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (_Bool)shouldActivateForProcessWithIdentifier:(id)arg1;	// IMP=0x00000001000cc2d4
- (id)_init;	// IMP=0x00000001000cc1e4
- (id)init;	// IMP=0x00000001000cc1a8
