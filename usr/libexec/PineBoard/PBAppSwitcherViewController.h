...
- (void).cxx_destruct;	// IMP=0x00000001001fddd8
...
- (void)invalidateSceneLayoutElements;	// IMP=0x00000001001fdc44
- (void)transitionToSwitcherWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001001fdafc
- (id)preferredFocusEnvironments;	// IMP=0x00000001001fdac0
- (void)viewDidLoad;	// IMP=0x00000001001fd864
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000001001fd778
