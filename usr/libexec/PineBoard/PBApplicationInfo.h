...
@interface PBApplicationInfo : _UIApplicationInfo
{
    ...
    _Bool _cloudDemoted;	// 21 = 0x15
    _Bool _installedByMagellan;	// 22 = 0x16
    _Bool _iconVisibilitySetByPreference;	// 23 = 0x17
    unsigned char _iconVisibilityDefaultVisible;	// 24 = 0x18
    _Bool _hasAllowIconVisibilityChangesEntitlement;	// 25 = 0x19
    _Bool _hasRunAsCurrentUserEntitlement;	// 26 = 0x1a
    _Bool _gameCenterEnabled;	// 27 = 0x1b
    _Bool _hasGetCurrentUserEntitlement;	// 28 = 0x1c
    _Bool _archerLinked;	// 29 = 0x1d
    _Bool _supportsBrowsingChannelGuideUserActivityType;	// 30 = 0x1e
...
+ (_Bool)_isExtraMultiUserApplication:(id)arg1;	// IMP=0x00000001000b5d04
+ (id)_infoPlistKeys;	// IMP=0x00000001000b5b7c
+ (id)_entitlementKeys;	// IMP=0x00000001000b5a40
- (void).cxx_destruct;	// IMP=0x00000001000b63e4
...
- (void)_refreshRunsAsCurrentUser;	// IMP=0x00000001000b580c
- (void)_refreshLocalizedName;	// IMP=0x00000001000b569c
- (id)getEntitlementValueUncached:(id)arg1 ofClass:(Class)arg2;	// IMP=0x00000001000b55a8
- (id)getInfoPlistValueUncached:(id)arg1;	// IMP=0x00000001000b5330
...
- (void)_loadFromProxy:(id)arg1;	// IMP=0x00000001000b3ec0
- (void)pb_reportUntrustedLaunchAttempt;	// IMP=0x0000000100238d54
