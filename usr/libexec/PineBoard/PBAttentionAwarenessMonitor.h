...
- (void).cxx_destruct;	// IMP=0x000000010014b454
...
- (void)_notifyAttentionRegained;	// IMP=0x000000010014b21c
- (void)_notifyAttentionLost;	// IMP=0x000000010014b0a4
- (void)removeObserver:(id)arg1;	// IMP=0x000000010014b044
- (void)addObserver:(id)arg1;	// IMP=0x000000010014afe4
- (_Bool)suspendWithError:(id *)arg1;	// IMP=0x000000010014afa4
- (_Bool)resumeWithError:(id *)arg1;	// IMP=0x000000010014af64
@property(readonly, nonatomic) double timeout;
- (id)initWithTimeout:(double)arg1 observerQueue:(id)arg2;	// IMP=0x000000010014aa18
