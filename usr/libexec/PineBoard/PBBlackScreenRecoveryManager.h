...
+ (id)sharedInstance;	// IMP=0x00000001000ab5a4
+ (id)dependencyDescription;	// IMP=0x00000001000ab418
- (void).cxx_destruct;	// IMP=0x00000001000acc70
...
- (void)dismiss;	// IMP=0x00000001000acb40
- (void)presentForDisplayModes:(id)arg1 selectionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000ab960
...
- (id)init;	// IMP=0x00000001000ab6a0
