...
- (void).cxx_destruct;	// IMP=0x00000001001595e8
...
- (void)_didDismiss:(id)arg1;	// IMP=0x00000001001593ec
- (void)_willDismiss:(id)arg1;	// IMP=0x0000000100159354
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100159158
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100158ed8
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (_Bool)definesPresentationContext;	// IMP=0x0000000100158ea0
- (void)dealloc;	// IMP=0x0000000100158da0
- (id)initWithContentViewController:(id)arg1 supportsInterruption:(_Bool)arg2;	// IMP=0x0000000100158bc0
