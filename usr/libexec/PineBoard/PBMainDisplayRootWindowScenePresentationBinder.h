...
+ (id)sharedInstance;	// IMP=0x0000000100113980
+ (id)dependencyDescription;	// IMP=0x00000001001138d4
- (void).cxx_destruct;	// IMP=0x0000000100113c1c
@property(readonly, nonatomic) UIRootSceneWindow *rootWindow; // @synthesize rootWindow=_rootWindow;
- (id)init;	// IMP=0x0000000100113a48
