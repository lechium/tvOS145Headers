...
+ (id)_allAudioMediaTypes;	// IMP=0x00000001001c5d78
+ (id)_bulletinInfoForNowPlayingInfo:(id)arg1;	// IMP=0x00000001001c591c
+ (id)sharedInstance;	// IMP=0x00000001001c2774
+ (id)dependencyDescription;	// IMP=0x00000001001c26c8
- (void).cxx_destruct;	// IMP=0x00000001001c5fa4
...
- (void)_updateWithNowPlayingInfoDictionary:(id)arg1 playbackState:(unsigned int)arg2 nowPlayingPID:(int)arg3;	// IMP=0x00000001001c4510
- (void)_performMetadataUpdate;	// IMP=0x00000001001c3bb4
- (void)_setNeedsMetadataUpdate;	// IMP=0x00000001001c3814
- (void)_presentTrackChangeBulletinWithInfo:(id)arg1;	// IMP=0x00000001001c3540
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x00000001001c3470
- (void)_nowPlayingAppDidChange:(id)arg1;	// IMP=0x00000001001c3288
- (void)_nowPlayingAppPlaybackStateDidChange:(id)arg1;	// IMP=0x00000001001c3184
- (void)_nowPlayingInfoDidChange:(id)arg1;	// IMP=0x00000001001c3080
- (void)_remotePlayerPlaybackStateDidChange:(id)arg1;	// IMP=0x00000001001c2f58
...
- (_Bool)nowPlayingMediaTypeAudioOnly;	// IMP=0x00000001001c2a6c
- (void)stopObserving;	// IMP=0x00000001001c2a10
- (void)startObserving;	// IMP=0x00000001001c28c8
- (void)dealloc;	// IMP=0x00000001001c2870
