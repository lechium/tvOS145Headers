...
- (void).cxx_destruct;	// IMP=0x00000001000dc3a8
...
- (id)_makeTransitionPayload;	// IMP=0x00000001000dc064
- (id)_payloadSourceApplication;	// IMP=0x00000001000dbf1c
- (_Bool)_shouldSendPayloadSourceApplication;	// IMP=0x00000001000dbd0c
- (id)_makeTransitionActions;	// IMP=0x00000001000db9fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000db994
- (unsigned long long)hash;	// IMP=0x00000001000db87c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000db560
- (id)debugDescription;	// IMP=0x00000001000db2e8
- (id)description;	// IMP=0x00000001000db1a8
- (id)makeSceneTransitionContext;	// IMP=0x00000001000daf38
- (id)makeProcessExecutionContext;	// IMP=0x00000001000dac00
...
- (id)_initWithOpenApplicationOptions:(id)arg1 auditToken:(id)arg2 trustedRequest:(_Bool)arg3 fromAppInfo:(id)arg4 toAppInfo:(id)arg5;	// IMP=0x00000001000da1c4
- (id)initWithRequest:(id)arg1 fromAppInfo:(id)arg2 toAppInfo:(id)arg3;	// IMP=0x00000001000da020
