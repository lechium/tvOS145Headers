...
- (void).cxx_destruct;	// IMP=0x000000010019ae6c
...
- (void)_performReducedMotionAnimation;	// IMP=0x000000010019a7ec
- (void)_performDefaultAnimation;	// IMP=0x000000010019a550
- (void)startAnimation;	// IMP=0x000000010019a500
- (id)initWithContext:(unsigned long long)arg1 layout:(id)arg2 targetSize:(struct CGSize)arg3 quadrant:(long long)arg4 pipInsets:(struct UIEdgeInsets)arg5;	// IMP=0x000000010019a334
