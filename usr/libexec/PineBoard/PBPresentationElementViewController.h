...
- (void).cxx_destruct;	// IMP=0x00000001000c0808
...
- (void)_updateState;	// IMP=0x00000001000c037c
- (void)_removeAcceptsEventObserverForViewController:(id)arg1;	// IMP=0x00000001000c02c4
- (void)_addAcceptsEventObserverForViewController:(id)arg1;	// IMP=0x00000001000c01f8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000c00e0
- (void)setContentViewController:(id)arg1 animated:(_Bool)arg2 transitionBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000001000bfc14
- (id)preferredFocusEnvironments;	// IMP=0x00000001000bfb50
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000001000bf95c
- (void)loadView;	// IMP=0x00000001000bf894
- (id)initWithLayoutLevel:(long long)arg1;	// IMP=0x00000001000bf7b8
