...
- (void).cxx_destruct;	// IMP=0x000000010002f880
...
- (id)description;	// IMP=0x000000010002f4f0
- (unsigned long long)hash;	// IMP=0x000000010002f4bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010002f354
- (id)initWithToken:(id)arg1 requestType:(unsigned long long)arg2;	// IMP=0x000000010002f268
- (id)initWithToken:(id)arg1;	// IMP=0x000000010002f1d4
- (id)init;	// IMP=0x000000010002f19c
