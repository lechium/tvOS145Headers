...
- (void).cxx_destruct;	// IMP=0x00000001001cbd08
...
- (void)invalidateImage;	// IMP=0x00000001001cbbe8
- (id)fetchImage;	// IMP=0x00000001001cb0d0
- (id)initWithSnapshotPredicate:(id)arg1 sceneID:(id)arg2 bundleIdentifier:(id)arg3 scaleFactor:(double)arg4;	// IMP=0x00000001001caedc
- (id)init;	// IMP=0x00000001001caea4
