...
- (void).cxx_destruct;	// IMP=0x00000001000ecba4
...
- (void)_beginDismissalTransactionAnimated:(_Bool)arg1 shouldUpdateWallpaper:(_Bool)arg2 shouldApplyStartValues:(_Bool)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000ec7b0
- (void)viewServiceDidTerminate;	// IMP=0x00000001000ec700
- (void)viewServiceDidDismiss:(id)arg1;	// IMP=0x00000001000ec680
- (void)viewService:(id)arg1 willDismissWithResult:(id)arg2;	// IMP=0x00000001000ec5d0
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000ec1b4
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000ebf98
- (void)screenSaverTransitionUpdatedAcceptEvents:(_Bool)arg1;	// IMP=0x00000001000ebbe4
- (void)screenSaverTransitionShowSnapshotImage:(id)arg1;	// IMP=0x00000001000eba50
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (void)viewDidLoad;	// IMP=0x00000001000eb71c
- (id)initWithChildViewController:(id)arg1;	// IMP=0x00000001000eb590
