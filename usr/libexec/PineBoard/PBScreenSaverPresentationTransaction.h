...
- (void).cxx_destruct;	// IMP=0x0000000100188158
...
- (void)_prepareKioskAnimationInTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100187b0c
- (id)_defaultAppAnimationTransaction;	// IMP=0x00000001001879dc
- (void)_begin;	// IMP=0x000000010018737c
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100187360
- (id)initWithScreenSaverViewController:(id)arg1 animated:(_Bool)arg2 options:(id)arg3;	// IMP=0x0000000100187208
