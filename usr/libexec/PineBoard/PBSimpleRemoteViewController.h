...
+ (id)exportedInterface;	// IMP=0x00000001001ac798
+ (id)serviceViewControllerInterface;	// IMP=0x00000001001ac454
- (void).cxx_destruct;	// IMP=0x00000001001acb94
...
- (void)dealloc;	// IMP=0x00000001001ac3f0
- (void)_dismissViewServiceAnimated:(_Bool)arg1 withOptions:(id)arg2 dismissalResult:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001001abe18
- (void)dismissWithResult:(id)arg1;	// IMP=0x00000001001aba40
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x00000001001ab8d0
- (void)dismissViewServiceAnimated:(_Bool)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001ab830
- (void)messageViewServiceWithMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001001ab66c
- (void)prepareViewServiceAnimated:(_Bool)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001ab3f8
