...
- (void).cxx_destruct;	// IMP=0x000000010014ed50
...
- (void)_begin;	// IMP=0x000000010014e868
- (void)interruptWithContext:(id)arg1;	// IMP=0x000000010014e7f4
- (_Bool)_canBeInterrupted;	// IMP=0x000000010014e7b4
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 presentationDelegate:(id)arg4;	// IMP=0x000000010014e648
- (id)init;	// IMP=0x000000010014e610
