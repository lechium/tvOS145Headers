...
@class INDateComponentsRange, NSArray, NSData, NSDictionary, NSNumber, NSString, NSXPCListenerEndpoint, PBSAudioUpsellConfiguration, UARPAccessoryID;
...
- (void)fetchUserPreferenceForFirmwareUpdatesForAccessoryID:(UARPAccessoryID *)arg1 reply:(void (^)(_Bool))arg2;
- (void)presentAirDropPromptForDiagnosticFileWithOptions:(NSDictionary *)arg1;
- (void)handleShowHomeIntentWithFilters:(NSArray *)arg1 time:(INDateComponentsRange *)arg2;
