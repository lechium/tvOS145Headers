...
+ (void)_getViewServiceInfoForRequest:(id)arg1 serviceName:(id *)arg2 className:(id *)arg3;	// IMP=0x0000000100169454
- (void).cxx_destruct;	// IMP=0x000000010016b36c
...
- (void)_queueCallHandlersForRequest:(id)arg1 withReason:(unsigned long long)arg2 result:(id)arg3 error:(id)arg4;	// IMP=0x000000010016ab34
- (void)_queueSendPendingMessagesForRequest:(id)arg1;	// IMP=0x000000010016a1dc
- (void)_callMessageReply:(CDUnknownBlockType)arg1 forRequest:(id)arg2 success:(_Bool)arg3 result:(id)arg4 error:(id)arg5;	// IMP=0x0000000100169c98
- (void)_handleClientDismissalWithContext:(id)arg1 dismissalContext:(id)arg2;	// IMP=0x0000000100169854
- (void)_handleCreatedRemoteViewController:(id)arg1 forRequest:(id)arg2;	// IMP=0x0000000100169604
- (void)dialogManager:(id)arg1 didCancelDialogWithContext:(id)arg2 dismissalContext:(id)arg3;	// IMP=0x000000010016932c
- (void)dialogManager:(id)arg1 willDismissDialogWithContext:(id)arg2 dismissalContext:(id)arg3;	// IMP=0x0000000100169204
- (void)dismissUIWithRequest:(id)arg1;	// IMP=0x0000000100168cf0
- (void)messageUIWithRequest:(id)arg1 message:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010016872c
- (void)presentUIWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100167494
- (void)invalidate;	// IMP=0x0000000100166e9c
- (void)dealloc;	// IMP=0x0000000100166e1c
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x0000000100166b78
- (id)init;	// IMP=0x0000000100166b40
