...
+ (id)sharedInstance;	// IMP=0x0000000100161da0
+ (id)dependencyDescription;	// IMP=0x0000000100161be0
- (void).cxx_destruct;	// IMP=0x0000000100162630
...
- (void)prepareUIForSystemOverlayPresentationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100162590
@property(readonly, nonatomic, getter=isPresenting) _Bool presenting;
- (void)updateWallpaperWithTransitionContext:(id)arg1;	// IMP=0x00000001001624f4
- (void)dismissWallpaperAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001623d8
- (void)presentWallpaperAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001622a4
- (id)init;	// IMP=0x0000000100161e68
