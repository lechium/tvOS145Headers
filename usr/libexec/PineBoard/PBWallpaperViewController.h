...
- (void).cxx_destruct;	// IMP=0x0000000100155b4c
...
- (void)sceneManager:(id)arg1 didChangeCurrentApplicationFromSceneHandle:(id)arg2 toSceneHandle:(id)arg3;	// IMP=0x0000000100155908
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001556a4
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100155440
...
- (id)_wallpaperForApplicationSceneHandle:(id)arg1 withVariant:(long long)arg2;	// IMP=0x0000000100155294
- (void)_updateWallpaperForApplicationSceneHandle:(id)arg1;	// IMP=0x000000010015514c
- (void)updateWallpaperWithTransitionContext:(id)arg1;	// IMP=0x0000000100154da0
- (void)setIdleModeActive:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100154a44
- (void)viewDidLoad;	// IMP=0x0000000100154990
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100154858
