...
- (void).cxx_destruct;	// IMP=0x00000001000865e4
...
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100086518
- (void)_begin;	// IMP=0x0000000100086214
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000100086084
