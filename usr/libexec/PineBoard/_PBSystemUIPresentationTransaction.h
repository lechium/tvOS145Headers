...
- (void).cxx_destruct;	// IMP=0x000000010018eb20
...
- (_Bool)_canBeInterrupted;	// IMP=0x000000010018ea54
- (void)_begin;	// IMP=0x000000010018e6a0
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000010018e510
