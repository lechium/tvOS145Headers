...
+ (id)defaultAccountsModel;	// IMP=0x00000001000105a4
...
- (void)update;	// IMP=0x0000000100010d14
...
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x0000000100010758
- (id)init;	// IMP=0x0000000100010628
