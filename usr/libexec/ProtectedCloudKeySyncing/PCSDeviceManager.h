...
+ (id)sharedManager;	// IMP=0x0000000100005f24
...
- (void)updatedIDSDevices:(id)arg1;	// IMP=0x00000001000068fc
@property(readonly) NSArray *allDevices;
- (id)deviceForPairingID:(id)arg1;	// IMP=0x0000000100006448
- (id)deviceForIDSIdentifier:(id)arg1;	// IMP=0x00000001000061b8
- (id)currentActivePairedDevice;	// IMP=0x0000000100006014
