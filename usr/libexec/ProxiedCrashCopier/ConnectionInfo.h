...
- (void).cxx_destruct;	// IMP=0x0000000100004adc
@property(readonly) NSString *connectionType; // @synthesize connectionType=_connectionType;
- (void)reachabilityCallback:(id)arg1;	// IMP=0x0000000100004ac4
@property(readonly) _Bool onCellular;
- (void)dealloc;	// IMP=0x0000000100004a78
- (id)init;	// IMP=0x0000000100004798
