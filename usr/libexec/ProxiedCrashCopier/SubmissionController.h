...
- (void).cxx_destruct;	// IMP=0x0000000100004738
...
- (void)handleWatchDog;	// IMP=0x0000000100003310
- (void)handleUnlock;	// IMP=0x0000000100003290
- (id)init;	// IMP=0x0000000100003000
