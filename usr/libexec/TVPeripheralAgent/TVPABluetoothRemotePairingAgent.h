...
- (void)_peripheralStateDidChangeNotification:(id)arg1;	// IMP=0x00000001000070a0
- (void)_handleRemoteDidPair;	// IMP=0x0000000100006dcc
- (void)_handlePairingTimeout;	// IMP=0x0000000100006ce0
- (void)unpairAllRemotes;	// IMP=0x00000001000069d4
- (void)stopProximityPairing;	// IMP=0x00000001000068dc
- (void)startProximityPairing;	// IMP=0x0000000100006554
- (void)dealloc;	// IMP=0x000000010000644c
