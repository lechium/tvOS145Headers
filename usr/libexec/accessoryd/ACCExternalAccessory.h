...
+ (id)accessoryDictionaryForLogging:(id)arg1;	// IMP=0x00000001000bea04
+ (unsigned int)_generateLegacyIAPConnectionID;	// IMP=0x00000001000be98c
- (void).cxx_destruct;	// IMP=0x00000001000bec90
...
- (void)_constructEADictionary:(id)arg1;	// IMP=0x00000001000bdba0
- (void)_addEAProtocolsForEAEndpoints:(id)arg1;	// IMP=0x00000001000bd840
- (void)_addEAProtocolPrimaryEndpointInfo:(struct ACCEndpoint_s *)arg1;	// IMP=0x00000001000bd518
- (id)_nativeUSBEndpointUUIDForProtocolIdentifier:(id)arg1 iAP2Endpoint:(CDStruct_4aa09b98 *)arg2;	// IMP=0x00000001000bd25c
- (void)_addiAP2VehicleInfo:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000bcbd4
- (void)_addiAP2EAProtocols:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000bc454
- (void)_addiAP2IdentificationInfo:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000bc1f8
- (void)_addAccessoryInfo:(struct ACCEndpoint_s *)arg1;	// IMP=0x00000001000bbd14
- (void)_addiAP2AuthInfo:(CDStruct_4aa09b98 *)arg1;	// IMP=0x00000001000bbc8c
- (id)copyExternalAccessoryProtocols;	// IMP=0x00000001000bbb84
- (id)externalAccessoryProtocolInformationForProtocolName:(id)arg1;	// IMP=0x00000001000bb958
- (void)updateAccessoryInfo;	// IMP=0x00000001000bb05c
- (id)description;	// IMP=0x00000001000bb008
- (id)initWithEndpointUUIDs:(id)arg1 primaryEndpointUUID:(id)arg2;	// IMP=0x00000001000bacf0
