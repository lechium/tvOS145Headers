...
- (void).cxx_destruct;	// IMP=0x00000001000865c4
...
- (void)powerInfoChangeNotificationHandler:(id)arg1;	// IMP=0x000000010008563c
- (void)systemHasPoweredOnNotificationHandler:(id)arg1;	// IMP=0x00000001000851c8
- (void)systemWillSleepNotificationHandler:(id)arg1;	// IMP=0x0000000100084cdc
- (void)stopPowerUpdates;	// IMP=0x0000000100084b38
- (void)startPowerUpdates;	// IMP=0x00000001000843c4
- (_Bool)isOldUpdateTypeEnabled:(int)arg1;	// IMP=0x0000000100084388
- (_Bool)isUpdateTypeEnabled:(int)arg1;	// IMP=0x000000010008434c
- (void)startSiphoningControl;	// IMP=0x00000001000842f4
- (void)dealloc;	// IMP=0x0000000100084268
- (id)initWithEndpointUID:(id)arg1 andBitmask:(unsigned long long)arg2 andOldBitmask:(unsigned long long)arg3;	// IMP=0x000000010008412c
