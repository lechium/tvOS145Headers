...
- (void).cxx_destruct;	// IMP=0x000000010007834c
...
- (void)clearContinuationTokenIfSupported;	// IMP=0x0000000100077e10
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000768f0
@property(readonly, nonatomic, getter=isContextSecretValidForSRP) _Bool contextSecretValidForSRP;
- (id)initWithContext:(id)arg1;	// IMP=0x0000000100076824
