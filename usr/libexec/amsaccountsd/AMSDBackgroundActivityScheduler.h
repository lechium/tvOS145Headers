...
- (void).cxx_destruct;	// IMP=0x0000000100007544
...
- (void)schedule;	// IMP=0x0000000100006b1c
- (void)invalidate;	// IMP=0x0000000100006aa0
- (void)checkIn;	// IMP=0x0000000100006884
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000001000067b4
