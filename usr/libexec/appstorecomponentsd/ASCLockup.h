...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100005fc8
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x0000000100007548
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x000000010000723c
- (id)featureWithClass:(Class)arg1;	// IMP=0x0000000100007104
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000067d8
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100006570
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000062d8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100005fd0
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x0000000100005f8c
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x0000000100005d14
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x0000000100003eec
@property(readonly, copy, nonatomic) NSSet *signpostTags;
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x0000000100007838
