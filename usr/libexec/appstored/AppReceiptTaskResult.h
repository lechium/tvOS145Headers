...
- (void).cxx_destruct;	// IMP=0x000000010009fdbc
...
- (void)addRefreshed:(id)arg1;	// IMP=0x000000010009fcf0
- (void)addRevoked:(id)arg1;	// IMP=0x000000010009fc78
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010009fb6c
