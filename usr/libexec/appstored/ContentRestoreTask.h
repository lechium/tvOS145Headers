...
- (void).cxx_destruct;	// IMP=0x00000001000c3420
...
- (id)_newBodyDictionaryWithAccountID:(id)arg1;	// IMP=0x00000001000c2aec
- (void)main;	// IMP=0x00000001000c2244
- (id)initWithRestoreAppInstalls:(id)arg1 account:(id)arg2;	// IMP=0x00000001000c2190
