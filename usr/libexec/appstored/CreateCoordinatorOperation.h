...
- (void).cxx_destruct;	// IMP=0x000000010005cfe4
...
- (id)_newCoordinatorWithType:(unsigned long long)arg1 forBundleID:(id)arg2 createIfNotExisting:(_Bool)arg3 wasCreated:(_Bool *)arg4 error:(id *)arg5;	// IMP=0x000000010005cd28
- (_Bool)_cancelOwnedCoordinatorsForBundleID:(id)arg1;	// IMP=0x000000010005cb20
- (void)main;	// IMP=0x000000010005c758
- (id)initWithBundleID:(id)arg1 coordinatorType:(unsigned long long)arg2;	// IMP=0x000000010005c6a4
