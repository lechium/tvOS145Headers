...
- (void).cxx_destruct;	// IMP=0x00000001001c10a4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001c0ea0
@property(readonly, nonatomic) RestoreAppInstall *restoreAppInstall;
- (id)initWithApplication:(id)arg1;	// IMP=0x00000001001c0b88
