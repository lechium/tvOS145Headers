...
- (void).cxx_destruct;	// IMP=0x00000001001f8204
...
- (id)_formatTimeInternal:(long long)arg1;	// IMP=0x00000001001f7f24
- (id)_simpleTime:(id)arg1;	// IMP=0x00000001001f7e5c
- (id)_simpleDate:(id)arg1;	// IMP=0x00000001001f7d54
- (id)description;	// IMP=0x00000001001f7be0
- (id)dictionary;	// IMP=0x00000001001f770c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001f74d0
