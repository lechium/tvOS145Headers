...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x00000001001b88d8
- (void).cxx_destruct;	// IMP=0x00000001001b8f64
...
- (id)description;	// IMP=0x00000001001b8844
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x00000001001b85a0
