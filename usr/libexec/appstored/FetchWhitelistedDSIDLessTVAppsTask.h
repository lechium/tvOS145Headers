...
- (void).cxx_destruct;	// IMP=0x000000010005a830
...
- (void)_lookupWhitelistedProviderAppsWithOutError:(id *)arg1;	// IMP=0x000000010005a374
- (void)_lookupHeadboardAppsWithOutError:(id *)arg1;	// IMP=0x0000000100059a48
- (void)main;	// IMP=0x000000010005999c
