...
- (void).cxx_destruct;	// IMP=0x0000000100188720
...
- (void)handleEngagementRequest:(id)arg1 purchase:(id)arg2 purchaseQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001001881c8
- (void)handleDialogRequest:(id)arg1 purchase:(id)arg2 purchaseQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100187f78
- (void)handleAuthenticateRequest:(id)arg1 purchase:(id)arg2 purchaseQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100187d28
- (id)_processPurchaseResult:(id)arg1;	// IMP=0x0000000100187c58
- (id)_authenticateWithClientInfo:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001877a0
- (id)_buyParams;	// IMP=0x0000000100186d74
- (void)main;	// IMP=0x000000010018614c
- (id)initWithProductIdentifier:(id)arg1 quantity:(unsigned long long)arg2 client:(id)arg3;	// IMP=0x0000000100185fc0
- (id)initWithBuyParams:(id)arg1 client:(id)arg2;	// IMP=0x0000000100185eb8
