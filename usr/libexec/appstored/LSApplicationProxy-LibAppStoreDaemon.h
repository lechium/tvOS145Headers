...
- (_Bool)_lib_isValidDSID:(id)arg1;	// IMP=0x00000001000a4418
- (id)lib_storeMetadataError:(id *)arg1;	// IMP=0x00000001000a4380
- (id)lib_extensionType:(long long)arg1;	// IMP=0x00000001000a41ec
