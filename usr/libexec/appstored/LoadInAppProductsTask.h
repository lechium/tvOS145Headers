...
- (void).cxx_destruct;	// IMP=0x000000010016f7a0
...
- (id)_parseResponse:(id)arg1 error:(id *)arg2;	// IMP=0x000000010016eb60
- (id)_requestBatches:(id)arg1 error:(id *)arg2;	// IMP=0x000000010016e6fc
- (id)_queryDictionary;	// IMP=0x000000010016e158
- (void)main;	// IMP=0x000000010016da28
- (id)initWithProductIdentifiers:(id)arg1 client:(id)arg2;	// IMP=0x000000010016d974
