...
+ (id)shortNameForAppUsageType:(long long)arg1;	// IMP=0x0000000100215620
+ (id)contextForType:(long long)arg1;	// IMP=0x00000001002155ec
- (void).cxx_destruct;	// IMP=0x0000000100215d30
...
- (id)_startDateForAppUsageType:(long long)arg1;	// IMP=0x0000000100215b50
- (void)_recordLaunchesIntervalStartDateForAppUsageType:(long long)arg1;	// IMP=0x0000000100215b20
- (void)_recordIntervalStartDateForAppUsageType:(long long)arg1;	// IMP=0x0000000100215af0
- (void)_setLogKey:(id)arg1;	// IMP=0x0000000100215ae4
- (id)_metricsTopic;	// IMP=0x0000000100215a04
- (id)_launchesStartDateForAppUsageType:(long long)arg1;	// IMP=0x00000001002159b8
- (void)recordLaunchesIntervalStartDate;	// IMP=0x0000000100215878
- (void)recordIntervalStartDate;	// IMP=0x0000000100215738
@property(readonly, nonatomic) Class metadataEntityClass;
@property(readonly, nonatomic) Class appEventEntityClass;
- (id)initWithAppUsageType:(long long)arg1;	// IMP=0x0000000100215274
