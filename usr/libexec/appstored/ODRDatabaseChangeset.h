...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001c6ed8
@property(readonly, copy) NSSet *deletedStorageIDs;
@property(readonly, copy) NSSet *deletedAssetPackURLs;
- (void)unionChangeset:(id)arg1;	// IMP=0x00000001001c6d98
- (void)addDeletedStorageID:(id)arg1;	// IMP=0x00000001001c6cf4
- (void)addDeletedAssetPackURL:(id)arg1;	// IMP=0x00000001001c6c50
