...
+ (id)newContextWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x00000001000d6828
- (void).cxx_destruct;	// IMP=0x00000001000d69b4
...
- (id)_initWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x00000001000d68b8
