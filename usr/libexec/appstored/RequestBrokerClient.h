...
- (void).cxx_destruct;	// IMP=0x0000000100264354
...
- (void)_trackRequest:(id)arg1;	// IMP=0x0000000100264294
- (void)_releaseRequest:(id)arg1;	// IMP=0x000000010026421c
- (id)description;	// IMP=0x0000000100264148
- (void)submitRequest:(id)arg1 delegate:(id)arg2 withReplyHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100263ff4
- (void)cancelAllRequestsWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100263c68
- (void)queueTask:(id)arg1;	// IMP=0x0000000100263b60
- (void)invalidate;	// IMP=0x0000000100263b20
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000100263980
