...
- (void).cxx_destruct;	// IMP=0x000000010009e2b8
...
- (void)_setResponse:(id)arg1;	// IMP=0x000000010009e20c
@property(readonly) ASDRequestResponse *response; // @synthesize response=_response;
- (id)initForClient:(id)arg1 withOptions:(id)arg2;	// IMP=0x000000010009e05c
