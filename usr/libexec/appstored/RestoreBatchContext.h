...
- (void).cxx_destruct;	// IMP=0x000000010010c8c0
...
- (void)softFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x000000010010c7ec
- (void)itemSucceeded:(id)arg1 storeItem:(id)arg2;	// IMP=0x000000010010c518
- (void)hardFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x000000010010c47c
- (id)initWithItems:(id)arg1 account:(id)arg2;	// IMP=0x000000010010c084
