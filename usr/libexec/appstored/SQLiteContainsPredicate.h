...
+ (id)doesNotContainPredicateWithProperty:(id)arg1 values:(id)arg2;	// IMP=0x00000001001bb214
+ (id)containsPredicateWithProperty:(id)arg1 query:(id)arg2 queryProperty:(id)arg3;	// IMP=0x00000001001bb110
+ (id)containsPredicateWithProperty:(id)arg1 values:(id)arg2;	// IMP=0x00000001001bb04c
- (void).cxx_destruct;	// IMP=0x00000001001bb8c4
...
- (id)SQLForEntityClass:(Class)arg1;	// IMP=0x00000001001bb684
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001bb444
- (void)applyBinding:(id)arg1 atIndex:(inout int *)arg2;	// IMP=0x00000001001bb2e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001bb2dc
