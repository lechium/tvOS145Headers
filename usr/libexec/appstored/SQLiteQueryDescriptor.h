...
- (void).cxx_destruct;	// IMP=0x0000000100164714
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000001001640ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100163ff4
