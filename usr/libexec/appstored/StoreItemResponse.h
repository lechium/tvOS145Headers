...
+ (id)updateItemResponseWithDictionary:(id)arg1 installedItem:(id)arg2;	// IMP=0x000000010023cfc0
+ (id)universalItemResponseWithDictionary:(id)arg1;	// IMP=0x000000010023cf68
+ (id)errorItemResponseWithError:(id)arg1 accountID:(id)arg2;	// IMP=0x000000010023cef4
+ (id)defaultItemResponseWithDictionary:(id)arg1;	// IMP=0x000000010023ce9c
+ (id)purchase_itemResponseWithError:(id)arg1 usingPurchaseInfo:(id)arg2;	// IMP=0x0000000100255f3c
+ (id)purchase_itemResponseFromDictionary:(id)arg1 usingPurchaseInfo:(id)arg2;	// IMP=0x0000000100255d80
- (void).cxx_destruct;	// IMP=0x000000010023e178
...
- (id)_optimalDownloadWindowFromDictionary:(id)arg1;	// IMP=0x000000010023dcb4
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x000000010023dbe4
- (id)errorForItemID:(id)arg1;	// IMP=0x000000010023dbd4
- (id)_initWithError:(id)arg1 accountID:(id)arg2;	// IMP=0x000000010023db30
- (id)_initWithDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 installedItem:(id)arg3;	// IMP=0x000000010023d038
