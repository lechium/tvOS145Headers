...
+ (id)_stringFromDigest:(char *)arg1;	// IMP=0x0000000100119910
+ (id)_hashArrayFromMeasurement:(id)arg1;	// IMP=0x00000001001197cc
- (void).cxx_destruct;	// IMP=0x0000000100119a5c
...
- (id)initWithURL:(id)arg1 attributes:(id)arg2;	// IMP=0x00000001001193e0
