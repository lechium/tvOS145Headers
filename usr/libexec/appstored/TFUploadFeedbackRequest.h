...
- (void).cxx_destruct;	// IMP=0x00000001001ba6ec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001ba4e8
- (unsigned long long)hash;	// IMP=0x00000001001ba3ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001ba25c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001ba10c
- (void)copyTo:(id)arg1;	// IMP=0x00000001001ba008
- (void)writeTo:(id)arg1;	// IMP=0x00000001001b9f1c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001b9ae8
- (id)dictionaryRepresentation;	// IMP=0x00000001001b98d0
- (id)description;	// IMP=0x00000001001b981c
