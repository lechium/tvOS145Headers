...
- (void).cxx_destruct;	// IMP=0x00000001001cb4cc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001cb1f4
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x00000001001cb1e8
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x00000001001cb0c0
- (void)setValue:(id)arg1 forRequestParameter:(id)arg2;	// IMP=0x00000001001caf68
- (void)setValue:(id)arg1 forRequestHeader:(id)arg2;	// IMP=0x00000001001cae0c
...
- (id)init;	// IMP=0x00000001001c9e54
