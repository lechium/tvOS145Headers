...
- (void).cxx_destruct;	// IMP=0x000000010019f3a0
...
- (id)initWithStoreItemID:(id)arg1 externalVersionID:(id)arg2;	// IMP=0x000000010019f27c
- (id)initWithApplicationProxy:(id)arg1 evidOverride:(id)arg2;	// IMP=0x000000010019f0b0
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x000000010019f0a0
