...
+ (id)contextWithReason:(long long)arg1;	// IMP=0x000000010012e3e4
+ (id)defaultContext;	// IMP=0x000000010012e3a8
- (void).cxx_destruct;	// IMP=0x000000010012e644
...
- (void)_setLogKey:(id)arg1;	// IMP=0x000000010012e5c4
...
- (id)humanReadableReason;	// IMP=0x000000010012e498
- (id)init;	// IMP=0x000000010012e424
