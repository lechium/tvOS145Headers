...
- (void).cxx_destruct;	// IMP=0x000000010007ff3c
...
- (id)description;	// IMP=0x000000010007fe98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010007fde4
- (id)initWithBundleID:(id)arg1;	// IMP=0x000000010007fd80
