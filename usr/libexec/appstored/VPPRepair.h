...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logUUID:(id)arg3;	// IMP=0x00000001000c0c28
- (void).cxx_destruct;	// IMP=0x00000001000c15ec
- (_Bool)_handleVPPRecoveryWithOutError:(id *)arg1;	// IMP=0x00000001000c1288
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000c0dec
- (void)setRepairedBundleIDs:(id)arg1;	// IMP=0x00000001000c0bbc
...
- (id)initWithApplication:(id)arg1 options:(id)arg2;	// IMP=0x00000001000c0950
- (id)init;	// IMP=0x00000001000c0914
