...
+ (Class)provisioningProfileType;	// IMP=0x00000001001925a0
- (void).cxx_destruct;	// IMP=0x000000010019590c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010019509c
- (unsigned long long)hash;	// IMP=0x0000000100194c40
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010019464c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010019405c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100193ba0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100193b98
- (id)dictionaryRepresentation;	// IMP=0x0000000100192894
- (id)description;	// IMP=0x00000001001927e0
...
- (id)provisioningProfileAtIndex:(unsigned long long)arg1;	// IMP=0x0000000100192588
- (unsigned long long)provisioningProfilesCount;	// IMP=0x0000000100192570
- (void)addProvisioningProfile:(id)arg1;	// IMP=0x00000001001924fc
- (void)clearProvisioningProfiles;	// IMP=0x00000001001924e4
