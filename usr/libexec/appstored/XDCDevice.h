...
- (void).cxx_destruct;	// IMP=0x0000000100169394
...
- (id)description;	// IMP=0x00000001001692c8
- (void)updateWithIDSDevice:(id)arg1;	// IMP=0x00000001001691ac
- (void)markAsTombstoneDevice;	// IMP=0x000000010016919c
...
- (id)initWithIDSDevice:(id)arg1;	// IMP=0x0000000100168dd4
