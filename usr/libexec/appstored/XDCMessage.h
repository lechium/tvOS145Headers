...
- (void).cxx_destruct;	// IMP=0x00000001001d00fc
...
- (id)replyWithProtobuf:(id)arg1 messageType:(long long)arg2;	// IMP=0x00000001001d0008
- (id)copyIDSRepresentation;	// IMP=0x00000001001cffcc
- (id)initWithProtobuf:(id)arg1 device:(id)arg2 messageID:(id)arg3;	// IMP=0x00000001001cfed8
- (id)initWithProtobuf:(id)arg1 messageType:(long long)arg2;	// IMP=0x00000001001cfe40
