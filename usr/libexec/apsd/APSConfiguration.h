...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100066220
+ (void)loadConfigurationForEnvironment:(id)arg1 interface:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000100065eac
+ (id)configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100065c68
+ (id)_onQueue_configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100065a20
+ (void)initialize;	// IMP=0x00000001000659c4
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100067b40
- (_Bool)_isExpired;	// IMP=0x0000000100067adc
- (_Bool)_isLoaded;	// IMP=0x0000000100067ad4
...
- (id)bagExpiryInterval;	// IMP=0x0000000100067a74
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x0000000100067954
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x00000001000671c4
- (void)_failWithError:(id)arg1;	// IMP=0x00000001000670b4
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x0000000100066e40
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100066ca0
- (id)pendingCompletionBocks;	// IMP=0x0000000100066c98
- (void)dealloc;	// IMP=0x0000000100066c4c
- (id)initWithEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x00000001000664f8
