...
+ (void)_saveCachedProperties;	// IMP=0x0000000100065398
+ (void)_loadCachedProperties;	// IMP=0x0000000100064f48
+ (id)environmentForName:(id)arg1;	// IMP=0x0000000100064f34
+ (void)initialize;	// IMP=0x0000000100064910
- (void).cxx_destruct;	// IMP=0x00000001000657dc
...
- (id)description;	// IMP=0x00000001000656d8
@property(readonly, nonatomic) unsigned long long priority;
- (unsigned long long)hash;	// IMP=0x0000000100065670
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010006566c
