...
- (void)proxyManager:(APSIDSProxyManager *)arg1 incomingFilterForGuid:(NSString *)arg2 environmentName:(NSString *)arg3 enabledTopics:(NSArray *)arg4 ignoredTopics:(NSArray *)arg5 opportunisticTopics:(NSArray *)arg6 nonWakingTopics:(NSArray *)arg7;
