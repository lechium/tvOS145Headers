...
- (void).cxx_destruct;	// IMP=0x0000000100005504
...
- (id)initWithDNSTask:(id)arg1 messageId:(unsigned long long)arg2 taskId:(unsigned long long)arg3 taskStatus:(unsigned long long)arg4;	// IMP=0x00000001000053f4
- (id)initWithDNSTask:(id)arg1;	// IMP=0x0000000100005374
