...
+ (id)sharedInstance;	// IMP=0x0000000100083a1c
- (void).cxx_destruct;	// IMP=0x0000000100084504
...
- (void)removeListener:(id)arg1;	// IMP=0x000000010008443c
- (void)addListener:(id)arg1;	// IMP=0x00000001000843ac
- (void)_setSystemLockState:(_Bool)arg1;	// IMP=0x0000000100084228
- (void)_setSystemScreenState:(_Bool)arg1;	// IMP=0x00000001000840a4
- (void)_systemWillSleep;	// IMP=0x0000000100083e40
- (void)_systemDidWake;	// IMP=0x0000000100083e28
- (void)_deliverNotificationSelector:(SEL)arg1;	// IMP=0x0000000100083d68
- (void)dealloc;	// IMP=0x0000000100083afc
- (id)init;	// IMP=0x0000000100083a88
