...
- (void).cxx_destruct;	// IMP=0x00000001000158ac
...
- (id)description;	// IMP=0x000000010001582c
- (id)compile;	// IMP=0x00000001000156fc
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001000154f0
- (id)initWithApprove:(id)arg1 body:(id)arg2 decline:(id)arg3 title:(id)arg4;	// IMP=0x00000001000153f4
