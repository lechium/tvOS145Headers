...
- (void).cxx_destruct;	// IMP=0x00000001001f27a8
...
- (id)analyticsDictionary;	// IMP=0x00000001001f24b0
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00000001001f24a4
- (void)markSucceeded;	// IMP=0x00000001001f2498
- (void)markEndTime;	// IMP=0x00000001001f2454
- (void)markStartTime;	// IMP=0x00000001001f2410
- (_Bool)hasFailureType;	// IMP=0x00000001001f2400
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00000001001f2374
