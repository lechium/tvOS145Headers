...
- (void).cxx_destruct;	// IMP=0x00000001000e1f38
...
- (void)synchronizeUsingActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e1eb8
- (void)fetchDeviceTypesForAllLanguages:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e1e9c
- (void)fetchDeviceTypesForLanguage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e1e84
- (void)deleteUserData:(id)arg1;	// IMP=0x00000001000e1de0
- (void)mergeDataWithModifiedRecords:(id)arg1 deletedRecordIDs:(id)arg2 containsAllChanges:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000e1cdc
- (void)synchronizeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e1b00
@property(retain, nonatomic) CKServerChangeToken *serverChangeToken;
@property(nonatomic) _Bool hasSetUpRecordZoneSubscription;
- (id)init;	// IMP=0x00000001000e19f8
