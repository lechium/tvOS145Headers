...
- (void).cxx_destruct;	// IMP=0x000000010012f10c
...
- (void)reset;	// IMP=0x000000010012ed7c
...
- (id)initWithZone:(id)arg1 dataStore:(id)arg2 subscriptionNames:(id)arg3;	// IMP=0x000000010012eb4c
- (id)initWithZoneName:(id)arg1 subscriptionNames:(id)arg2;	// IMP=0x000000010012ea70
- (id)initWithZoneName:(id)arg1 subscriptionName:(id)arg2;	// IMP=0x000000010012e98c
