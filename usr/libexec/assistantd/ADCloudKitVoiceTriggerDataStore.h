...
- (void).cxx_destruct;	// IMP=0x00000001002bb420
...
- (void)synchronizeUsingActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001002bb388
- (void)fetchDeviceTypesForAllLanguages:(CDUnknownBlockType)arg1;	// IMP=0x00000001002bb36c
- (void)fetchDeviceTypesForLanguage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001002bb354
- (void)deleteUserData:(id)arg1;	// IMP=0x00000001002bb298
- (_Bool)_expandVoiceTriggerArchiveFiles:(id)arg1;	// IMP=0x00000001002bac8c
- (id)_createVoiceTriggerArchiveFileWithEnrolledLanguageList:(id *)arg1;	// IMP=0x00000001002ba67c
- (id)_createCacheDirectory;	// IMP=0x00000001002ba5a0
- (_Bool)_cleanupCacheDirectory;	// IMP=0x00000001002ba494
- (id)_cacheDirectory;	// IMP=0x00000001002ba410
- (void)_mergeDataWithModifiedRecords:(id)arg1 deletedRecordIDs:(id)arg2 containsAllChanges:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001002b95a4
- (void)mergeDataWithModifiedRecords:(id)arg1 deletedRecordIDs:(id)arg2 containsAllChanges:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001002b9490
- (void)_synchronizeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001002b8b34
- (void)synchronizeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001002b8a9c
@property(retain, nonatomic) CKServerChangeToken *serverChangeToken;
@property(nonatomic) _Bool hasSetUpRecordZoneSubscription;
- (id)init;	// IMP=0x00000001002b869c
