...
- (void).cxx_destruct;	// IMP=0x000000010021cf48
...
- (id)dictionaryRepresentation;	// IMP=0x000000010021ce88
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x000000010021cd8c
