...
- (void).cxx_destruct;	// IMP=0x00000001000c4620
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00000001000c42c0
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00000001000c3fa0
- (void)dealloc;	// IMP=0x00000001000c3cb4
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00000001000c3b88
- (id)init;	// IMP=0x00000001000c3b70
