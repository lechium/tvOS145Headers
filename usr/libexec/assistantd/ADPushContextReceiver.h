...
- (void).cxx_destruct;	// IMP=0x000000010025df18
- (oneway void)sendContext:(id)arg1;	// IMP=0x000000010025ddfc
- (id)initWithCollector:(id)arg1 pid:(int)arg2 connection:(id)arg3;	// IMP=0x000000010025dd5c
