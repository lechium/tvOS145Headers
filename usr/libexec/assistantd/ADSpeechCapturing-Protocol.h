...
@class ADAudioPlaybackService, AFSpeechRequestOptions, CSAudioSessionController, CSServerEndpointFeatures, CSSpeechController, NSObject;
...
- (id)initWithQueue:(NSObject<OS_dispatch_queue> *)arg1 speechController:(CSSpeechController *)arg2 audioSessionController:(CSAudioSessionController *)arg3 audioPlaybackService:(ADAudioPlaybackService *)arg4;
- (id)init;
@end
