...
- (void).cxx_destruct;	// IMP=0x00000001001b93c8
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00000001001b985c
- (id)metricValue;	// IMP=0x00000001001b9440
