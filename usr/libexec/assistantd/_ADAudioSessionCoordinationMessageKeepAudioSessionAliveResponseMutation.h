...
- (void).cxx_destruct;	// IMP=0x00000001000f0e08
- (id)generate;	// IMP=0x00000001000f0dd4
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001000f0d5c
- (id)init;	// IMP=0x00000001000f0d4c
