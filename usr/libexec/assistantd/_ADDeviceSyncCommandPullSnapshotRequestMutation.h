...
- (void).cxx_destruct;	// IMP=0x000000010005120c
- (id)generate;	// IMP=0x0000000100051158
- (void)setDataType:(id)arg1;	// IMP=0x0000000100051124
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001000510ac
- (id)init;	// IMP=0x000000010005109c
