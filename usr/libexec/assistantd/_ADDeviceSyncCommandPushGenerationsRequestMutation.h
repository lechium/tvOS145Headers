...
- (void).cxx_destruct;	// IMP=0x000000010019a814
- (id)generate;	// IMP=0x000000010019a760
- (void)setGenerationsByDataType:(id)arg1;	// IMP=0x000000010019a72c
- (id)initWithBaseModel:(id)arg1;	// IMP=0x000000010019a6b4
- (id)init;	// IMP=0x000000010019a6a4
