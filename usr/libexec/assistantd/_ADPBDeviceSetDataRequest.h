...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00000001000e2330
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x000000010008ddb8
- (void).cxx_destruct;	// IMP=0x00000001000e53cc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000e4ba4
- (unsigned long long)hash;	// IMP=0x00000001000e47e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000e4274
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000e3cf4
- (void)copyTo:(id)arg1;	// IMP=0x00000001000e38bc
- (void)writeTo:(id)arg1;	// IMP=0x00000001000e348c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000e3484
- (id)dictionaryRepresentation;	// IMP=0x00000001000e2540
- (id)description;	// IMP=0x00000001000e248c
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00000001000e2318
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00000001000e2300
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x00000001000e228c
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00000001000e2274
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000ace70
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001286a8
