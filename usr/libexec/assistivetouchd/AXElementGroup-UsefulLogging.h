...
- (id)elemLog;	// IMP=0x000000010002d804
@property(nonatomic) _Bool scatAssistiveTechFocused;
- (void)prepareElementsForScanning:(id)arg1;	// IMP=0x00000001000a2734
...
- (void)scatScrollToVisible;	// IMP=0x00000001000a2500
@property(readonly, nonatomic) _Bool scatIsValid;
@property(readonly, nonatomic) NSString *scatSpeakableDescription;
- (id)scatSpeakableDescription:(_Bool)arg1;	// IMP=0x00000001000a21c8
@property(readonly, nonatomic) struct CGRect scatFrame;
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00000001000a2154
- (id)scrollableElement;	// IMP=0x00000001000a20dc
...
- (id)scatSupportedGestures;	// IMP=0x00000001000a1e30
@property(readonly, nonatomic) struct CGPath *scatPath;
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00000001000a1e20
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000a1e18
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000a1e10
