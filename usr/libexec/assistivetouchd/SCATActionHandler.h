...
- (void).cxx_destruct;	// IMP=0x0000000100077a90
...
- (void)_resetWithActionSource:(id)arg1;	// IMP=0x00000001000779a4
- (void)_handleFireAction;	// IMP=0x00000001000778cc
- (_Bool)isPending;	// IMP=0x0000000100077880
- (void)cancelPendingAction;	// IMP=0x000000010007772c
- (void)notifyDidReceiveAction:(id)arg1;	// IMP=0x00000001000773d4
- (_Bool)_shouldHandleSelectActionImmediately;	// IMP=0x0000000100077338
@property(readonly, nonatomic) _Bool shouldShowMenuOnFirstSelectAction;
- (id)initWithAction:(long long)arg1 timeoutDuration:(double)arg2;	// IMP=0x0000000100077224
