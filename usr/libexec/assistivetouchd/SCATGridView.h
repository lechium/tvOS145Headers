...
- (void).cxx_destruct;	// IMP=0x000000010005c810
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000010005c5f0
- (void)_drawLinesInContext:(struct CGContext *)arg1 forRows:(_Bool)arg2;	// IMP=0x000000010005c3b4
- (void)layoutSubviews;	// IMP=0x000000010005c028
- (double)_adjustOriginValue:(double)arg1 forDistance:(double)arg2 maximumEndPosition:(double)arg3;	// IMP=0x000000010005c000
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005bebc
