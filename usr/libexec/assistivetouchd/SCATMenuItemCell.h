...
+ (struct CGSize)cellSizeForTitle:(id)arg1;	// IMP=0x0000000100093b18
+ (struct CGSize)maxCellSize;	// IMP=0x0000000100093af4
+ (id)measuringCell;	// IMP=0x000000010009398c
+ (id)titleToSizeCache;	// IMP=0x0000000100093868
...
- (void)resetCell;	// IMP=0x0000000100096884
- (_Bool)allowsDwellScanningToAbortAfterTimeout;	// IMP=0x0000000100096838
- (id)accessibilityLabel;	// IMP=0x00000001000967e4
- (id)scatSpeakableDescription;	// IMP=0x0000000100096790
- (_Bool)scatIndicatesOwnFocus;	// IMP=0x0000000100096788
- (_Bool)scatShouldActivateDirectly;	// IMP=0x0000000100096780
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x000000010009671c
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x0000000100096710
- (void)prepareForReuse;	// IMP=0x00000001000964b0
- (void)didUpdateScatMenuItemStyle;	// IMP=0x0000000100096320
- (void)_setIconDimmed:(_Bool)arg1 asDimAsBorder:(_Bool)arg2 focused:(_Bool)arg3;	// IMP=0x0000000100096044
- (void)_setBorderDimmed:(_Bool)arg1 focused:(_Bool)arg2 hidden:(_Bool)arg3;	// IMP=0x0000000100095a84
- (_Bool)_useHighVisibilityImage;	// IMP=0x0000000100095a7c
...
- (id)description;	// IMP=0x000000010009550c
- (void)_setupConstraints;	// IMP=0x00000001000941f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100093cd8
