...
- (id)keyboardContainer;	// IMP=0x00000001000a0ae8
@property(readonly, nonatomic) struct CGRect frame;
- (_Bool)isGroup;	// IMP=0x00000001000a0ad4
- (id)highestAncestorGroup;	// IMP=0x00000001000a0a80
...
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00000001000a0944
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000a093c
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000a0930
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00000001000a0928
- (void)scatScrollToVisible;	// IMP=0x00000001000a0924
- (id)scatSupportedGestures;	// IMP=0x00000001000a091c
@property(readonly, nonatomic) _Bool scatHidesGroupCursorWhenFocused;
@property(readonly, nonatomic) NSArray *scatCustomActions;
- (id)scrollableElement;	// IMP=0x00000001000a0904
