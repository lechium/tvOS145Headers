...
- (void).cxx_destruct;	// IMP=0x00000001000051b4
...
- (long long)purgeAmount:(long long)arg1 withUrgency:(long long)arg2;	// IMP=0x0000000100004f44
- (long long)purgeableAmountWithUrgency:(long long)arg1;	// IMP=0x0000000100004e4c
- (id)initWithPurgeRequest:(id)arg1;	// IMP=0x0000000100004dd4
- (id)init;	// IMP=0x0000000100004dc4
