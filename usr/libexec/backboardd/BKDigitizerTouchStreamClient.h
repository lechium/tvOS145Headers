...
- (void)watchForPortDeathOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000001000557d8
- (id)description;	// IMP=0x00000001000555f4
- (void)invalidate;	// IMP=0x0000000100055580
- (void)dealloc;	// IMP=0x00000001000554e4
- (id)init;	// IMP=0x00000001000554a0
