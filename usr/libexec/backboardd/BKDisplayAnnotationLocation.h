...
+ (id)relativeToBottomMiddleOfSuper:(struct CGPoint)arg1;	// IMP=0x0000000100056708
+ (id)relativeToBottomLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x0000000100056684
+ (id)relativeToTopLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x0000000100056600
+ (id)centerAtPoint:(struct CGPoint)arg1;	// IMP=0x0000000100056590
+ (id)controlledBySupernode;	// IMP=0x0000000100056550
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100056428
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000563e0
