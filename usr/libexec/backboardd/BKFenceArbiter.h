...
+ (id)sharedInstance;	// IMP=0x0000000100005dec
- (void).cxx_destruct;	// IMP=0x00000001000048b8
- (id)_newAssertionForTriggerPort:(unsigned int)arg1;	// IMP=0x00000001000042d0
- (id)_newFenceHandle;	// IMP=0x0000000100003804
- (id)init;	// IMP=0x00000001000036f0
