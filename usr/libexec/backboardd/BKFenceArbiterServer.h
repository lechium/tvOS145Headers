...
- (void).cxx_destruct;	// IMP=0x00000001000034f8
- (void)queue_handleMessage:(id)arg1 client:(id)arg2;	// IMP=0x0000000100003340
- (id)initWithServiceName:(id)arg1 onQueue:(id)arg2;	// IMP=0x000000010000321c
