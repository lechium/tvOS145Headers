...
+ (id)sharedInstance;	// IMP=0x0000000100030c94
- (void).cxx_destruct;	// IMP=0x0000000100030a48
...
- (void)_queue_finishBootingIfNecessaryAndTellObservers:(_Bool)arg1;	// IMP=0x0000000100030820
- (void)_systemAppDidFinishLaunching:(id)arg1;	// IMP=0x00000001000307c8
- (void)removeObserver:(id)arg1;	// IMP=0x0000000100030744
- (void)addObserver:(id)arg1;	// IMP=0x00000001000306c0
@property(readonly, nonatomic, getter=isFirstBoot) _Bool firstBoot;
- (id)description;	// IMP=0x0000000100030628
- (id)initWithSystemAppSentinel:(id)arg1 firstBootToken:(id)arg2 alternateSystemAppManager:(id)arg3;	// IMP=0x00000001000304a4
