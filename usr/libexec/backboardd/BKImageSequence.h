...
- (void).cxx_destruct;	// IMP=0x000000010001f4dc
...
- (void)_loadAllImages;	// IMP=0x000000010001f420
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x000000010001f224
- (id)_idiomSuffix;	// IMP=0x000000010001f178
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x000000010001ee7c
- (id)allImages;	// IMP=0x000000010001ee48
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x000000010001ee3c
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x000000010001ed04
