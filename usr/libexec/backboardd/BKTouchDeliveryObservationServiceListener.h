...
- (void).cxx_destruct;	// IMP=0x000000010004b0d4
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x000000010004ae60
- (void)activate;	// IMP=0x000000010004ae50
- (id)initWithObservationManager:(id)arg1;	// IMP=0x000000010004ad60
