...
- (void).cxx_destruct;	// IMP=0x000000010004dfe0
...
- (void)removeService:(id)arg1;	// IMP=0x000000010004df74
- (void)addService:(id)arg1;	// IMP=0x000000010004df00
- (void)_resetServiceStatus;	// IMP=0x000000010004dd48
- (id)description;	// IMP=0x000000010004dc50
