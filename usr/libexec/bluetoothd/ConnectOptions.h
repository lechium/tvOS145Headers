...
@interface ConnectOptions : NSObject <NSCopying, NSCoding>
{
    ...
    NSString *_temporaryIdentityAddress;	// 104 = 0x68
    NSData *_temporaryIRK;	// 112 = 0x70
}

+ (id)alertOptionsWithConnectionAlerts:(_Bool)arg1 disconnectionAlerts:(_Bool)arg2 notificationAlerts:(_Bool)arg3 delay:(long long)arg4 bridgeTransport:(_Bool)arg5;	// IMP=0x0000000100269134
- (void).cxx_destruct;	// IMP=0x0000000100269ac8
@property(retain) NSData *temporaryIRK; // @synthesize temporaryIRK=_temporaryIRK;
@property(retain) NSString *temporaryIdentityAddress; // @synthesize temporaryIdentityAddress=_temporaryIdentityAddress;
...
- (id)description;	// IMP=0x0000000100269830
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010026970c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100269640
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100269270
