...
- (void).cxx_destruct;	// IMP=0x00000001000432b4
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00000001000431b0
- (id)description;	// IMP=0x0000000100043090
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x0000000100042f68
