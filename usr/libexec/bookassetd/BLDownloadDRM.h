...
- (id)_sinfsArrayWithDataKey:(id)arg1;	// IMP=0x000000010001d344
@property(readonly) BLSinfsArray *sinfsArray;
- (id)sinfForIdentifier:(long long)arg1;	// IMP=0x000000010001d1f0
@property(readonly) BLSinfsArray *pinfsArray;
@property(readonly, getter=isDRMFree) _Bool DRMFree;
- (id)firstDataForSinfDataKey:(id)arg1;	// IMP=0x000000010001d048
- (id)initWithSinfArray:(id)arg1;	// IMP=0x000000010001ce8c
