...
- (void).cxx_destruct;	// IMP=0x00000001000d32ec
...
- (void)runOperations;	// IMP=0x00000001000d27b0
- (void)_checkRecordsExistenceWithOperationType:(long long)arg1 recordIDsToCPLRecord:(id)arg2 recordsToCheckOnly:(id)arg3 recordsToFetch:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000d1598
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 additionalTransportScopes:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000d145c
