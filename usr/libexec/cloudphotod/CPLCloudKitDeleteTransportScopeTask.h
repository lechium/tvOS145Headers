...
- (void).cxx_destruct;	// IMP=0x00000001000928f0
...
- (void)runOperations;	// IMP=0x0000000100091e48
- (id)_errorForDeleteError:(id)arg1;	// IMP=0x0000000100091ce8
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100091bdc
