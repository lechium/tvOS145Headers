...
- (void).cxx_destruct;	// IMP=0x00000001000e0584
...
- (void)_determineScopeTypeAndFetchLibraryInfo;	// IMP=0x00000001000dffb0
- (void)runOperations;	// IMP=0x00000001000df6e0
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000df5c0
