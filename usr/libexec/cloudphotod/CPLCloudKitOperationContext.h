...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x000000010008899c
- (id)operationDescription;	// IMP=0x0000000100088994
- (id)extendedStatusDescriptionStrings;	// IMP=0x000000010008898c
