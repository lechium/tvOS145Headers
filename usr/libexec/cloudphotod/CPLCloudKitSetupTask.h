...
- (void).cxx_destruct;	// IMP=0x000000010008ce54
...
- (void)runOperations;	// IMP=0x000000010008ccf4
- (void)fetchUserRecord;	// IMP=0x000000010008c72c
- (void)fetchDerivativesFilter;	// IMP=0x000000010008c480
- (void)fetchDisabledFeatures;	// IMP=0x000000010008bfec
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010008bf44
