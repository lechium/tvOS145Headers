...
+ (void)initialize;	// IMP=0x00000001000c3cec
- (void).cxx_destruct;	// IMP=0x00000001000c6fb4
...
- (void)runOperations;	// IMP=0x00000001000c4370
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 additionalTransportScopes:(id)arg4 progressHandler:(CDUnknownBlockType)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000001000c3d44
