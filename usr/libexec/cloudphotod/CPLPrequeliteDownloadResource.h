...
- (void).cxx_destruct;	// IMP=0x0000000100045f6c
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x0000000100045dc8
- (id)initWithResource:(id)arg1;	// IMP=0x0000000100045b64
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000459b8
