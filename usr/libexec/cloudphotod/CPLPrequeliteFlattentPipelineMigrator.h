...
- (void).cxx_destruct;	// IMP=0x00000001000537fc
@property(readonly, nonatomic) CPLPrequeliteStore *store; // @synthesize store=_store;
- (_Bool)migrate;	// IMP=0x000000010005357c
- (_Bool)_migratePushQueue:(id)arg1;	// IMP=0x0000000100052ed4
- (_Bool)_discardResourceForUpload:(id)arg1;	// IMP=0x0000000100052d64
- (_Bool)_enqueueResourcesForChange:(id)arg1 inOutgoingResourcesWithUploadIdentifier:(id)arg2;	// IMP=0x00000001000528fc
- (unsigned long long)_availabilityOfResource:(id)arg1;	// IMP=0x00000001000526d0
@property(readonly, nonatomic) NSError *lastError; // @synthesize lastError=_lastError;
- (void)_setLastError:(id)arg1;	// IMP=0x0000000100052618
- (id)initWithStore:(id)arg1;	// IMP=0x0000000100052468
