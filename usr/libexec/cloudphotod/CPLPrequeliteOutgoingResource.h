...
- (void).cxx_destruct;	// IMP=0x0000000100037138
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x0000000100036fb0
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x0000000100036e98
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x0000000100036bb0
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100036a3c
