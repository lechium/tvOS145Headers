...
- (id)resource;	// IMP=0x000000010004edcc
- (id)initWithResource:(id)arg1;	// IMP=0x000000010004ebdc
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x000000010004ea38
