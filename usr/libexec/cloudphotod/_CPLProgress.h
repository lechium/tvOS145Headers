...
- (void).cxx_destruct;	// IMP=0x000000010002b0c8
...
- (void)unpublish;	// IMP=0x000000010002b050
- (void)publish;	// IMP=0x000000010002b018
- (void)_publishRealProgressIfNecessary;	// IMP=0x000000010002ae1c
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000010002ad84
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x000000010002abc0
