...
- (void).cxx_destruct;	// IMP=0x00000001000115c8
...
- (void)dealloc;	// IMP=0x00000001000112fc
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x0000000100010790
- (_Bool)_validateOutputSize;	// IMP=0x0000000100010628
- (_Bool)_validateOrientation;	// IMP=0x00000001000104e0
- (_Bool)_validateMetadata;	// IMP=0x0000000100010348
- (_Bool)_validateSource;	// IMP=0x000000010001011c
- (void)_validate;	// IMP=0x000000010000ffa4
- (_Bool)validateSourceAndOptions;	// IMP=0x000000010000ff64
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x000000010000fe0c
