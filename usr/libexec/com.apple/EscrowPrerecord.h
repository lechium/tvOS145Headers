...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x000000010004b534
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100041b10
- (unsigned long long)hash;	// IMP=0x0000000100041964
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000416cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100041488
- (void)copyTo:(id)arg1;	// IMP=0x00000001000412d0
- (void)writeTo:(id)arg1;	// IMP=0x0000000100041148
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100041140
...
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x0000000100040998
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x0000000100040908
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x000000010004b290
