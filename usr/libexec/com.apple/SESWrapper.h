...
- (void).cxx_destruct;	// IMP=0x000000010005b904
...
- (void)dealloc;	// IMP=0x000000010005b7b0
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x000000010005af24
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x000000010005a454
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 enroll:(_Bool)arg3 env:(id)arg4 duplicate:(_Bool)arg5;	// IMP=0x0000000100059740
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x0000000100057b48
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100056df4
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x0000000100056d78
- (unsigned long long)srpPublicKeySize;	// IMP=0x0000000100056d14
- (unsigned long long)srpKeySize;	// IMP=0x0000000100056c84
- (id)srpInitBlob;	// IMP=0x0000000100056b00
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x0000000100056868
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x0000000100056778
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x00000001000565c0
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x000000010005654c
- (id)initWithRequest:(id)arg1;	// IMP=0x000000010005653c
