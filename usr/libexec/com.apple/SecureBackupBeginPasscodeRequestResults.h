...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000f25c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000f394
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000f264
- (id)description;	// IMP=0x000000010000f110
- (id)initWithStoredCertificate:(id)arg1 uuid:(id)arg2;	// IMP=0x000000010000efe4
