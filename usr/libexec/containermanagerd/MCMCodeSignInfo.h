...
- (void).cxx_destruct;	// IMP=0x00000001000105f0
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x00000001000102cc
- (id)initWithURL:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x0000000100010278
