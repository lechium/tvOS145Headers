...
- (void).cxx_destruct;	// IMP=0x0000000100067648
...
- (id)description;	// IMP=0x0000000100067550
- (unsigned long long)hash;	// IMP=0x0000000100067400
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000670a4
- (id)serialize;	// IMP=0x0000000100066dd8
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x0000000100066bc4
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x0000000100066bb4
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x0000000100066b20
