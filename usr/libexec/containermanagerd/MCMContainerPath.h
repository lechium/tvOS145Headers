...
+ (id)_posixOwnerForContainerSubdirectories:(unsigned long long)arg1 user:(id)arg2;	// IMP=0x000000010008a1c8
+ (Class)_containerClassPathClass;	// IMP=0x000000010008a1bc
+ (id)containerPathFromURL:(id)arg1 containerClassPath:(id)arg2 relativePath:(id *)arg3;	// IMP=0x0000000100089f58
+ (id)containerPathIdentifierForCodeSignIdentifier:(id)arg1 containerClass:(unsigned long long)arg2;	// IMP=0x0000000100089df8
+ (id)containerPathForContainerClassPath:(id)arg1 containerPathIdentifier:(id)arg2;	// IMP=0x0000000100089cc0
+ (id)containerPathForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2 containerPathIdentifier:(id)arg3;	// IMP=0x0000000100089bcc
+ (id)containerPathForContainerIdentity:(id)arg1 containerPathIdentifier:(id)arg2;	// IMP=0x0000000100089b10
- (void).cxx_destruct;	// IMP=0x0000000100089838
...
- (_Bool)_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100089644
- (_Bool)_obj1:(id)arg1 isEqualToObj2:(id)arg2;	// IMP=0x00000001000895f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100089538
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000894c0
- (_Bool)isEqualToContainerPath:(id)arg1;	// IMP=0x000000010008942c
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithContainerClassPath:(id)arg1 containerPathIdentifier:(id)arg2 containerRootComponent:(id)arg3 containerDataComponent:(id)arg4;	// IMP=0x0000000100089080
@property(readonly, nonatomic) NSURL *classURL;
@property(readonly, nonatomic) NSURL *categoryURL;
@property(readonly, nonatomic) NSURL *baseURL;
- (_Bool)createDataURLIfNecessaryWithDataProtectionClass:(int)arg1 error:(id *)arg2;	// IMP=0x0000000100088e1c
- (_Bool)createIfNecessaryWithDataProtectionClass:(int)arg1 error:(id *)arg2;	// IMP=0x0000000100088c80
