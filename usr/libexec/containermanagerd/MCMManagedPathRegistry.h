...
- (void).cxx_destruct;	// IMP=0x00000001000644dc
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x0000000100064184
- (void)_addPaths:(id)arg1;	// IMP=0x0000000100064144
- (id)managedPathForURL:(id)arg1;	// IMP=0x0000000100063fa4
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x0000000100063c98
- (id)initWithDaemonUser:(id)arg1;	// IMP=0x0000000100063b70
