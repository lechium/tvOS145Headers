...
- (void).cxx_destruct;	// IMP=0x0000000100082c98
...
- (_Bool)canBeHandledLocally;	// IMP=0x0000000100082bdc
- (id)initWithXPCObject:(id)arg1 clientConnection:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000100082a40
