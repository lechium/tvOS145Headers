...
- (void).cxx_destruct;	// IMP=0x000000010002d784
...
- (void)dealloc;	// IMP=0x000000010002d6f4
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2;	// IMP=0x000000010002d524
- (id)initWithUUID:(id)arg1 existed:(_Bool)arg2 url:(id)arg3 containerPathIdentifier:(id)arg4 identifier:(id)arg5 containerClass:(unsigned long long)arg6 personaUniqueString:(id)arg7 sandboxToken:(const char *)arg8;	// IMP=0x000000010002d3d8
- (_Bool)encodeReplyOntoXPCObject:(id)arg1;	// IMP=0x000000010002d158
