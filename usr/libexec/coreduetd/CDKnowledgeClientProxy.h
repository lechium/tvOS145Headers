...
- (void).cxx_destruct;	// IMP=0x0000000100024224
...
- (id)description;	// IMP=0x0000000100024170
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000100024114
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000001000240c8
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000100023fa0
- (void)_logInvocationForSelector:(id)arg1;	// IMP=0x0000000100023f88
- (void)dealloc;	// IMP=0x0000000100023eac
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x0000000100023c28
