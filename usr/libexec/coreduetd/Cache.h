...
- (void).cxx_destruct;	// IMP=0x000000010000badc
...
- (void)evictRandom;	// IMP=0x000000010000b9c4
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000010000b6cc
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000010000b4fc
- (void)flush;	// IMP=0x000000010000b3c0
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x000000010000b300
