...
+ (id)requestForSpeexRecordSettingsWithContext:(id)arg1;	// IMP=0x00000001000d090c
+ (id)requestForOpusRecordSettingsWithContext:(id)arg1;	// IMP=0x00000001000d0770
+ (id)requestForLpcmRecordSettingsWithContext:(id)arg1;	// IMP=0x00000001000d05b4
+ (id)defaultRequestWithContext:(id)arg1;	// IMP=0x00000001000d02c8
- (void).cxx_destruct;	// IMP=0x00000001000d0e38
...
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00000001000d0a94
