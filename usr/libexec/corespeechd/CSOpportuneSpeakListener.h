...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x00000001000608f4
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x00000001000608f0
- (_Bool)_shouldReportBoron;	// IMP=0x00000001000608b0
- (_Bool)_popRemoteVADSignal;	// IMP=0x0000000100060828
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x0000000100060784
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x00000001000603e4
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x0000000100060334
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100060320
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005ff54
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f9cc
- (void)_resetAlignBuffer;	// IMP=0x000000010005f99c
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005f4b4
- (id)init;	// IMP=0x000000010005f3c0
