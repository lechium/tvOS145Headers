...
- (void).cxx_destruct;	// IMP=0x000000010007678c
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x0000000100076550
- (void)_calculateSpeechVoicingLevel;	// IMP=0x0000000100076380
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x0000000100076340
- (void)calculateShadowMicScore;	// IMP=0x000000010007605c
- (void)addDataToBuffer:(id)arg1;	// IMP=0x000000010007604c
- (id)init;	// IMP=0x0000000100075fc0
