...
- (void).cxx_destruct;	// IMP=0x000000010001444c
...
- (void)performTransitionForEvent:(long long)arg1;	// IMP=0x000000010001423c
- (void)addTransitionFrom:(long long)arg1 to:(long long)arg2 for:(long long)arg3;	// IMP=0x000000010001408c
- (void)reset;	// IMP=0x0000000100014080
- (id)initWithInitialState:(long long)arg1;	// IMP=0x0000000100014004
