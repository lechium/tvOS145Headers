...
- (void).cxx_destruct;	// IMP=0x00000001000bcb54
...
- (void)_handlePingPongMessage:(id)arg1 client:(id)arg2;	// IMP=0x00000001000bc964
- (void)_notifyXPCDisconnectionToProxy:(id)arg1;	// IMP=0x00000001000bc8fc
- (void)_notifyXPCDisconnectionToProxies;	// IMP=0x00000001000bc838
- (void)_handleClientError:(id)arg1 client:(id)arg2;	// IMP=0x00000001000bc654
- (void)_handleSetXPCClientTypeMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00000001000bc4fc
- (void)_handleAudioProvidingRequestTypeSwitchMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00000001000bc3a8
- (void)_handleAudioProvidingMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00000001000bc204
- (void)_handleClientMessage:(id)arg1 client:(id)arg2;	// IMP=0x00000001000bc034
- (void)_handleClientEvent:(id)arg1;	// IMP=0x00000001000bbf48
- (void)sendMessageToClient:(id)arg1;	// IMP=0x00000001000bbdbc
- (void)activateConnection;	// IMP=0x00000001000bbca8
- (_Bool)_getAudioProvideWithContext:(id)arg1 streamClientType:(unsigned long long)arg2;	// IMP=0x00000001000bba3c
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001000bb7fc
