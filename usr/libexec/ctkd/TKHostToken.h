...
+ (id)keychainItemClasses;	// IMP=0x0000000100003414
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100002b54
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000036c0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100003564
- (id)connectionWithError:(id *)arg1;	// IMP=0x0000000100002d84
- (id)description;	// IMP=0x0000000100002c84
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2 automatic:(_Bool)arg3;	// IMP=0x0000000100002b5c
