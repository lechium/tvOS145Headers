...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x000000010000c1a0
- (void).cxx_destruct;	// IMP=0x000000010000c674
...
- (void)addSlotWithEndpoint:(id)arg1 name:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x000000010000c278
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x000000010000c108
