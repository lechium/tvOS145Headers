...
- (void).cxx_destruct;	// IMP=0x000000010000e660
...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000e27c
- (double)getReferenceTemperatureForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000e178
- (void)recordValue;	// IMP=0x000000010000e0c8
- (void)stop;	// IMP=0x000000010000e05c
- (void)start;	// IMP=0x000000010000dfcc
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000dd84
