...
+ (id)managerWithContext:(id)arg1;	// IMP=0x000000010003ddf8
+ (long long)nextHoursBudgetWithPreviousBudget:(long long)arg1;	// IMP=0x000000010003dddc
- (void).cxx_destruct;	// IMP=0x000000010003ee00
...
- (void)registerForBlueListNotifications;	// IMP=0x000000010003e728
- (_Bool)shouldBlueListPushes;	// IMP=0x000000010003e46c
- (void)updateBlueListStatus:(_Bool)arg1;	// IMP=0x000000010003e3c8
- (void)setupResetTimer;	// IMP=0x000000010003e27c
- (_Bool)overBudget;	// IMP=0x000000010003e238
- (void)decrementPushBudgetRemaining;	// IMP=0x000000010003e1d8
- (void)updateBudgetsForNextSlot;	// IMP=0x000000010003e198
- (void)updateGlobalBudget:(long long)arg1;	// IMP=0x000000010003e0e0
- (id)initWithContext:(id)arg1;	// IMP=0x000000010003de48
