...
+ (id)getDeviceBootTime;	// IMP=0x000000010001fe5c
+ (id)policyInstance;	// IMP=0x000000010001fda8
- (void).cxx_destruct;	// IMP=0x00000001000201c8
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010001ff10
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010001fe50
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010001fe1c
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010001fe14
- (id)init;	// IMP=0x000000010001fd18
