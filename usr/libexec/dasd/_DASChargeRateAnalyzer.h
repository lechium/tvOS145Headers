...
- (void).cxx_destruct;	// IMP=0x000000010000f358
...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000ed80
- (double)getReferenceChargeRateForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000ebd4
- (void)recordValue;	// IMP=0x000000010000eb24
- (void)stop;	// IMP=0x000000010000eab8
- (void)start;	// IMP=0x000000010000ea28
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000e7d0
