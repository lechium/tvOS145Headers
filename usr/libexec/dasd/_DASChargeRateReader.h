...
- (void).cxx_destruct;	// IMP=0x000000010000e7c4
@property(retain, nonatomic) id <_CDContext> context; // @synthesize context=_context;
- (id)lastModifiedDate;	// IMP=0x000000010000e7a8
- (id)currentValue;	// IMP=0x000000010000e740
- (id)init;	// IMP=0x000000010000e6cc
