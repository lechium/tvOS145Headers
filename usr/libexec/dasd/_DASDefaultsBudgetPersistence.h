...
+ (id)persistence;	// IMP=0x0000000100005014
...
- (id)convertNameFromCompactToFull:(id)arg1;	// IMP=0x0000000100005bf4
- (id)convertNameFromFullToCompact:(id)arg1;	// IMP=0x0000000100005b50
- (void)saveModulationDate:(id)arg1;	// IMP=0x0000000100005950
- (void)updateBudget:(id)arg1;	// IMP=0x0000000100005800
- (void)saveBudgets:(id)arg1;	// IMP=0x000000010000553c
- (id)loadBudgetsWithExpectedNames:(id)arg1;	// IMP=0x00000001000050b8
- (id)init;	// IMP=0x0000000100004e94
