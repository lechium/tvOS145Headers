...
- (void).cxx_destruct;	// IMP=0x000000010002f4cc
...
- (id)description;	// IMP=0x000000010002f44c
- (id)initWithCondition:(id)arg1 withRequiredValue:(double)arg2 withCurrentValue:(double)arg3;	// IMP=0x000000010002f3c0
