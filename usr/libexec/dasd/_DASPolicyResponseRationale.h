...
- (void).cxx_destruct;	// IMP=0x000000010002f958
...
- (void)addRationaleWithCondition:(id)arg1;	// IMP=0x000000010002f820
- (void)addRationaleForCondition:(id)arg1 withRequiredValue:(double)arg2 withCurrentValue:(double)arg3;	// IMP=0x000000010002f794
- (id)initWithPolicyName:(id)arg1;	// IMP=0x000000010002f6f0
- (id)description;	// IMP=0x000000010002f4d8
