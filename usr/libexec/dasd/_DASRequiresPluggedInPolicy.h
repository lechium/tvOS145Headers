...
+ (_Bool)isWirelessCharger:(id)arg1;	// IMP=0x000000010002a750
+ (id)policyInstance;	// IMP=0x000000010002a4a0
- (void).cxx_destruct;	// IMP=0x000000010002ad64
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x000000010002a9d4
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002a7f4
- (double)scoreForActivity:(id)arg1 isPluggedIn:(_Bool)arg2;	// IMP=0x000000010002a714
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010002a664
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002a640
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002a50c
- (_Bool)shouldLogScoreToPowerLog;	// IMP=0x000000010002a498
- (id)predictionForDevicePluggedIn;	// IMP=0x000000010002a42c
- (id)init;	// IMP=0x000000010002a258
- (id)initializeTriggers;	// IMP=0x000000010002a100
