...
+ (id)purgeOpAtUrgency:(int)arg1 info:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010004006c
...
- (id)initWithUrgency:(int)arg1 info:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010003ffb4
