...
+ (id)contentServerConnection:(id)arg1 port:(id)arg2;	// IMP=0x0000000100053650
- (void).cxx_destruct;	// IMP=0x0000000100056f88
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100056bc0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100056798
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000564ac
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100055ce0
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010005597c
- (_Bool)addAuthenticationHeadersToRequest:(id)arg1 withBody:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000556d4
- (void)cancelDownloading;	// IMP=0x0000000100055380
- (void)runRunLoopUntilDone;	// IMP=0x0000000100055344
- (_Bool)startDownloadingFile;	// IMP=0x00000001000545f4
- (void)invalidate;	// IMP=0x00000001000545b4
- (void)enableAuthenticationWithHMACKey:(id)arg1;	// IMP=0x00000001000545a8
- (_Bool)downloadTo:(id)arg1 byPosting:(id)arg2 toPath:(id)arg3 retry:(int)arg4 error:(id *)arg5;	// IMP=0x00000001000542b8
- (id)postDataForEnrolment:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x00000001000541c8
- (id)postData:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100054064
- (_Bool)downloadFile:(id)arg1 to:(id)arg2 retry:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100053bfc
- (id)downloadFileToNSData:(id)arg1 retry:(long long)arg2 error:(id *)arg3;	// IMP=0x0000000100053ab8
- (void)dealloc;	// IMP=0x0000000100053978
- (void)setupServer:(id)arg1 port:(id)arg2;	// IMP=0x0000000100053914
- (id)initWithCellularAccess:(_Bool)arg1;	// IMP=0x00000001000536e4
