...
+ (id)sharedInstance;	// IMP=0x000000010005ab70
- (void).cxx_destruct;	// IMP=0x000000010005c5e4
...
- (_Bool)compareSavedHubHostsWithNewHosts;	// IMP=0x000000010005c180
- (_Bool)compareSavedHubHostNameWithNewHostName;	// IMP=0x000000010005beec
- (_Bool)enrollAndSetup:(id *)arg1;	// IMP=0x000000010005bb18
- (_Bool)askFindMyHubForHubInfoAndDeviceOptions;	// IMP=0x000000010005afe0
- (unsigned long long)queryFindMyHubAndDetermineLogicSyncResult;	// IMP=0x000000010005ace0
- (_Bool)discoverAndEnrollWithHub:(id *)arg1;	// IMP=0x000000010005ac20
