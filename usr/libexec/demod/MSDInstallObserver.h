...
- (void)coordinator:(id)arg1 canceledWithReason:(id)arg2 client:(unsigned long long)arg3;	// IMP=0x000000010004c59c
- (void)coordinatorDidCompleteSuccessfully:(id)arg1;	// IMP=0x000000010004c550
- (id)init;	// IMP=0x000000010004c4e4
