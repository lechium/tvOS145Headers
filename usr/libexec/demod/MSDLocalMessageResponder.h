...
+ (id)sharedInstance;	// IMP=0x0000000100032e3c
- (void).cxx_destruct;	// IMP=0x0000000100036b74
...
- (_Bool)saveOperationRequestIfNeeded:(id)arg1 server:(id)arg2 port:(id)arg3 completeBy:(int)arg4;	// IMP=0x0000000100036950
- (void)lostClientConnection:(id)arg1;	// IMP=0x0000000100036858
- (void)sendRebootTimeoutMessageToPricing:(int)arg1;	// IMP=0x0000000100036784
- (void)handleMessage:(id)arg1 from:(id)arg2;	// IMP=0x0000000100033974
- (void)start;	// IMP=0x000000010003343c
- (_Bool)checkEntitlementsWithRequest:(id)arg1 from:(id)arg2;	// IMP=0x0000000100033100
- (id)getEntitlementsFrom:(id)arg1;	// IMP=0x0000000100032ea8
