...
+ (id)sharedInstance;	// IMP=0x0000000100073544
- (void).cxx_destruct;	// IMP=0x0000000100076540
...
- (long long)convertPingType:(unsigned long long)arg1;	// IMP=0x00000001000764a0
- (_Bool)updateManifestInfo:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000761a0
- (long long)pingIntervalToUse;	// IMP=0x0000000100076054
- (_Bool)processRequest:(id)arg1;	// IMP=0x0000000100074f4c
- (id)reducedKeyList;	// IMP=0x0000000100074ebc
- (id)fullKeyList;	// IMP=0x0000000100074df8
- (_Bool)ack:(_Bool)arg1;	// IMP=0x0000000100074bbc
- (id)pingWithType:(unsigned long long)arg1;	// IMP=0x0000000100074580
- (void)pingAndProcess:(unsigned long long)arg1 waitForCompletion:(_Bool)arg2;	// IMP=0x00000001000741dc
...
- (void)handlePingTimerTicking:(id)arg1;	// IMP=0x000000010007406c
- (void)startPeriodicPing;	// IMP=0x0000000100073da4
- (void)sendImmediateDeviceInfoPing;	// IMP=0x0000000100073ce8
- (void)sendPushNotificationPing;	// IMP=0x0000000100073cd4
- (void)reportBundleInstallCompleted;	// IMP=0x0000000100073cc0
- (void)reportCachingHubFailed;	// IMP=0x0000000100073cac
- (void)start;	// IMP=0x00000001000739bc
- (void)contentServerDidDisappear;	// IMP=0x00000001000739b8
- (void)contentServerDidAppear:(id)arg1 port:(id)arg2;	// IMP=0x00000001000736c8
- (id)init;	// IMP=0x00000001000735b0
