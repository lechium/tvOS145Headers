...
- (void).cxx_destruct;	// IMP=0x000000010000c6a4
...
- (void)pushToTestLog:(id)arg1;	// IMP=0x000000010000c518
- (id)description;	// IMP=0x000000010000c488
- (void)appendDownloadedFileSize:(long long)arg1;	// IMP=0x000000010000c388
- (void)processServerRangeResponse:(id)arg1;	// IMP=0x000000010000c258
- (id)getRangeHeaderForDownload;	// IMP=0x000000010000c070
- (_Bool)isDownloadComplete;	// IMP=0x000000010000bed8
- (id)init;	// IMP=0x000000010000be94
