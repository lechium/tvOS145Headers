...
+ (id)sharedInstance;	// IMP=0x000000010000b330
...
- (id)sanitizeTestLog:(id)arg1;	// IMP=0x000000010000bce8
- (void)pushTestLog:(id)arg1;	// IMP=0x000000010000bc50
- (void)sendCommandsToDemod:(id)arg1 replyFromDemod:(CDUnknownBlockType)arg2;	// IMP=0x000000010000b9bc
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000b734
- (void)sendTestEvents:(id)arg1;	// IMP=0x000000010000b5f8
- (void)pushTestEvent:(id)arg1 ofType:(id)arg2;	// IMP=0x000000010000b528
- (id)getTimeStamp;	// IMP=0x000000010000b4cc
- (void)start;	// IMP=0x000000010000b3b4
