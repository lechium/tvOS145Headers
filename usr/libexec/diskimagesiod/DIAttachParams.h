...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000d014
- (void).cxx_destruct;	// IMP=0x000000010001cda8
...
- (id)newAttachWithError:(id *)arg1;	// IMP=0x000000010001c988
- (_Bool)reOpenIfWritableWithError:(id *)arg1;	// IMP=0x000000010001c064
- (id)initWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000010001bf88
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010001bdbc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001bbe8
