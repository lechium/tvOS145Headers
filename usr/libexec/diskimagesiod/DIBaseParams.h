...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100023360
- (void).cxx_destruct;	// IMP=0x000000010002451c
...
- (id)copyInstanceID;	// IMP=0x0000000100024368
- (void)invalidate;	// IMP=0x0000000100024358
- (_Bool)hasCryptoBackend;	// IMP=0x00000001000242b0
- (_Bool)getPassphraseFromUserWithXpcHandler:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000241b4
- (_Bool)getPassphraseFromConsoleWithUseStdin:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000100023e80
- (id)description;	// IMP=0x0000000100023db8
- (id)copyEncryptionUUID;	// IMP=0x0000000100023d44
- (_Bool)setPassphrase:(const char *)arg1 error:(id *)arg2;	// IMP=0x000000010002391c
- (id)initWithURL:(id)arg1 fileOpenMode:(unsigned short)arg2 error:(id *)arg3;	// IMP=0x0000000100023734
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000235a8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000233f0
