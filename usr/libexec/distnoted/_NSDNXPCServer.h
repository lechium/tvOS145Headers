...
- (id)createEndpoint;	// IMP=0x0000000100001cdc
- (id)allClients;	// IMP=0x0000000100001c94
- (void)start;	// IMP=0x0000000100001a84
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100001a08
- (void)invalidate;	// IMP=0x00000001000018c0
- (id)__invalidate;	// IMP=0x0000000100001884
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x000000010000187c
- (id)dispatchQueue;	// IMP=0x0000000100001874
...
- (void)dealloc;	// IMP=0x000000010000165c
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x00000001000015a0
