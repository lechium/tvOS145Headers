...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0000000100005040
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0000000100004d70
...
- (void)main;	// IMP=0x0000000100004b94
- (_Bool)isAsynchronous;	// IMP=0x0000000100004b8c
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0000000100004ad8
