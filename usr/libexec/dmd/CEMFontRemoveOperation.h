...
- (void).cxx_destruct;	// IMP=0x0000000100005358
...
- (void)main;	// IMP=0x00000001000051d0
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x000000010000511c
