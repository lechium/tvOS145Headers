...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0000000100005ba8
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x00000001000058d8
...
- (void)main;	// IMP=0x00000001000056fc
- (_Bool)isAsynchronous;	// IMP=0x00000001000056f4
- (id)initWithImageDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0000000100005640
