...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x000000010000a440
- (id)_datesForNextCurfewBoundary;	// IMP=0x000000010000a078
- (void)_registerPredicateObserver;	// IMP=0x0000000100009c88
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x000000010000939c
- (id)metadata;	// IMP=0x0000000100009254
- (void)updateObserverRegistration;	// IMP=0x0000000100009248
- (void)invalidate;	// IMP=0x00000001000090cc
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x0000000100008bd8
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x0000000100008ad4
