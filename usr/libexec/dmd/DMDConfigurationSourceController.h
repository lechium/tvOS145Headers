...
- (void).cxx_destruct;	// IMP=0x00000001000321c8
...
- (void)resolveAssetWithContext:(id)arg1;	// IMP=0x00000001000320d8
- (void)reportEvents;	// IMP=0x0000000100031ff8
- (void)reportEventsTimeout;	// IMP=0x0000000100031fec
- (void)eventsForSourceDidChange:(id)arg1;	// IMP=0x0000000100031de8
- (void)reportStatus;	// IMP=0x0000000100031d08
- (void)reportStatusTimeout;	// IMP=0x0000000100031cfc
- (void)statusForSourceDidChange:(id)arg1;	// IMP=0x0000000100031af8
- (void)updateStatusChangeListener;	// IMP=0x0000000100031a04
@property(readonly, nonatomic) DMFConfigurationSource *configurationSource;
- (void)updateWithConfigurationSource:(id)arg1;	// IMP=0x0000000100031700
@property(readonly, copy, nonatomic) NSString *displayName;
@property(readonly, copy, nonatomic) NSString *organizationIdentifier;
- (id)debugDescription;	// IMP=0x00000001000315a8
- (id)description;	// IMP=0x00000001000314f8
- (id)initWithConfigurationSource:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100031320
