...
- (void)networkDidChange;	// IMP=0x000000010003623c
- (void)keybagLockStateDidChange;	// IMP=0x00000001000361cc
- (void)stopObservingChanges;	// IMP=0x0000000100036180
- (void)startObservingChanges;	// IMP=0x0000000100035d90
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0000000100035c94
