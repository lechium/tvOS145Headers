...
- (void).cxx_destruct;	// IMP=0x00000001000403d0
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x0000000100040224
- (void)main;	// IMP=0x000000010003fa88
