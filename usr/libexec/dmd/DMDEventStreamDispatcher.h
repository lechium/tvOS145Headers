...
- (void)_dispatchToListenerForKey:(id)arg1 inMap:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000100043300
- (void)_registerListener:(id)arg1 forKeys:(id)arg2 inMap:(id)arg3;	// IMP=0x00000001000430ec
- (void)_registerEventStreamHandlers;	// IMP=0x0000000100042948
- (id)initWithListeners:(id)arg1;	// IMP=0x0000000100042664
