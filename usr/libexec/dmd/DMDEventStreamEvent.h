...
- (void).cxx_destruct;	// IMP=0x0000000100043818
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x00000001000436b8
- (id)description;	// IMP=0x0000000100043608
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x000000010004352c
