...
- (void).cxx_destruct;	// IMP=0x000000010005a528
@property(readonly, nonatomic) DMDPolicyPersistence *policyPersistence; // @synthesize policyPersistence=_policyPersistence;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010005a3c8
- (id)initWithPolicyPersistence:(id)arg1;	// IMP=0x000000010005a350
