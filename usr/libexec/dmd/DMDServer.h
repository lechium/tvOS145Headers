...
+ (id)sharedServer;	// IMP=0x000000010005fb40
- (void).cxx_destruct;	// IMP=0x000000010005fdf0
...
- (void)invalidate;	// IMP=0x000000010005fcd4
- (void)run;	// IMP=0x000000010005fbac
- (id)init;	// IMP=0x000000010005f84c
