...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100061140
- (void).cxx_destruct;	// IMP=0x0000000100061708
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100061448
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100061148
