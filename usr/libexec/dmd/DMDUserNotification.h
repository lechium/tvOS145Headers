...
- (void).cxx_destruct;	// IMP=0x0000000100068e98
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x0000000100068dbc
- (struct __CFUserNotification *)notificationRef;	// IMP=0x0000000100068db4
- (void)dealloc;	// IMP=0x0000000100068d68
- (id)init;	// IMP=0x0000000100068cf8
