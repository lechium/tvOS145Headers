...
+ (id)sharedController;	// IMP=0x0000000100068ef8
- (void).cxx_destruct;	// IMP=0x0000000100069fa4
...
- (void)_notificationRef:(struct __CFUserNotification *)arg1 wasDismissedWithFlags:(unsigned long long)arg2;	// IMP=0x0000000100069cd0
- (void)_completeNotification:(id)arg1 response:(unsigned long long)arg2;	// IMP=0x0000000100069b08
- (void)_showNextNotification;	// IMP=0x0000000100069718
- (id)_dictFromNotification:(id)arg1;	// IMP=0x0000000100069500
- (void)showNotification:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100069064
- (id)initPrivate;	// IMP=0x0000000100068fa0
