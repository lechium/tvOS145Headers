...
- (void)dealloc;	// IMP=0x00000001000115bc
- (id)description;	// IMP=0x0000000100011530
- (_Bool)isInternalEvent;	// IMP=0x0000000100011518
- (id)initWithEventType:(int)arg1 filter:(id)arg2 client:(id)arg3 data:(id)arg4;	// IMP=0x000000010001128c
