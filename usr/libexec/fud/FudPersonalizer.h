...
- (_Bool)personalizeWithServer:(id)arg1;	// IMP=0x00000001000092a4
- (struct __CFDictionary *)createPersonalizationManifestCFDict:(id)arg1;	// IMP=0x0000000100008a94
- (struct __CFDictionary *)createPersonalizationObjectCFDict:(id)arg1;	// IMP=0x0000000100008864
- (void)doPersonalization:(id)arg1;	// IMP=0x00000001000085b8
- (void)overrideSecurityDomain:(_Bool)arg1;	// IMP=0x00000001000085b0
- (void)overrideServerURL:(id)arg1;	// IMP=0x0000000100008568
- (void)dealloc;	// IMP=0x00000001000084fc
- (void)freePersonalizationData;	// IMP=0x0000000100008470
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000100008388
