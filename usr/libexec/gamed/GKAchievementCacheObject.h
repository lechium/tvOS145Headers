...
+ (id)entityName;	// IMP=0x0000000100059690
- (id)internalRepresentation;	// IMP=0x0000000100059688
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005938c
