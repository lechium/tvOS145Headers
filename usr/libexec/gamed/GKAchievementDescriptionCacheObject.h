...
+ (id)entityName;	// IMP=0x000000010005898c
- (id)internalRepresentation;	// IMP=0x00000001000585f4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000581dc
