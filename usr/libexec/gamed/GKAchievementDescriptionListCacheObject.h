...
+ (id)entityName;	// IMP=0x0000000100058030
- (_Bool)isValid;	// IMP=0x0000000100058148
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005803c
