...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010016aefc
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010016acd0
- (void).cxx_destruct;	// IMP=0x000000010016b6a8
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010016b55c
...
- (unsigned long long)hash;	// IMP=0x000000010016b424
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016b2d8
- (id)serverRepresentation;	// IMP=0x000000010016b0e8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010016afe8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010016af04
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x000000010016b760
