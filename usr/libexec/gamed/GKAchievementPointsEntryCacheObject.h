...
+ (id)entityName;	// IMP=0x0000000100069140
- (id)internalRepresentation;	// IMP=0x000000010006934c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010006914c
