...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x00000001000b51c8
- (void).cxx_destruct;	// IMP=0x00000001000b5810
...
- (id)bundleURL;	// IMP=0x00000001000b5484
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x00000001000b5168
- (id)initWithProxy:(id)arg1;	// IMP=0x00000001000b50f4
