...
+ (void)migratePreSundanceAccountInformation;	// IMP=0x00000001000af354
+ (void)migratePreBlacktailAccountInformation;	// IMP=0x00000001000aee08
+ (id)authMachineForEnvironment:(long long)arg1;	// IMP=0x00000001000aec48
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000aec40
- (void).cxx_destruct;	// IMP=0x00000001000afaf0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000aed38
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000aec50
