...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x000000010011c01c
+ (_Bool)shouldProcessNotification;	// IMP=0x000000010011bcf4
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010011b910
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010011ac78
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010011a574
+ (id)syncQueue;	// IMP=0x000000010011a4dc
- (void).cxx_destruct;	// IMP=0x000000010011c72c
...
- (id)description;	// IMP=0x000000010011c340
- (void)handleAction:(id)arg1;	// IMP=0x000000010011c1c4
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x000000010011be8c
- (id)initWithPushNotification:(id)arg1;	// IMP=0x000000010011bac4
- (id)dataFrom64String:(id)arg1;	// IMP=0x000000010011b918
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010011b378
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010011ae04
