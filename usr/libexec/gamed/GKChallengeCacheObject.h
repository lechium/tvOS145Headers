...
+ (id)entityName;	// IMP=0x00000001000704ec
+ (id)fetchSortDescriptors;	// IMP=0x000000010006f5c0
+ (id)challengeWithServerRepresentation:(id)arg1 context:(id)arg2;	// IMP=0x000000010006f208
+ (id)challengesWithChallengeIDs:(id)arg1 context:(id)arg2;	// IMP=0x000000010006efec
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010006efe0
+ (id)uniqueAttributeName;	// IMP=0x000000010006efd4
- (void)invalidate;	// IMP=0x00000001000706b8
- (_Bool)hasDetails;	// IMP=0x00000001000704f8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010006fe64
- (id)orderedSetOfCompatibleBundleIDs;	// IMP=0x000000010006fb20
- (id)internalRepresentation;	// IMP=0x000000010006f678
- (Class)classForInternalRepresentation;	// IMP=0x000000010006f670
