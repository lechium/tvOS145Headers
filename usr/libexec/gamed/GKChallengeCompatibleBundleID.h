...
+ (id)entityName;	// IMP=0x0000000100070710
- (id)internalRepresentation;	// IMP=0x000000010007071c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010007070c
