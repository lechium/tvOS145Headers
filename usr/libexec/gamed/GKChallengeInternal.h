...
+ (id)internalRepresentation;	// IMP=0x000000010016f80c
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010016f3a4
- (void).cxx_destruct;	// IMP=0x000000010016ff18
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010016fda8
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x000000010016f9a8
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x000000010016f820
- (id)serverRepresentation;	// IMP=0x000000010016f814
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016f750
- (unsigned long long)hash;	// IMP=0x000000010016f704
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010016f5d0
