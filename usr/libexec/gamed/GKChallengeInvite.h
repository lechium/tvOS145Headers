...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000bdd00
- (void).cxx_destruct;	// IMP=0x00000001000bf420
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000be8ec
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000bddfc
- (id)initWithChallenge:(id)arg1;	// IMP=0x00000001000bdd84
- (id)challengeInternalObject;	// IMP=0x00000001000bdd7c
- (id)description;	// IMP=0x00000001000bdd08
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000bdc04
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000bd9c4
