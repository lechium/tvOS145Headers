...
+ (Class)entryClass;	// IMP=0x000000010006e9a8
+ (id)entityName;	// IMP=0x000000010006e99c
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010006e9b4
