...
+ (id)entityName;	// IMP=0x0000000100060e68
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000613d0
- (id)internalRepresentation;	// IMP=0x0000000100060e74
