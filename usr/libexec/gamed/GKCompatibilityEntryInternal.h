...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100179610
- (void).cxx_destruct;	// IMP=0x0000000100179be0
...
- (unsigned long long)hash;	// IMP=0x0000000100179a74
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100179810
