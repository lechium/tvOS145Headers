...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x00000001001302c0
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001300c4
- (void).cxx_destruct;	// IMP=0x0000000100130674
