...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00000001001c17b8
- (void).cxx_destruct;	// IMP=0x00000001001c1d54
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001001c18d8
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00000001001c1830
