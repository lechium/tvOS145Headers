...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x000000010015bc10
- (void).cxx_destruct;	// IMP=0x000000010015c020
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010015bd30
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x000000010015bc88
