...
+ (id)entityName;	// IMP=0x0000000100063e8c
- (id)internalRepresentation;	// IMP=0x0000000100063bc4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010006383c
