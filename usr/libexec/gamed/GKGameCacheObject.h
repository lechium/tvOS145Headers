...
+ (id)entityName;	// IMP=0x0000000100058024
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0000000100055928
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x000000010005576c
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x00000001000555b0
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x000000010005535c
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0000000100055244
+ (id)fetchSortDescriptors;	// IMP=0x0000000100055158
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010005514c
+ (id)uniqueAttributeName;	// IMP=0x0000000100055140
- (id)gameDescriptor;	// IMP=0x0000000100057c04
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x0000000100057b50
- (id)internalRepresentation;	// IMP=0x00000001000579a4
- (_Bool)storePiecesExpired;	// IMP=0x0000000100057954
- (_Bool)storePiecesValid;	// IMP=0x00000001000578e4
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00000001000570d4
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005675c
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x0000000100055eec
- (_Bool)isValid;	// IMP=0x0000000100055e44
- (void)invalidate;	// IMP=0x00000001000550ec
