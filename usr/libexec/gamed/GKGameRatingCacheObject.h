...
+ (id)entityName;	// IMP=0x000000010005bd0c
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010005b7d0
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005ba98
