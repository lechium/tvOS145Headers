...
+ (id)entityName;	// IMP=0x0000000100068118
- (id)internalRepresentation;	// IMP=0x0000000100068414
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100068124
