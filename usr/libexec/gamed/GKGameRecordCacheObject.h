...
+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x000000010005b798
+ (id)fetchSortDescriptors;	// IMP=0x000000010005b644
+ (id)entityName;	// IMP=0x000000010005b638
+ (id)recordForGame:(id)arg1 playerProfile:(id)arg2;	// IMP=0x0000000100059a44
+ (id)recordsForGames:(id)arg1 playerProfile:(id)arg2;	// IMP=0x000000010005969c
- (id)internalRepresentation;	// IMP=0x000000010005b48c
- (void)updateAchievementsWithServerRepresentation:(id)arg1;	// IMP=0x000000010005b1d0
- (void)updateIDsWithServerRepresentation:(id)arg1;	// IMP=0x000000010005a7ec
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100059b58
