...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100178e0c
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x0000000100178d6c
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x0000000100178b90
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x000000010017856c
- (void).cxx_destruct;	// IMP=0x00000001001794f4
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100179254
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100179164
- (unsigned long long)hash;	// IMP=0x0000000100179118
- (id)init;	// IMP=0x0000000100178da8
