...
+ (id)sharedManager;	// IMP=0x000000010013ef14
- (void).cxx_destruct;	// IMP=0x000000010013f42c
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x000000010013f184
- (id)init;	// IMP=0x000000010013f0cc
