...
- (void).cxx_destruct;	// IMP=0x00000001000c23fc
...
- (void)setResult:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x00000001000c2238
@property(retain) NSError *error; // @synthesize error=_error;
- (oneway void)release;	// IMP=0x00000001000c20fc
- (id)retain;	// IMP=0x00000001000c2060
- (void)dealloc;	// IMP=0x00000001000c1ffc
- (id)init;	// IMP=0x00000001000c1f94
