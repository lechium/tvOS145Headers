...
+ (id)entityName;	// IMP=0x0000000100065c90
- (id)internalRepresentation;	// IMP=0x000000010006577c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100064edc
