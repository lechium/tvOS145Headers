...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010016b928
- (void).cxx_destruct;	// IMP=0x000000010016c0d0
...
- (unsigned long long)hash;	// IMP=0x000000010016bdac
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016bcc4
