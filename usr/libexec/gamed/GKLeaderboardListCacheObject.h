...
+ (id)entityName;	// IMP=0x000000010005ceb0
- (_Bool)isValid;	// IMP=0x000000010005cfc8
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005cebc
