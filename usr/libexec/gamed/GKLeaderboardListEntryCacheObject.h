...
+ (id)entityName;	// IMP=0x000000010005ca60
- (id)internalRepresentation;	// IMP=0x000000010005ccd8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005ca6c
