...
+ (id)entityName;	// IMP=0x000000010005c83c
- (id)internalRepresentation;	// IMP=0x000000010005c518
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005bed0
