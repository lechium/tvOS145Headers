...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010016c250
- (void).cxx_destruct;	// IMP=0x000000010016c634
...
- (unsigned long long)hash;	// IMP=0x000000010016c534
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016c44c
