...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100177e30
- (void).cxx_destruct;	// IMP=0x00000001001784c8
...
- (_Bool)hasGuestPlayers;	// IMP=0x000000010017819c
- (unsigned long long)hash;	// IMP=0x0000000100177dbc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100177614
- (id)init;	// IMP=0x0000000100177594
