...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100164c10
- (void).cxx_destruct;	// IMP=0x0000000100164ec8
...
- (id)description;	// IMP=0x0000000100164ab0
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x0000000100164960
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100164708
