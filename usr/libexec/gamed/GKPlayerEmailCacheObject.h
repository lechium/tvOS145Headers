...
+ (id)entityName;	// IMP=0x00000001000550e0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100054dc8
- (id)internalRepresentation;	// IMP=0x0000000100054b40
