...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100169a78
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100169a70
- (void).cxx_destruct;	// IMP=0x0000000100169dbc
...
- (unsigned long long)hash;	// IMP=0x0000000100169ca8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100169b6c
