...
@interface GKPlayerInternal : GKInternalRepresentation
{
    ...
    long long _globalFriendListAccess;	// 176 = 0xb0
    union {
        struct {
    ...
    NSArray *_monogramComponents;	// 192 = 0xc0
}

+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x0000000100167adc
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x00000001001679cc
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x000000010016781c
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100166d3c
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100166d34
+ (id)propertiesToFetch;	// IMP=0x000000010017d4a4
+ (int)familiarity;	// IMP=0x000000010017d49c
+ (unsigned char)piecesToLoad;	// IMP=0x000000010017d460
- (void).cxx_destruct;	// IMP=0x000000010016827c
...
- (id)debugDescription;	// IMP=0x0000000100167d70
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x0000000100167d40
- (_Bool)allowNearbyMultiplayer;	// IMP=0x0000000100167d38
...
- (long long)globalFriendListSharingStatus;	// IMP=0x0000000100167d08
...
- (int)defaultFamiliarity;	// IMP=0x0000000100167b4c
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x0000000100167900
- (id)minimalInternal;	// IMP=0x0000000100167438
- (unsigned long long)hash;	// IMP=0x00000001001673ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100167300
- (id)serverRepresentation;	// IMP=0x00000001001671f0
- (id)conciseDescription;	// IMP=0x0000000100167124
- (id)cacheKey;	// IMP=0x0000000100167118
- (void)updateWithProperties:(id)arg1;	// IMP=0x000000010017d4fc
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010017cedc
