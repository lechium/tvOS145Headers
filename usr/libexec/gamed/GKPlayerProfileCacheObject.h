...
+ (id)entityName;	// IMP=0x000000010005326c
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100051394
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00000001000512f0
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x0000000100051200
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100050f24
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x0000000100050c84
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010004ffd4
+ (id)uniqueAttributeName;	// IMP=0x000000010004ffc8
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x0000000100054914
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x00000001000548e4
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x0000000100054358
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0000000100054114
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0000000100053d08
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0000000100053b00
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x0000000100053904
+ (id)selfPlayerID;	// IMP=0x00000001000538a8
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x00000001000535e8
+ (id)_familiarityLookup;	// IMP=0x00000001000533f4
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x0000000100053278
- (id)internalRepresentation;	// IMP=0x00000001000530b0
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x0000000100052e30
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x0000000100051c2c
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x0000000100051768
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100051758
- (void)deleteCachedImage:(id)arg1;	// IMP=0x00000001000507bc
- (void)deleteCachedAvatars;	// IMP=0x00000001000504e4
- (void)clearImages;	// IMP=0x0000000100050190
...
- (void)invalidate;	// IMP=0x0000000100050068
...
@property(nonatomic) long long globalFriendListAccess; // @dynamic globalFriendListAccess;
