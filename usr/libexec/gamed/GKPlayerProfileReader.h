...
+ (id)readerWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x00000001001739cc
- (void).cxx_destruct;	// IMP=0x0000000100174e78
...
- (void)readResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100173f3c
- (id)poolName;	// IMP=0x0000000100173ee8
- (int)familiarityForPlayer:(id)arg1;	// IMP=0x0000000100173c68
- (id)initWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x0000000100173ad4
