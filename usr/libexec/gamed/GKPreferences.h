...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x0000000100098fd0
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x0000000100098f94
+ (id)shared;	// IMP=0x0000000100097bfc
- (void).cxx_destruct;	// IMP=0x000000010009a30c
...
- (void)setMultiplayerShouldAlwaysReloadCollectionView:(_Bool)arg1;	// IMP=0x0000000100099584
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x0000000100098290
- (void)setStringValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000100098278
- (id)stringValueForKey:(id)arg1 defaultValue:(id)arg2;	// IMP=0x0000000100098200
- (void)setTimeInterval:(double)arg1 forKey:(id)arg2;	// IMP=0x0000000100098154
- (double)timeIntervalForKey:(id)arg1 defaultValue:(double)arg2;	// IMP=0x00000001000980f4
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(id)arg2;	// IMP=0x0000000100098050
- (long long)unsignedIntegerValueForKey:(id)arg1 defaultValue:(long long)arg2;	// IMP=0x0000000100097ff8
- (void)setIntegerValue:(long long)arg1 forKey:(id)arg2;	// IMP=0x0000000100097f54
- (long long)integerValueForKey:(id)arg1 defaultValue:(long long)arg2;	// IMP=0x0000000100097efc
- (void)setBooleanValue:(_Bool)arg1 forKey:(id)arg2;	// IMP=0x0000000100097e70
- (_Bool)booleanValueForKey:(id)arg1;	// IMP=0x0000000100097e60
- (_Bool)booleanValueForKey:(id)arg1 defaultValue:(_Bool)arg2;	// IMP=0x0000000100097e08
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x0000000100097d98
- (void)_didWriteKey:(id)arg1;	// IMP=0x0000000100097d70
- (void)synchronize;	// IMP=0x0000000100097d34
- (void)invalidate;	// IMP=0x0000000100097d24
- (_Bool)isInternalBuild;	// IMP=0x0000000100097ca8
- (id)init;	// IMP=0x0000000100097bf0
- (id)initWithoutUIKitNotifications;	// IMP=0x0000000100097b5c
- (id)initWithUIKitNotifications;	// IMP=0x0000000100097b50
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x000000010011cd60
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x000000010011ccdc
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x000000010011cc58
...
- (void)getMultiplayerAllowedPlayerTypeWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010011cab0
