...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010003c484
...
- (id)description;	// IMP=0x000000010003e1fc
- (id)customInviteSoundPathForBundleID:(id)arg1;	// IMP=0x000000010003dff8
- (void)declineInviteWithReason:(int)arg1;	// IMP=0x000000010003ddb0
- (void)updateDeclineInviteTrackingForReason:(long long)arg1;	// IMP=0x000000010003dbd0
- (id)clientNotification;	// IMP=0x000000010003d6dc
- (id)clientNotificationWithiCloudID:(id)arg1;	// IMP=0x000000010003d634
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010003d1e0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010003cd08
- (id)initWithPushNotification:(id)arg1;	// IMP=0x000000010003c854
- (void)parseClientData:(id)arg1;	// IMP=0x000000010003c688
- (long long)inviteVersionFromMessage:(id)arg1;	// IMP=0x000000010003c4c0
- (id)init;	// IMP=0x000000010003c48c
