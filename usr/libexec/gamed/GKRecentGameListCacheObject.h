...
+ (Class)entryClass;	// IMP=0x0000000100066834
+ (id)entityName;	// IMP=0x0000000100066828
- (id)internalRepresentation;	// IMP=0x0000000100066ad0
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100066840
