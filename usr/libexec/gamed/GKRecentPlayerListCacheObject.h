...
+ (Class)entryClass;	// IMP=0x0000000100065ca8
+ (id)entityName;	// IMP=0x0000000100065c9c
- (id)internalRepresentation;	// IMP=0x0000000100065f44
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100065cb4
