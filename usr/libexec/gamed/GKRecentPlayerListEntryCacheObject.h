...
+ (id)entityName;	// IMP=0x0000000100066408
- (id)internalRepresentation;	// IMP=0x0000000100066698
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100066414
