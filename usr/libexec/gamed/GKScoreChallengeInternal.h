...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010016fff8
+ (id)internalRepresentation;	// IMP=0x000000010016ffe4
- (void).cxx_destruct;	// IMP=0x000000010017063c
...
- (id)titleText;	// IMP=0x000000010017047c
- (unsigned long long)type;	// IMP=0x0000000100170474
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0000000100170130
