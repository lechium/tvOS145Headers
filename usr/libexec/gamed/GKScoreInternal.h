...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010016d020
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010016c9c8
- (void).cxx_destruct;	// IMP=0x000000010016d888
...
- (unsigned long long)hash;	// IMP=0x000000010016d718
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016d3d4
- (id)serverRepresentation;	// IMP=0x000000010016d1d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010016cef4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010016c9f0
