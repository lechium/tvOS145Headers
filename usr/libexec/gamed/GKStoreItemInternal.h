...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100162e84
- (void).cxx_destruct;	// IMP=0x00000001001636f8
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010016323c
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x000000010016315c
- (_Bool)isValid;	// IMP=0x0000000100163120
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100163064
- (unsigned long long)hash;	// IMP=0x000000010016304c
- (void)updateWithProperties:(id)arg1;	// IMP=0x000000010017ca94
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010017c4f4
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010017c01c
