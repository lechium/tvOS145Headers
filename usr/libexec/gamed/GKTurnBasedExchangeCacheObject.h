...
+ (id)entityName;	// IMP=0x000000010006c210
- (id)internalRepresentation;	// IMP=0x000000010006cacc
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x000000010006c21c
