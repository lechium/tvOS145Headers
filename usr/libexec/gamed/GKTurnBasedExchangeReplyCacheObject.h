...
+ (id)entityName;	// IMP=0x000000010006cad4
- (id)internalRepresentation;	// IMP=0x000000010006ce3c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010006cae0
