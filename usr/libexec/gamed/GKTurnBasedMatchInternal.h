...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100174ecc
- (void).cxx_destruct;	// IMP=0x0000000100176358
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100176024
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x00000001001757b8
- (long long)previousParticipantIndex;	// IMP=0x00000001001755b8
- (long long)localPlayerParticipantIndex;	// IMP=0x0000000100175514
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010017535c
- (unsigned long long)hash;	// IMP=0x0000000100175310
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010017eae0
