...
+ (id)entityName;	// IMP=0x000000010006bdc0
- (id)internalRepresentation;	// IMP=0x000000010006c208
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010006bdcc
