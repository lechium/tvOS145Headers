...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001764d8
- (void).cxx_destruct;	// IMP=0x0000000100176c2c
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100176a28
- (id)serverRepresentation;	// IMP=0x00000001001767ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001766a4
- (unsigned long long)hash;	// IMP=0x0000000100176688
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010017f73c
