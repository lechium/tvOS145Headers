...
+ (id)sessionsWithSessionIDs:(id)arg1 inContext:(id)arg2;	// IMP=0x000000010006b5b4
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010006b5a8
+ (id)uniqueAttributeName;	// IMP=0x000000010006b59c
+ (id)sessionWithID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x000000010006b488
+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x0000000100069530
+ (id)entityName;	// IMP=0x0000000100069524
- (id)internalRepresentation;	// IMP=0x000000010006bc14
- (id)participantAtIndex:(long long)arg1;	// IMP=0x000000010006b9f0
- (void)expire;	// IMP=0x000000010006b978
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010006a3dc
- (id)participantWithPlayerID:(id)arg1;	// IMP=0x000000010006a0d8
- (void)saveGameData:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100069d78
- (void)expireGameData;	// IMP=0x0000000100069ba8
- (void)deleteGameData;	// IMP=0x0000000100069880
- (id)gameData;	// IMP=0x0000000100069660
- (void)prepareForDeletion;	// IMP=0x0000000100069614
- (_Bool)isActive;	// IMP=0x0000000100069570
