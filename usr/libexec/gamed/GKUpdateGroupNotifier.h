...
- (void).cxx_destruct;	// IMP=0x000000010016df00
...
- (void)addUpdatesFromGroup:(id)arg1;	// IMP=0x000000010016ddb0
- (void)addUpdate:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x000000010016dc24
- (void)updateError:(id)arg1;	// IMP=0x000000010016dba0
- (oneway void)release;	// IMP=0x000000010016daf0
- (id)retain;	// IMP=0x000000010016da54
- (void)dealloc;	// IMP=0x000000010016d9f0
- (id)init;	// IMP=0x000000010016d988
