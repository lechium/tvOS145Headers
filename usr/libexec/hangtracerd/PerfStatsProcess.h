...
+ (id)processWithPID:(int)arg1 name:(const char *)arg2;	// IMP=0x00000001000104f8
+ (unsigned long long)generateUniqueIDForPID:(int)arg1 processName:(id)arg2;	// IMP=0x00000001000104c4
...
- (id)initWithPID:(int)arg1 name:(id)arg2;	// IMP=0x0000000100010580
