...
+ (int)dumpConnectedHosts:(id *)arg1;	// IMP=0x0000000100002128
+ (void)invalidateServiceWithPID:(int)arg1 heartBeatRef:(unsigned long long)arg2;	// IMP=0x0000000100001f94
+ (void)invalidateWatcherForHost:(struct __CFString *)arg1;	// IMP=0x0000000100001c24
+ (void)removeService:(id)arg1 forHostID:(struct __CFString *)arg2;	// IMP=0x0000000100001b4c
+ (void)addService:(id)arg1 forHostID:(struct __CFString *)arg2;	// IMP=0x0000000100001a48
...
- (void)enumerateServices:(CDUnknownBlockType)arg1;	// IMP=0x0000000100004d14
- (void)removeService:(id)arg1;	// IMP=0x0000000100004ca4
- (void)addService:(id)arg1;	// IMP=0x0000000100004c34
- (void)dealloc;	// IMP=0x0000000100004ab8
- (id)initWithCheckinGoop:(void *)arg1;	// IMP=0x000000010000431c
- (id)description;	// IMP=0x0000000100004298
- (void)handleSleepNotification:(unsigned int)arg1 service:(unsigned int)arg2 messageArgument:(void *)arg3;	// IMP=0x00000001000039e8
- (void)runWatcher;	// IMP=0x0000000100003048
- (void)invalidate;	// IMP=0x0000000100002be0
- (id)receiveMessage:(char **)arg1 size:(unsigned long long *)arg2;	// IMP=0x0000000100002800
- (int)receivePacket:(char *)arg1 size:(unsigned long long)arg2;	// IMP=0x0000000100002784
- (int)sendPacket:(const char *)arg1 size:(unsigned long long)arg2;	// IMP=0x0000000100002710
- (long long)_receivePartialPacket:(char *)arg1 size:(unsigned long long)arg2;	// IMP=0x0000000100002588
- (long long)_sendPartialPacket:(const char *)arg1 size:(unsigned long long)arg2;	// IMP=0x0000000100002400
