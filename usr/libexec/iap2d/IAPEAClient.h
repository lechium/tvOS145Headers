...
+ (unsigned int)clientIDForCameraClient;	// IMP=0x00000001000417c0
+ (unsigned int)clientIDForLocationClient;	// IMP=0x00000001000417b4
...
- (void)_setJetsamPrioritySpecialCasing:(_Bool)arg1;	// IMP=0x0000000100042040
- (int)_getProcessId;	// IMP=0x0000000100041f7c
@property(nonatomic) _Bool cameraSupportedByClient;
@property(nonatomic) _Bool locationSupportedByClient;
- (void)decreaseSessionRefCount;	// IMP=0x0000000100041dc4
- (void)increaseSessionRefCount;	// IMP=0x0000000100041d80
- (_Bool)canSendConnectionEventForAccessory:(id)arg1;	// IMP=0x0000000100041a18
- (void)takeProcessAssertion:(id)arg1;	// IMP=0x00000001000417cc
- (void)dealloc;	// IMP=0x0000000100041648
- (id)initWithCapabilities:(unsigned int)arg1 auditToken:(CDStruct_4c969caf)arg2 xpcConnection:(id)arg3 eaProtocols:(id)arg4 andBundleId:(id)arg5;	// IMP=0x0000000100041218
