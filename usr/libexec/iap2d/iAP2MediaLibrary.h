...
+ (_Bool)isMusicAppVisible;	// IMP=0x000000010003ca6c
+ (_Bool)allowCachedTracksForAppleMusic;	// IMP=0x000000010003ca20
+ (id)__getMediaLibraryFromConnectionID:(unsigned int)arg1;	// IMP=0x000000010003c9b8
...
- (_Bool)isGeniusMixesSupported;	// IMP=0x000000010003e6b8
- (void)stopSendingMediaLibraryInfomationUpdates;	// IMP=0x000000010003e640
- (void)startSendingMediaLibraryInfomationUpdates;	// IMP=0x000000010003e5c0
- (void)_updateMediaLibraryInfomationUpdates:(_Bool)arg1;	// IMP=0x000000010003e3c8
- (void)_sendLibraryInfoList;	// IMP=0x000000010003ddb4
- (_Bool)_checkForDifferentRadioLibrary;	// IMP=0x000000010003dc4c
- (_Bool)_checkForDifferentMediaLibraries;	// IMP=0x000000010003da34
- (void)dealloc;	// IMP=0x000000010003d748
- (void)shuttingDown;	// IMP=0x000000010003d4d0
- (id)initWithConnection:(id)arg1;	// IMP=0x000000010003d138
- (id)description;	// IMP=0x000000010003d098
- (void)_setupNewLibraries:(id)arg1;	// IMP=0x000000010003cd98
- (void)_handlMediaLibraryNeedFilterChange:(id)arg1;	// IMP=0x000000010003cd10
- (void)_mediaLibrariesAvailableChanged:(id)arg1;	// IMP=0x000000010003cc24
- (void)_handleSubscribedToAppleMusicChanged:(id)arg1;	// IMP=0x000000010003cc14
- (void)_updateSubscribedToAppleMusicStatus:(_Bool)arg1;	// IMP=0x000000010003cab4
