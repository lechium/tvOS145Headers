...
- (void)addEngineTypeBitmask:(int)arg1;	// IMP=0x000000010002ae94
- (_Bool)isVehicleInfoSupported:(int)arg1;	// IMP=0x000000010002ae70
- (void)dealloc;	// IMP=0x000000010002adb0
