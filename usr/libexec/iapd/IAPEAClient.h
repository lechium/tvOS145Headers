...
+ (unsigned int)clientIDForCameraClient;	// IMP=0x00000001000b62e8
+ (unsigned int)clientIDForLocationClient;	// IMP=0x00000001000b62dc
...
- (void)_setJetsamPrioritySpecialCasing:(_Bool)arg1;	// IMP=0x00000001000b6d88
- (int)_getProcessId;	// IMP=0x00000001000b6c8c
@property(nonatomic) _Bool cameraSupportedByClient;
@property(nonatomic) _Bool locationSupportedByClient;
- (void)decreaseSessionRefCount;	// IMP=0x00000001000b6a7c
- (void)increaseSessionRefCount;	// IMP=0x00000001000b6a24
- (_Bool)canSendConnectionEventForAccessory:(id)arg1;	// IMP=0x00000001000b661c
- (void)takeProcessAssertion:(id)arg1;	// IMP=0x00000001000b62f4
- (void)dealloc;	// IMP=0x00000001000b60c8
- (id)initWithCapabilities:(unsigned int)arg1 auditToken:(CDStruct_4c969caf)arg2 xpcConnection:(id)arg3 eaProtocols:(id)arg4 andBundleId:(id)arg5;	// IMP=0x00000001000b5b60
