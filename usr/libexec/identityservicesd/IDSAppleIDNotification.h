...
- (void).cxx_destruct;	// IMP=0x000000010023a6b8
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x000000010023a3c0
- (void)addSession:(id)arg1;	// IMP=0x000000010023a34c
- (void)addServiceType:(id)arg1;	// IMP=0x000000010023a2e8
- (void)addAlias:(id)arg1;	// IMP=0x000000010023a288
- (id)init;	// IMP=0x000000010023a160
