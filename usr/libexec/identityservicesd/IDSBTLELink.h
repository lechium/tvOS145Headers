...
- (void).cxx_destruct;	// IMP=0x0000000100150f94
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x0000000100150a48
- (void)didReceiveData:(id)arg1;	// IMP=0x000000010014ff68
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x000000010014fb8c
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x000000010014fb0c
- (unsigned long long)sendPacketBuffer:(CDStruct_78c9ccae *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x000000010014f814
- (id)copyLinkStatsDict;	// IMP=0x000000010014f698
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x000000010014f5e0
- (void)triggerBTCorruptionRecovery;	// IMP=0x000000010014f5b0
- (void)_localDetectedCorruption;	// IMP=0x000000010014f59c
- (void)dealloc;	// IMP=0x000000010014f53c
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010014f3c8
