...
- (void).cxx_destruct;	// IMP=0x000000010026a634
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010026a160
- (_Bool)wantsHTTPGet;	// IMP=0x000000010026a144
- (id)additionalQueryStringParameters;	// IMP=0x0000000100269f40
- (id)additionalMessageHeaders;	// IMP=0x0000000100269cec
- (id)bagKey;	// IMP=0x0000000100269cd0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002699f8
