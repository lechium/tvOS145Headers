...
- (void).cxx_destruct;	// IMP=0x00000001001a248c
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x00000001001a2090
- (void)sendMonitorMessage;	// IMP=0x00000001001a1758
- (void)checkConnectivityState:(id)arg1;	// IMP=0x00000001001a1388
- (id)init;	// IMP=0x00000001001a1218
