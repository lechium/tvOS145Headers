...
- (void).cxx_destruct;	// IMP=0x000000010008e3a8
...
- (void)copyOpportunisticCacheWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010008df2c
- (id)initWithQueue:(id)arg1 connection:(id)arg2 opportunisticCache:(id)arg3;	// IMP=0x000000010008de08
