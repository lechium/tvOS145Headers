...
- (void).cxx_destruct;	// IMP=0x00000001001a31f4
...
- (_Bool)_isEntitledForPreferInfraWiFiForServices:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001a2e4c
- (void)_defaultPeerSetPreferInfraWiFi:(_Bool)arg1 services:(id)arg2;	// IMP=0x00000001001a2dac
- (void)reunionSyncCompletedForServices:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a2a28
- (void)reunionSyncStartedForServices:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a26a4
- (id)initWithConnection:(id)arg1 clientProcessName:(id)arg2 UTunDeliveryController:(id)arg3 duetInterface:(id)arg4;	// IMP=0x00000001001a2540
