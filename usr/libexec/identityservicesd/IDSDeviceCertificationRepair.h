...
- (void).cxx_destruct;	// IMP=0x00000001005e0f8c
...
- (_Bool)_missingDeviceIdentity:(_Bool *)arg1;	// IMP=0x00000001005e0140
- (void)recertifyDeviceIfNeeded;	// IMP=0x00000001005df8d4
- (void)_repairTimerHit:(id)arg1;	// IMP=0x00000001005df878
- (id)init;	// IMP=0x00000001005df780
