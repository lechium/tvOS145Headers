...
- (void).cxx_destruct;	// IMP=0x000000010012f578
...
- (id)description;	// IMP=0x000000010012f44c
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x000000010012f330
