...
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x00000001001be8ec
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x00000001001be838
- (id)init;	// IMP=0x00000001001be7d0
