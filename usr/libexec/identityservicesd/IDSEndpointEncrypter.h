...
- (void).cxx_destruct;	// IMP=0x000000010044f1d0
...
- (void)decryptData:(id)arg1 usingIdentifier:(id)arg2 onQueue:(id)arg3 isRetry:(_Bool)arg4 replayKey:(id)arg5 withCompletion:(CDUnknownBlockType)arg6;	// IMP=0x000000010044e5cc
- (id)decryptData:(id)arg1 usingIdentifier:(id)arg2 isRetry:(_Bool)arg3 onQueue:(id)arg4 error:(id *)arg5;	// IMP=0x000000010044dde0
- (id)encryptData:(id)arg1 usedIdentifier:(id *)arg2 onQueue:(id)arg3 error:(id *)arg4;	// IMP=0x000000010044d78c
- (id)initWithEndpoint:(id)arg1 fullDeviceIdentityContainerEncrypter:(id)arg2 replayCommitter:(id)arg3 forceLegacyPK:(_Bool)arg4;	// IMP=0x000000010044d638
