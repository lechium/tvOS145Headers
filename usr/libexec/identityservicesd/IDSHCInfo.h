...
- (void *)remoteContext;	// IMP=0x000000010026efa0
- (void *)localContext;	// IMP=0x000000010026ef84
- (void)setRemoteContext:(void *)arg1;	// IMP=0x000000010026ed8c
- (void)setLocalContext:(void *)arg1;	// IMP=0x000000010026eb94
- (void)invalidate;	// IMP=0x000000010026e8ec
