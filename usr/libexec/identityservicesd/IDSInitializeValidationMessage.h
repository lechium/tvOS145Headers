...
- (void).cxx_destruct;	// IMP=0x00000001005cb480
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00000001005caec0
- (_Bool)requiresPushTokenKeys;	// IMP=0x00000001005caea4
- (id)additionalMessageHeaders;	// IMP=0x00000001005cacdc
- (id)messageBody;	// IMP=0x00000001005caacc
- (id)requiredKeys;	// IMP=0x00000001005caa4c
- (id)bagKey;	// IMP=0x00000001005caa30
- (long long)responseCommand;	// IMP=0x00000001005caa18
- (long long)command;	// IMP=0x00000001005caa00
- (double)anisetteHeadersTimeout;	// IMP=0x00000001005ca9e8
- (_Bool)wantsBinaryPush;	// IMP=0x00000001005ca9cc
- (_Bool)wantsCompressedBody;	// IMP=0x00000001005ca9b0
- (_Bool)wantsHTTPHeaders;	// IMP=0x00000001005ca994
- (_Bool)wantsBagKey;	// IMP=0x00000001005ca978
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001005ca668
- (id)init;	// IMP=0x00000001005ca50c
