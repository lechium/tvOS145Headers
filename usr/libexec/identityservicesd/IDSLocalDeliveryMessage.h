...
- (id)socketPairMessage;	// IMP=0x000000010026bd6c
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x000000010026bd08
- (void)kickProgressBlock;	// IMP=0x000000010026bb0c
- (id)init;	// IMP=0x000000010026b874
