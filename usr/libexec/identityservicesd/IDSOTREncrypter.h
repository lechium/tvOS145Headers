...
- (void).cxx_destruct;	// IMP=0x00000001003fed44
...
- (id)decryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x00000001003fe1a4
- (id)encryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x00000001003fd5b8
- (id)initWithOTRController:(id)arg1 OTRToken:(id)arg2;	// IMP=0x00000001003fd4b4
