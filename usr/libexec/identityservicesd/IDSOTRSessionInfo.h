...
- (void).cxx_destruct;	// IMP=0x000000010038b7e8
...
- (void)setNegotiationTimer;	// IMP=0x000000010038b324
- (void)_handleNegotiationTimeout;	// IMP=0x000000010038a9b0
- (void)removeNegotiationTimer;	// IMP=0x000000010038a75c
- (void)dealloc;	// IMP=0x000000010038a6e0
- (id)initWithToken:(id)arg1;	// IMP=0x000000010038a60c
