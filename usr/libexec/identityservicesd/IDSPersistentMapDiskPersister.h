...
- (void).cxx_destruct;	// IMP=0x00000001004a8354
...
- (void)purgeData;	// IMP=0x00000001004a7d98
- (void)saveData:(id)arg1;	// IMP=0x00000001004a6da0
- (id)data;	// IMP=0x00000001004a64c8
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4 fileDirectory:(id)arg5;	// IMP=0x00000001004a6254
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4;	// IMP=0x00000001004a6158
