...
- (void).cxx_destruct;	// IMP=0x0000000100387218
...
- (void)persistNumberOfPreflightAttempts:(unsigned int)arg1;	// IMP=0x00000001003869ec
- (unsigned int)loadNumberOfPreflightAttempts;	// IMP=0x00000001003869b8
- (void)persistNumberOfSuccessfulValidationSends:(unsigned int)arg1;	// IMP=0x000000010038697c
- (unsigned int)loadNumberOfSuccessfulValidationSends;	// IMP=0x0000000100386948
- (void)heartbeat;	// IMP=0x000000010038608c
- (void)removePhoneNumberValidationRequestor:(id)arg1;	// IMP=0x0000000100385e6c
- (id)identifyPhoneNumberForRequestor:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100385d68
- (void)addPhoneNumberValidationRequestor:(id)arg1;	// IMP=0x0000000100385bdc
- (void)removeListener:(id)arg1;	// IMP=0x0000000100385b78
- (void)addListener:(id)arg1;	// IMP=0x0000000100385ac8
- (void)timedOutWaitingForSMS;	// IMP=0x0000000100385518
- (void)resetSMSCounter;	// IMP=0x00000001003852f4
- (void)handleIncomingSMSForResponse:(id)arg1;	// IMP=0x00000001003846a8
- (void)handleRegistrationSMSSuccessfullyDeliveredWithTelephonyTimeout:(id)arg1;	// IMP=0x0000000100383ef4
- (void)handleRegistrationSMSDeliveryFailedWithShouldBypassRetry:(_Bool)arg1;	// IMP=0x0000000100383604
- (void)handleRegistrationSMSDeliveryFailed;	// IMP=0x00000001003835cc
- (void)_requestUserConsentForPhoneNumberValidationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100383478
- (void)_tryToSendSMSIdentification;	// IMP=0x0000000100382028
- (void)_sendPreflightVerificationWithIMSI:(id)arg1 PLMN:(id)arg2;	// IMP=0x0000000100381384
- (void)_performHighestPriorityPreflightVerification;	// IMP=0x000000010038131c
- (void)_popHighestPriorityPreflightVerification;	// IMP=0x000000010038125c
- (id)_getHighestPriorityMechanism;	// IMP=0x0000000100381174
- (void)_sendPreflightVerificationIfNeeded;	// IMP=0x0000000100380e84
- (void)_issueAsyncCoreTelephonyPhoneNumberValidationRequestWithPushToken:(id)arg1 mechanism:(id)arg2;	// IMP=0x0000000100380734
- (void)_sendSMSVerificationWithMechanism:(id)arg1;	// IMP=0x0000000100380228
- (void)_setSMSDeliveryTimeout:(double)arg1;	// IMP=0x000000010037ffd4
- (_Bool)_canDeliverSMSNow;	// IMP=0x000000010037ffac
- (void)_smsDeliveryClear;	// IMP=0x000000010037fd60
- (void)_clearSMSDeliveryTimeout;	// IMP=0x000000010037fd18
- (void)_keychainMigrationComplete:(id)arg1;	// IMP=0x000000010037fbc8
- (void)_SIMSetupDidComplete;	// IMP=0x000000010037fae8
- (void)systemRestoreStateDidChange;	// IMP=0x000000010037f9fc
- (void)systemDidStopBackup;	// IMP=0x000000010037f910
- (void)systemDidFinishMigration;	// IMP=0x000000010037f71c
- (void)PNRResponseReceivedWithResponseData:(id)arg1;	// IMP=0x000000010037f188
- (void)PNRRequestSentWithRequestData:(id)arg1;	// IMP=0x000000010037ed04
- (void)PNRReadyStateChanged:(_Bool)arg1;	// IMP=0x000000010037eb2c
- (void)_deviceIDChangedNotification:(id)arg1;	// IMP=0x000000010037e970
- (void)_registerForLockdownNotifications;	// IMP=0x000000010037e828
- (void)_lockdownStateChanged:(id)arg1;	// IMP=0x000000010037e640
- (_Bool)_validSIMStateForRegistration;	// IMP=0x000000010037e518
- (_Bool)_deviceCanRegisterPresently;	// IMP=0x000000010037e2bc
- (long long)_errorCodeForRegistrationError:(long long)arg1;	// IMP=0x000000010037e1fc
- (void)_failPromisesWithError:(long long)arg1;	// IMP=0x000000010037e00c
- (void)_fulfillPromisesWithPhoneNumber:(id)arg1 token:(id)arg2;	// IMP=0x000000010037de0c
- (void)_notifySuccess:(id)arg1;	// IMP=0x000000010037d4fc
- (void)_notifyFailureWithError:(long long)arg1;	// IMP=0x000000010037cc90
- (_Bool)_isAwaitingUserSelectionDuringSetup;	// IMP=0x000000010037c9f8
- (_Bool)_isUserSubscriptionSelectionStillPending;	// IMP=0x000000010037c7a4
- (_Bool)_userHasDisabledSMSRegistration;	// IMP=0x000000010037c478
- (long long)_registrationControlStatus;	// IMP=0x000000010037c408
@property(copy, nonatomic) IDSPreflightStack *currentPreflightStack;
- (void)_registerForDeviceCenterNotifications;	// IMP=0x000000010037c238
- (void)dealloc;	// IMP=0x000000010037c1e0
- (void)invalidate;	// IMP=0x000000010037c0a8
- (id)initWithCTPNR:(id)arg1 preflightStackStore:(id)arg2;	// IMP=0x000000010037be08
- (id)initWithCTPNR:(id)arg1 preflightStackStore:(id)arg2 HTTPDelivery:(id)arg3 pushHandler:(id)arg4 lockdownManager:(id)arg5 systemMonitor:(id)arg6 arbiter:(id)arg7 systemAccountAdapter:(id)arg8;	// IMP=0x000000010037b5f8
- (void)_cancelScheduledSMSTimeout;	// IMP=0x000000010037b55c
- (void)_scheduleSMSTimeout:(double)arg1;	// IMP=0x000000010037b388
- (void)_cancelScheduledHeartbeat;	// IMP=0x000000010037b2ec
- (void)_scheduleHeartbeat:(double)arg1;	// IMP=0x000000010037b090
@property(readonly, copy) NSString *description;
- (_Bool)_isPhoneNumberIdentificationSupported;	// IMP=0x000000010037adcc
