...
- (void).cxx_destruct;	// IMP=0x00000001005cdc3c
...
- (id)description;	// IMP=0x00000001005cdb1c
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x00000001005cda18
