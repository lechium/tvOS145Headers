...
- (void).cxx_destruct;	// IMP=0x00000001005ce988
...
- (void)requestUserConsentToValidatePhoneNumberForCTPNR:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001005ce870
- (id)authenticatePhoneUser;	// IMP=0x00000001005ce854
- (id)localPhoneAuthenticationCertificates;	// IMP=0x00000001005ce28c
- (id)phoneAuthenticationCertificateSigningRequestForUser:(id)arg1;	// IMP=0x00000001005ce19c
- (struct __SecKey *)phoneAuthenticationCertificatePrivateKey;	// IMP=0x00000001005ce114
- (struct __SecKey *)phoneAuthenticationCertificatePublicKey;	// IMP=0x00000001005ce08c
- (id)initWithQueue:(id)arg1 userStore:(id)arg2 server:(id)arg3 phoneNumberValidator:(id)arg4 deviceSupport:(id)arg5;	// IMP=0x00000001005cdef8
- (id)initWithQueue:(id)arg1 userStore:(id)arg2 deviceSupport:(id)arg3;	// IMP=0x00000001005cddc4
- (id)initWithQueue:(id)arg1 userStore:(id)arg2;	// IMP=0x00000001005cdc8c
