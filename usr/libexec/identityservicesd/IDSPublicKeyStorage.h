...
+ (id)sharedInstance;	// IMP=0x00000001002dbe00
- (void).cxx_destruct;	// IMP=0x00000001002dcde4
...
- (void)logState;	// IMP=0x00000001002dcc3c
- (id)publicDeviceIdentityContainerForDeviceID:(id)arg1;	// IMP=0x00000001002dc744
- (void)clearCache;	// IMP=0x00000001002dc654
- (void)dealloc;	// IMP=0x00000001002dc5f0
- (void)_removeOldPersistence;	// IMP=0x00000001002dc4d8
- (id)initWithPeerIDManager:(id)arg1 accountController:(id)arg2;	// IMP=0x00000001002dbfcc
- (id)init;	// IMP=0x00000001002dbef8
