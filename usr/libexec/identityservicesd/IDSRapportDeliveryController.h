...
+ (id)sharedInstance;	// IMP=0x0000000100151be8
- (void).cxx_destruct;	// IMP=0x00000001001535fc
...
- (void)rapportClient:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x00000001001532a4
- (unsigned int)_nextMessageID;	// IMP=0x0000000100153264
- (void)sendMessage:(id)arg1 messageID:(id)arg2 topic:(id)arg3 command:(id)arg4 destinationIDs:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000100151f70
- (void)dealloc;	// IMP=0x0000000100151f10
- (id)init;	// IMP=0x0000000100151e70
- (id)initWithRapportClient:(id)arg1;	// IMP=0x0000000100151d7c
