...
- (void).cxx_destruct;	// IMP=0x00000001005a5964
...
- (id)debugDescription;	// IMP=0x00000001005a1be4
- (id)description;	// IMP=0x00000001005a177c
- (id)_userStore;	// IMP=0x00000001005a16f4
- (id)_user;	// IMP=0x00000001005a1688
- (void)voidPassword;	// IMP=0x00000001005a135c
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x00000001005a1134
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010059ef70
...
- (id)_userID;	// IMP=0x000000010059d87c
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x000000010059d730
- (void)addCandidateEmail:(id)arg1;	// IMP=0x000000010059d634
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x000000010059d5b0
- (_Bool)removeFromKeychain;	// IMP=0x000000010059d548
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010059826c
- (id)init;	// IMP=0x00000001005981cc
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x00000001005980c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001005980ac
- (id)_keychain_comparisonValue;	// IMP=0x00000001002f0dd0
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x00000001002f0b38
