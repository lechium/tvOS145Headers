...
- (void).cxx_destruct;	// IMP=0x00000001002e9380
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00000001002e8d28
- (double)anisetteHeadersTimeout;	// IMP=0x00000001002e8d10
- (id)nonStandardMessageHeadersForOutgoingPush;	// IMP=0x00000001002e8cf4
- (id)messageBody;	// IMP=0x00000001002e87e4
- (id)requiredKeys;	// IMP=0x00000001002e8700
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x00000001002e86e4
- (id)bagKey;	// IMP=0x00000001002e86c8
- (_Bool)requiresPushTokenKeys;	// IMP=0x00000001002e86ac
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x00000001002e85c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002e81d4
