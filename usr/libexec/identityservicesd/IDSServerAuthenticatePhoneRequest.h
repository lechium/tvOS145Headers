...
- (void).cxx_destruct;	// IMP=0x0000000100029e14
...
- (id)initWithUser:(id)arg1 phoneSignature:(id)arg2 certificateSigningRequest:(id)arg3 pushToken:(id)arg4;	// IMP=0x0000000100029c40
