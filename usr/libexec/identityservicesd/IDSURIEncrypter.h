...
- (void).cxx_destruct;	// IMP=0x00000001000aa14c
...
- (void)decryptData:(id)arg1 usingIdentifier:(id)arg2 onQueue:(id)arg3 isRetry:(_Bool)arg4 replayKey:(id)arg5 withCompletion:(CDUnknownBlockType)arg6;	// IMP=0x00000001000a74f8
- (void)encryptData:(id)arg1 onQueue:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000a5c58
- (id)encryptData:(id)arg1 usedIdentifier:(id *)arg2 error:(id *)arg3;	// IMP=0x00000001000a5aa4
- (_Bool)_isReplayError:(id)arg1;	// IMP=0x00000001000a58ac
- (id)_lookupIdentityWithLastResortFallback:(_Bool *)arg1;	// IMP=0x00000001000a54f4
- (id)_lookupEndpoint;	// IMP=0x00000001000a5394
- (void)setupWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x00000001000a5258
- (id)initWithPeerIDManager:(id)arg1 fullDeviceIdentityContainerEncrypter:(id)arg2 rateLimiter:(id)arg3 replayCommitter:(id)arg4 publicIdentityCache:(id)arg5 avoidMainQueue:(_Bool)arg6;	// IMP=0x00000001000a5098
