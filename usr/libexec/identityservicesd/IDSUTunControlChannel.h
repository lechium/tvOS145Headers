...
- (void).cxx_destruct;	// IMP=0x00000001001acaa8
...
- (void)resumeOTRNegotiation;	// IMP=0x00000001001ac634
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x00000001001ac5a8
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00000001001abfec
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00000001001abcfc
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x00000001001ab358
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x00000001001aae88
- (void)_destroyFairplayDeviceSession;	// IMP=0x00000001001aae74
- (void)_destroyFairplayHostSession;	// IMP=0x00000001001aad6c
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x00000001001aac94
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x00000001001aa678
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x00000001001aa1cc
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x00000001001aa178
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x00000001001aa154
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x00000001001a9dcc
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x00000001001a9db0
- (void)dealloc;	// IMP=0x00000001001a9d58
- (void)invalidate;	// IMP=0x00000001001a9cec
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x00000001001a9c44
- (void)sendMessage:(id)arg1;	// IMP=0x00000001001a9b9c
- (void)_checkSendNewMessage;	// IMP=0x00000001001a808c
- (void)_clearChannel;	// IMP=0x00000001001a7ecc
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x00000001001a7e5c
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x00000001001a7c20
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x00000001001a7b58
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x00000001001a68b8
- (void)writeToConnection;	// IMP=0x00000001001a5ef8
- (void)readFromConnection;	// IMP=0x00000001001a3c18
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x00000001001a3850
- (void)simulateDecryptionFailure;	// IMP=0x00000001001a3778
- (void)_cleanupConnection;	// IMP=0x00000001001a36c0
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001a33cc
- (id)description;	// IMP=0x00000001001a3288
