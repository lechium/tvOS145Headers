...
- (void).cxx_destruct;	// IMP=0x0000000100151b14
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00000001001516a8
- (id)bagKey;	// IMP=0x000000010015168c
- (id)requiredKeys;	// IMP=0x0000000100151624
- (id)messageBody;	// IMP=0x000000010015144c
- (id)additionalMessageHeaders;	// IMP=0x00000001001512bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015103c
