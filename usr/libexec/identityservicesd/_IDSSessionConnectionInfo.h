...
- (void).cxx_destruct;	// IMP=0x00000001003a1258
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x00000001003a08f0
- (void)_addRemotePacketOutage;	// IMP=0x00000001003a084c
- (id)description;	// IMP=0x00000001003a06fc
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x00000001003a0608
