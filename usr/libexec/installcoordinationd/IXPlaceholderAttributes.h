...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000c9dc
- (void).cxx_destruct;	// IMP=0x000000010000e598
...
- (id)description;	// IMP=0x000000010000e400
- (id)infoPlistContent;	// IMP=0x000000010000e0c4
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x000000010000ded4
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x000000010000d840
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x000000010000d798
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000010000d6d8
- (id)_plistKeys;	// IMP=0x000000010000d624
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000d34c
- (unsigned long long)hash;	// IMP=0x000000010000d11c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000c9e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000c6d0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000c378
- (id)init;	// IMP=0x000000010000c344
