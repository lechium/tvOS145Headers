...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100026b74
- (void).cxx_destruct;	// IMP=0x0000000100026cfc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100026b7c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100026a0c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000268a0
