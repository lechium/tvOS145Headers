...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010002e5d4
- (void).cxx_destruct;	// IMP=0x000000010002e764
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010002e5dc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010002e43c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010002e2a8
