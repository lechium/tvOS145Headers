...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010002dce8
- (void).cxx_destruct;	// IMP=0x000000010002de24
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010002dcf0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010002dbec
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010002daf0
