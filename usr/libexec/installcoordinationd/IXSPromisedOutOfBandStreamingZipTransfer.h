...
- (unsigned long long)totalBytesForProgress;	// IMP=0x00000001000043b8
- (void)reset;	// IMP=0x0000000100004320
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000042ec
- (oneway void)_remote_setArchiveBytesConsumed:(unsigned long long)arg1;	// IMP=0x0000000100004430
