...
- (void).cxx_destruct;	// IMP=0x000000010005b120
@property(retain, nonatomic) FBSApplicationTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x000000010005b0ac
- (void)invalidate;	// IMP=0x000000010005b054
- (id)initWithBundleIdentifier:(id)arg1 reason:(unsigned char)arg2;	// IMP=0x000000010005ac54
