...
+ (_Bool)_validateStubSignature:(id)arg1 withSigningID:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100056dd8
+ (_Bool)_validateBundleExecutable:(id)arg1 againstStubAt:(id)arg2 trustedHashes:(id)arg3 sectionName:(id)arg4 signingIdentifier:(id)arg5 error:(id *)arg6;	// IMP=0x00000001000564ac
+ (_Bool)validateWatchKitV2StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100056240
+ (_Bool)validateWatchKitV1StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100055fd4
+ (id)_validateSignatureAndCopyInfoForURL:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100054a5c
+ (id)codeSigningVerifierForBundle:(id)arg1;	// IMP=0x0000000100054a08
- (void).cxx_destruct;	// IMP=0x0000000100057184
...
- (_Bool)performValidationWithError:(id *)arg1;	// IMP=0x0000000100054f04
- (id)_loadSystemDetachedSignatureForBundleID:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100054d6c
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000100054988
