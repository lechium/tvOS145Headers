...
- (void).cxx_destruct;	// IMP=0x0000000100018f6c
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x0000000100018cf0
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x0000000100018748
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x000000010001860c
