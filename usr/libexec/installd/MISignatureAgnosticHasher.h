...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x000000010005cc88
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x000000010005cc68
- (void).cxx_destruct;	// IMP=0x000000010005cd04
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x000000010005c3e0
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x000000010005b23c
- (void)dealloc;	// IMP=0x000000010005b1d8
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x000000010005b12c
