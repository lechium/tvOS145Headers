...
+ (id)infoWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000bfb4
- (void).cxx_destruct;	// IMP=0x000000010000c0a4
...
- (id)initWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000c014
