...
+ (id)queueEntryWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100012f70
- (void).cxx_destruct;	// IMP=0x00000001000132c4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100013230
- (_Bool)isEqualToTestQueueEntry:(id)arg1;	// IMP=0x0000000100013148
- (unsigned long long)hash;	// IMP=0x00000001000130d4
- (id)initWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100013000
