...
- (void).cxx_destruct;	// IMP=0x0000000100092ab8
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x00000001000926b4
- (void)cancel;	// IMP=0x0000000100092640
- (void)start;	// IMP=0x0000000100091f5c
- (id)description;	// IMP=0x0000000100091e88
- (void)callCompletionHandlers;	// IMP=0x0000000100091d28
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100091c80
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6;	// IMP=0x0000000100091b74
