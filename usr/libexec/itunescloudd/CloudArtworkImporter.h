...
- (void).cxx_destruct;	// IMP=0x00000001000befa4
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000bedb8
- (void)_adjustOperationQueueStatusForMediaDownloads;	// IMP=0x00000001000bec3c
- (void)downloadManager:(id)arg1 didCancelAssets:(id)arg2;	// IMP=0x00000001000bec30
- (void)downloadManager:(id)arg1 didFinishAsset:(id)arg2 withError:(id)arg3;	// IMP=0x00000001000bec24
- (void)downloadManager:(id)arg1 didUpdateDownloadProgress:(id)arg2;	// IMP=0x00000001000bec18
- (void)downloadManager:(id)arg1 didEnqueueAssetDownloads:(id)arg2 didRemoveAssetDownloads:(id)arg3;	// IMP=0x00000001000bec0c
- (void)cancelAllImports;	// IMP=0x00000001000bebfc
- (void)cancelAllImportsAndWaitForOperationsToFinish:(_Bool)arg1;	// IMP=0x00000001000beb40
- (void)increasePriorityForAllOperations;	// IMP=0x00000001000beac4
- (void)decreasePriorityForAllOperations;	// IMP=0x00000001000bea48
- (void)deprioritizeImportArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2;	// IMP=0x00000001000be9b8
- (void)importCloudArtworkForRequests:(id)arg1;	// IMP=0x00000001000be8fc
- (void)importArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2 token:(id)arg3 mediaType:(unsigned int)arg4 allowsCellularData:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000001000be778
- (void)dealloc;	// IMP=0x00000001000be620
- (id)initWithConfiguration:(id)arg1 sourceType:(long long)arg2;	// IMP=0x00000001000be0a4
- (id)initWithMusicLibrary:(id)arg1 sourceType:(long long)arg2;	// IMP=0x00000001000be014
