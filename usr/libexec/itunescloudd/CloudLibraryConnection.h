...
- (void).cxx_destruct;	// IMP=0x00000001000ac5d8
...
- (void)disconnect;	// IMP=0x00000001000ac524
- (void)connectWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000ac420
- (void)_onQueue_sendRequest:(id)arg1 withInternalResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000aad18
- (void)sendRequest:(id)arg1 withResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000aac34
@property(readonly, nonatomic) ICUserIdentityStore *userIdentityStore;
@property(readonly, nonatomic) ICUserIdentity *userIdentity;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00000001000aaaf4
