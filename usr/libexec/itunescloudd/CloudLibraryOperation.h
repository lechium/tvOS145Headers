...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100060ea0
- (void).cxx_destruct;	// IMP=0x0000000100060dfc
...
- (id)description;	// IMP=0x0000000100060cdc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100060c64
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100060bac
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0000000100060a6c
- (id)init;	// IMP=0x0000000100060a1c
