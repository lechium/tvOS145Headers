...
- (id)_createBag;	// IMP=0x0000000100032020
- (void)userNotificationCenter:(id)arg1 didReceiveNotificationResponse:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100031ef4
- (void)userNotificationCenter:(id)arg1 didChangeSettings:(id)arg2;	// IMP=0x0000000100031cf4
- (id)init;	// IMP=0x0000000100031b78
