...
- (void).cxx_destruct;	// IMP=0x00000001000c0d80
...
- (id)dictionaryRepresentation;	// IMP=0x00000001000c0cd0
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000001000c0c24
