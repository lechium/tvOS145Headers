...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x000000010007dbd4
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x000000010007db14
- (void).cxx_destruct;	// IMP=0x000000010007dac0
...
- (id)description;	// IMP=0x000000010007d9dc
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x000000010007d8ac
