...
- (void).cxx_destruct;	// IMP=0x000000010005048c
...
- (id)debugDescription;	// IMP=0x00000001000502cc
- (_Bool)isValid;	// IMP=0x00000001000502c4
- (id)initWithSong:(id)arg1;	// IMP=0x000000010004fedc
