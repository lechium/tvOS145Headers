...
- (void).cxx_destruct;	// IMP=0x0000000100098240
...
- (id)metadataFilter;	// IMP=0x00000001000981bc
- (id)queryFilter;	// IMP=0x0000000100098140
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x0000000100098120
- (void)main;	// IMP=0x0000000100097abc
