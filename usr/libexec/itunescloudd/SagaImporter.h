...
- (void).cxx_destruct;	// IMP=0x0000000100081e10
...
- (_Bool)_updateGlobalPlaylistsFromContainersPayloadAtPath:(id)arg1 downloadPathForSubscribedContainersPayload:(id)arg2;	// IMP=0x0000000100081b5c
- (void)_importLyricsWithLyricsTokenMap:(id)arg1;	// IMP=0x0000000100081a34
- (void)_removeUnavailableSubscriptionAssetsInLibrary:(id)arg1;	// IMP=0x00000001000819b0
- (void)importTracksFromRevision:(unsigned int)arg1 toRevision:(unsigned int)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100080350
- (void)cancel;	// IMP=0x0000000100080278
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000100080140
