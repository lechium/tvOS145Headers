...
- (void)main;	// IMP=0x000000010003115c
- (id)initWithConfiguration:(id)arg1 sagaID:(unsigned long long)arg2;	// IMP=0x000000010003110c
- (id)initWithSagaID:(unsigned long long)arg1;	// IMP=0x00000001000310ac
