...
- (void).cxx_destruct;	// IMP=0x00000001001e48bc
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00000001001e47b8
- (id)description;	// IMP=0x00000001001e4698
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00000001001e4570
