...
- (void)addRefreshed:(id)arg1;	// IMP=0x000000010011d104
- (void)addRevoked:(id)arg1;	// IMP=0x000000010011d0a8
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010011cfbc
- (void)dealloc;	// IMP=0x000000010011cf4c
