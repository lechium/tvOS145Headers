...
- (void).cxx_destruct;	// IMP=0x000000010007440c
- (_Bool)_updateTouchIDSettingsForAccount:(id)arg1;	// IMP=0x0000000100073d38
- (id)_authenticateWithAccount:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100072ee0
- (void)run;	// IMP=0x0000000100072a74
@property(copy) CDUnknownBlockType resultBlock;
@property _Bool requiresStoreAuthentication;
- (id)init;	// IMP=0x00000001000728ac
