...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001b8d50
- (void)_presentDialog:(id)arg1;	// IMP=0x00000001001b8cb8
- (void)dealloc;	// IMP=0x00000001001b8c68
