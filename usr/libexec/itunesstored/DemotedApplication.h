...
- (void).cxx_destruct;	// IMP=0x0000000100034648
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000344c4
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000100033f08
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000100033d40
