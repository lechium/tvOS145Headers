...
- (void)_setURLCredential:(id)arg1;	// IMP=0x0000000100195740
- (void)_setState:(long long)arg1;	// IMP=0x00000001001956e0
- (id)_openSession;	// IMP=0x0000000100195484
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x00000001001952b4
- (void)run;	// IMP=0x0000000100194e34
- (void)cancel;	// IMP=0x0000000100194da4
...
- (void)dealloc;	// IMP=0x0000000100194ba8
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x0000000100194b2c
