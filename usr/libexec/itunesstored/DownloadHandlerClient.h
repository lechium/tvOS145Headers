...
- (id)description;	// IMP=0x000000010002740c
...
- (id)resetDisavowedSessionProperties;	// IMP=0x0000000100026f40
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x0000000100026af8
- (void)dealloc;	// IMP=0x0000000100026a98
- (id)initWithInputConnection:(id)arg1;	// IMP=0x0000000100026a44
