...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010018d6f4
- (void)dealloc;	// IMP=0x000000010018d6a4
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x000000010018d644
