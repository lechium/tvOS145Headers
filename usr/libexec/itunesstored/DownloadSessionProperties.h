...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100027ba4
- (unsigned long long)hash;	// IMP=0x0000000100027b9c
- (id)description;	// IMP=0x0000000100027b24
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100027a5c
- (void)dealloc;	// IMP=0x00000001000279fc
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x000000010002798c
