...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x00000001000129ac
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x0000000100012108
- (id)_cachePath;	// IMP=0x0000000100012068
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x0000000100011e70
- (void)run;	// IMP=0x00000001000118dc
- (void)dealloc;	// IMP=0x000000010001186c
