...
+ (id)defaultProperties;	// IMP=0x0000000100082610
+ (Class)databaseEntityClass;	// IMP=0x0000000100082604
- (void).cxx_destruct;	// IMP=0x0000000100082914
...
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x0000000100082330
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x0000000100081b84
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x0000000100081640
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x0000000100081060
