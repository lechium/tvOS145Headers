...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x00000001001058a0
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x0000000100107008
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x0000000100106e9c
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00000001001064f8
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100105708
- (void)dealloc;	// IMP=0x0000000100105690
- (id)init;	// IMP=0x0000000100105634
