...
- (_Bool)_loadPaymentsWithExpectedCount:(long long)arg1 error:(id *)arg2;	// IMP=0x000000010008cd04
- (_Bool)_getQueueCount:(long long *)arg1 error:(id *)arg2;	// IMP=0x000000010008cbf0
- (void)run;	// IMP=0x000000010008cafc
- (void)dealloc;	// IMP=0x000000010008ca6c
