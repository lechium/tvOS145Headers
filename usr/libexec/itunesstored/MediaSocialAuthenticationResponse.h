...
- (void).cxx_destruct;	// IMP=0x00000001000df768
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000df684
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00000001000df62c
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00000001000df5d4
- (id)init;	// IMP=0x00000001000df558
