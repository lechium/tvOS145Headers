...
- (void).cxx_destruct;	// IMP=0x00000001001a3678
@property(nonatomic) long long postID; // @synthesize postID=_postID;
- (id)_targetDictionaryWithContentItem:(id)arg1;	// IMP=0x00000001001a3574
- (id)_requestBodyDictionary;	// IMP=0x00000001001a2f2c
- (id)_externalServiceDictionaryWithDestination:(id)arg1;	// IMP=0x00000001001a2d64
- (id)_attachmentDictionaryWithAttachment:(id)arg1;	// IMP=0x00000001001a275c
- (void)run;	// IMP=0x00000001001a1a1c
@property(copy) NSString *userAgent;
@property(copy) CDUnknownBlockType resultBlock;
- (id)initWithPostEntity:(id)arg1;	// IMP=0x00000001001a142c
- (id)initWithPostDescription:(id)arg1;	// IMP=0x00000001001a1250
