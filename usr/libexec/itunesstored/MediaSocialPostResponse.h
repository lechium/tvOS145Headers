...
+ (id)_unrecoverableErrors;	// IMP=0x0000000100157414
- (void).cxx_destruct;	// IMP=0x0000000100157534
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x000000010015738c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001572d0
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x0000000100156eac
