...
- (void).cxx_destruct;	// IMP=0x00000001001880c4
- (id)_requestURL;	// IMP=0x0000000100187f6c
- (void)main;	// IMP=0x0000000100187648
@property(readonly, copy) NSArray *statusPollRequests;
@property(copy) CDUnknownBlockType responseBlock;
- (id)initWithStatusPollRequests:(id)arg1;	// IMP=0x0000000100187474
