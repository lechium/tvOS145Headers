...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x0000000100041190
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x0000000100041148
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x0000000100042538
- (id)_temporaryIdentifier;	// IMP=0x00000001000424d8
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x000000010004247c
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x00000001000423f8
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x0000000100041f88
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x0000000100041e8c
- (void)setFailedWithError:(id)arg1;	// IMP=0x0000000100041da8
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x000000010004198c
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x0000000100041778
- (id)copyPaymentTransaction;	// IMP=0x00000001000411f0
- (void)dealloc;	// IMP=0x00000001000410f4
