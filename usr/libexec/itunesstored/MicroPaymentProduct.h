...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x0000000100066ebc
...
- (id)copyProduct;	// IMP=0x0000000100066ad8
- (void)dealloc;	// IMP=0x0000000100066a48
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001000663e4
