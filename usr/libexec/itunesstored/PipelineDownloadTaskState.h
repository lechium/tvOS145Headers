...
- (void).cxx_destruct;	// IMP=0x0000000100035f20
...
- (id)_overallProgress;	// IMP=0x0000000100035df8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100035ce8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100035c5c
- (unsigned long long)hash;	// IMP=0x0000000100035c54
- (void)setTransferProgressWithBytesWritten:(long long)arg1 totalBytesExpected:(long long)arg2;	// IMP=0x0000000100035c2c
- (void)setTransferProgress:(double)arg1;	// IMP=0x0000000100035bc0
- (void)setFinishProgress:(double)arg1;	// IMP=0x0000000100035b48
@property(readonly, nonatomic) SSOperationProgress *overallProgress;
- (id)initWithPrepareDownloadResponse:(id)arg1;	// IMP=0x0000000100035958
