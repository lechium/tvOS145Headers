...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000a1ca8
- (void)run;	// IMP=0x00000001000a178c
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x00000001000a161c
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x00000001000a158c
- (id)init;	// IMP=0x00000001000a1578
