...
- (void).cxx_destruct;	// IMP=0x000000010017ff80
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x000000010017f538
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x000000010017ef44
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1;	// IMP=0x000000010017eb80
- (id)sessionConfiguration;	// IMP=0x000000010017e9a0
