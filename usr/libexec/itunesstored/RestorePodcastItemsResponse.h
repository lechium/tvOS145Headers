...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00000001001a61c0
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00000001001a619c
- (void)dealloc;	// IMP=0x00000001001a613c
