...
+ (id)entityFromContext:(id)arg1;	// IMP=0x000000010006bad0
- (void)_assignToContact:(id)arg1 inContactStore:(id)arg2 withSoundIdentifier:(id)arg3;	// IMP=0x000000010006bf04
- (void)_assignToPersonWithID:(int)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010006be94
- (void)_assignToContactWithID:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010006bd8c
- (void)loadFromPurchase:(id)arg1;	// IMP=0x000000010006bc48
- (void)applyUserActionWithToneIdentifier:(id)arg1;	// IMP=0x000000010006bb18
