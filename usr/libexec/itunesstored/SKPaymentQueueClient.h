...
- (void).cxx_destruct;	// IMP=0x00000001000a5f40
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000a5d58
- (id)copyXPCEncoding;	// IMP=0x00000001000a5c4c
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000001000a5a44
