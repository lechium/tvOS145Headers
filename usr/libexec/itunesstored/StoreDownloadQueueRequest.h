...
+ (void)initialize;	// IMP=0x00000001000bc5b0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bc50c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000bc3c4
- (unsigned long long)hash;	// IMP=0x00000001000bc3b4
- (id)description;	// IMP=0x00000001000bc344
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00000001000bc28c
