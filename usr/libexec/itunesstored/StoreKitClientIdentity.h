...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x00000001001b0934
+ (void)initialize;	// IMP=0x00000001001b08f8
...
- (id)description;	// IMP=0x00000001001b1168
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001b1054
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x00000001001b0d94
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x00000001001b0b7c
- (void)dealloc;	// IMP=0x00000001001b0b04
