...
- (void).cxx_destruct;	// IMP=0x000000010000e534
- (id)_loadStatusOnce:(id *)arg1;	// IMP=0x000000010000e154
- (id)_getInitialStatus:(id *)arg1;	// IMP=0x000000010000de5c
- (_Bool)_carrierBundleStatusIsValidForCachedStatus:(id)arg1;	// IMP=0x000000010000dd60
- (void)_cacheAccountEligibilityWithStatus:(id)arg1;	// IMP=0x000000010000da40
- (void)run;	// IMP=0x000000010000cf58
