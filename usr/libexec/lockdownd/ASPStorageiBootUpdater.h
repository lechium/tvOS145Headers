...
- (void)dealloc;	// IMP=0x000000010002df70
- (_Bool)updateBootFirmwareWithCallback:(struct ramrod_update_callbacks *)arg1 context:(struct firmware_update_context *)arg2 error:(id *)arg3;	// IMP=0x000000010002df60
- (_Bool)updateBootFirmwareWithError:(id *)arg1;	// IMP=0x000000010002d7d8
- (id)initWithApNonce:(id)arg1;	// IMP=0x000000010002d734
