...
+ (id)assetWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x0000000100014680
- (void).cxx_destruct;	// IMP=0x000000010001482c
...
- (_Bool)isDegraded;	// IMP=0x00000001000147d0
- (_Bool)isDeletePending;	// IMP=0x00000001000147c4
- (void)updateLocalIdentifier:(id)arg1;	// IMP=0x00000001000147b8
- (id)initWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x00000001000144d4
