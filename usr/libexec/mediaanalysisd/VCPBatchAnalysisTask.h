...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x0000000100037638
- (void).cxx_destruct;	// IMP=0x0000000100038350
...
- (int)mainInternal;	// IMP=0x0000000100037cf8
- (_Bool)containsAsset:(id)arg1;	// IMP=0x0000000100037adc
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x0000000100037a3c
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x00000001000376a4
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0000000100037558
