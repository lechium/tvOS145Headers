...
+ (id)clientHandlerWithXPCConnection:(id)arg1;	// IMP=0x0000000100076c94
- (void).cxx_destruct;	// IMP=0x00000001000773d4
- (void)requestAnalysis:(unsigned long long)arg1 ofIOSurface:(id)arg2 withProperties:(id)arg3 withReply:(CDUnknownBlockType)arg4;	// IMP=0x0000000100076d00
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x0000000100076768
- (id)init;	// IMP=0x0000000100076750
