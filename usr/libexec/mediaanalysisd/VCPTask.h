...
- (void).cxx_destruct;	// IMP=0x000000010007423c
...
- (void)main;	// IMP=0x00000001000741a0
- (int)mainInternal;	// IMP=0x0000000100074198
- (_Bool)isCancelled;	// IMP=0x0000000100074134
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x000000010007406c
- (id)init;	// IMP=0x0000000100074054
