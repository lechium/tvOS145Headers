...
- (id)_createSQLiteErrorWithCode:(int)arg1 description:(id)arg2;	// IMP=0x0000000100015bbc
- (void)main;	// IMP=0x0000000100015424
- (id)initWithDatabasePath:(id)arg1 repairFaults:(_Bool)arg2;	// IMP=0x0000000100015384
