...
- (void).cxx_destruct;	// IMP=0x0000000100096c84
...
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4 usingDebugDescription:(_Bool)arg5;	// IMP=0x00000001000966a8
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4;	// IMP=0x0000000100096698
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x0000000100096684
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 usingDebugDescription:(_Bool)arg4;	// IMP=0x00000001000965bc
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x00000001000965ac
- (void)_appendSubheader:(id)arg1 toString:(id)arg2;	// IMP=0x0000000100096578
- (id)createDiagnosticInfo;	// IMP=0x0000000100095a04
- (id)init;	// IMP=0x00000001000959a0
