...
- (void).cxx_destruct;	// IMP=0x00000001000b2888
...
- (void)dealloc;	// IMP=0x00000001000b27d8
- (void)scheduleLayoutChangeForReason:(id)arg1;	// IMP=0x00000001000b2590
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x00000001000b22f0
@property(readonly, nonatomic) _Bool lockScreenVisible;
- (id)_fbsDisplayMonitorConfiguration;	// IMP=0x00000001000b2060
- (id)init;	// IMP=0x00000001000b1dc4
