...
- (void).cxx_destruct;	// IMP=0x00000001000bae0c
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00000001000bad60
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bad20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bace8
