...
- (void)cancel;	// IMP=0x00000001000b6fc0
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x00000001000b6fb0
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x00000001000b6eb8
