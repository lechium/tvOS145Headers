...
- (void).cxx_destruct;	// IMP=0x00000001000160a8
- (void)dispatchHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000100016000
- (void)dealloc;	// IMP=0x0000000100015fb0
- (id)init;	// IMP=0x0000000100015ef0
