...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100014250
...
- (_Bool)adjustVolumeWithStepAmount:(float)arg1 error:(id *)arg2;	// IMP=0x0000000100014350
- (_Bool)setVolume:(float)arg1 error:(id *)arg2;	// IMP=0x0000000100014348
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x00000001000142d0
