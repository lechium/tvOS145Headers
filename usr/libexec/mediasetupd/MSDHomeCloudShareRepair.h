...
+ (id)repairTokenForUser:(id)arg1;	// IMP=0x000000010001ac34
- (void).cxx_destruct;	// IMP=0x000000010001af50
...
- (void)performRepairRequest:(CDUnknownBlockType)arg1;	// IMP=0x000000010001adac
- (id)initWithUser:(id)arg1 repairInfo:(id)arg2 containerID:(id)arg3;	// IMP=0x000000010001acdc
