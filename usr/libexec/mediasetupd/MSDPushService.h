...
+ (id)sharedService;	// IMP=0x0000000100033a74
- (void).cxx_destruct;	// IMP=0x0000000100034594
...
- (void)connection:(id)arg1 didChangeConnectedStatus:(_Bool)arg2;	// IMP=0x000000010003446c
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x0000000100034210
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x0000000100034128
- (id)_determinePushEnvironment;	// IMP=0x000000010003403c
- (void)_statConnectionWithEnvironment:(id)arg1;	// IMP=0x0000000100033b6c
- (void)dealloc;	// IMP=0x0000000100033b10
- (id)init;	// IMP=0x0000000100033988
