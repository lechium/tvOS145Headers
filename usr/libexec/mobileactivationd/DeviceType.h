...
{
    _Bool _device_supports_dcrt_oob;	// 8 = 0x8
    _Bool _is_prodfused_demoted;	// 9 = 0x9
    _Bool _is_devfused_undemoted;	// 10 = 0xa
    _Bool _is_dev_board;	// 11 = 0xb
    _Bool _is_fpga;	// 12 = 0xc
    _Bool _is_ipod;	// 13 = 0xd
    _Bool _is_ipad;	// 14 = 0xe
    _Bool _is_audio_accessory;	// 15 = 0xf
    _Bool _has_telephony;	// 16 = 0x10
    _Bool _should_hactivate;	// 17 = 0x11
    _Bool _is_internal_build;	// 18 = 0x12
    _Bool _has_internal_diagnostics;	// 19 = 0x13
    NSString *_product_type;	// 24 = 0x18
    NSString *_device_class;	// 32 = 0x20
    NSString *_hardware_model;	// 40 = 0x28
}

+ (id)sharedInstance;	// IMP=0x0000000100015574
- (void).cxx_destruct;	// IMP=0x00000001000161a0
...
- (_Bool)runningInRAMDisk;	// IMP=0x0000000100016064
- (id)copyDeviceTreeInt:(id)arg1 key:(id)arg2 defaultValue:(int)arg3;	// IMP=0x0000000100015f14
- (id)copyBootArgs;	// IMP=0x0000000100015e70
- (id)copyBootSessionUUID;	// IMP=0x0000000100015dc0
- (id)copyDeviceTreeProperty:(id)arg1 key:(id)arg2;	// IMP=0x0000000100015d20
- (id)init;	// IMP=0x00000001000155e0
