...
- (void)issueDCRT:(NSDictionary *)arg1 withCompletionBlock:(void (^)(NSDictionary *, NSError *))arg2;
- (void)copyDCRTWithCompletionBlock:(void (^)(NSDictionary *, NSError *))arg1;
- (void)getDCRTStateWithCompletionBlock:(void (^)(NSDictionary *, NSError *))arg1;
