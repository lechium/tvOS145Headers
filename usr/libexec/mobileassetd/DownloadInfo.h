...
- (id)description;	// IMP=0x0000000100012bc8
- (id)_taskState;	// IMP=0x0000000100012af8
- (void)clearCacheServerUrl;	// IMP=0x0000000100012ad0
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x0000000100012ab8
- (double)currentEstimate;	// IMP=0x0000000100012928
- (void)updateDownloadData:(long long)arg1;	// IMP=0x0000000100012868
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x0000000100012704
- (void)dealloc;	// IMP=0x000000010001266c
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000100012478
- (id)initWithUrl:(id)arg1 options:(id)arg2;	// IMP=0x00000001000123c0
