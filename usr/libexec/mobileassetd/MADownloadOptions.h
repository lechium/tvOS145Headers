...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000ed70
...
- (void)logOptions;	// IMP=0x000000010000f4c4
- (id)description;	// IMP=0x000000010000f388
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000f140
- (void)dealloc;	// IMP=0x000000010000f0f0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000edd8
- (id)init;	// IMP=0x000000010000ed78
