...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100008040
...
- (id)description;	// IMP=0x00000001000086fc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100008468
- (void)dealloc;	// IMP=0x00000001000083b8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100008104
- (id)init;	// IMP=0x0000000100008048
