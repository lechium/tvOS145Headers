...
- (_Bool)verifyResponse:(id)arg1 signature:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100003f28
- (_Bool)verifyCerts:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100003b78
- (_Bool)determineAlg:(id)arg1;	// IMP=0x0000000100003af8
