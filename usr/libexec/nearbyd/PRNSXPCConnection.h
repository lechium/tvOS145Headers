...
- (void).cxx_destruct;	// IMP=0x00000001001bdec0
...
- (void)invalidate;	// IMP=0x00000001001bde2c
- (void)actOnRemoteObjectAndScheduleBarrierBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001001bda94
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001001bd9f4
