...
- (void).cxx_destruct;	// IMP=0x0000000100089310
...
- (void)setPowerState:(long long)arg1;	// IMP=0x0000000100088f9c
- (void)stop;	// IMP=0x0000000100088f14
- (_Bool)start;	// IMP=0x0000000100088cb0
- (void)setReadyToSleep;	// IMP=0x0000000100088abc
- (_Bool)sleepPending;	// IMP=0x0000000100088a80
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x00000001000889d8
