...
+ (id)sharedServer;	// IMP=0x00000001000469e0
- (void).cxx_destruct;	// IMP=0x000000010005434c
...
- (void)handleFallbackEnabled:(_Bool)arg1;	// IMP=0x0000000100053ba0
- (void)handleSessionStopped:(id)arg1;	// IMP=0x0000000100053b30
- (void)copySessionsWithProviderIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100053778
- (_Bool)removeFallbackInterface:(unsigned long long)arg1 predictedInterfaceIndex:(unsigned long long)arg2;	// IMP=0x0000000100053224
- (_Bool)addFallbackInterface:(unsigned long long)arg1 predictedInterfaceIndex:(unsigned long long)arg2;	// IMP=0x0000000100052d20
- (_Bool)shouldSetDropAll;	// IMP=0x0000000100052c80
- (void)registerForAppsChangedNotifications;	// IMP=0x000000010005290c
- (void)deregisterForCaptiveNetworkPluginChanges;	// IMP=0x0000000100052908
- (void)registerForCaptiveNetworkPluginChanges;	// IMP=0x00000001000524bc
- (void)handleNetworkDetectionEvent:(id)arg1;	// IMP=0x0000000100051a84
- (void)notifySessionForConfiguration:(id)arg1 sessionType:(int)arg2 notifyType:(int)arg3;	// IMP=0x0000000100051868
- (void)applyLayer2DefaultDrop:(unsigned char)arg1;	// IMP=0x000000010005173c
- (void)applyIPDefaultDropByFeature:(struct __CFString *)arg1 featureEnabled:(unsigned char)arg2;	// IMP=0x000000010005155c
- (long long)applyIPDefaultDrop:(_Bool)arg1 minDropType:(long long)arg2;	// IMP=0x0000000100050ff4
- (void)registerForNetworkDetectionEvents;	// IMP=0x0000000100050f58
- (void)postCurrentInfo;	// IMP=0x0000000100050e2c
- (void)adjustActiveSessionCount:(long long)arg1;	// IMP=0x0000000100050be0
- (void)deregisterForNetworkConfigurationChangeEvents;	// IMP=0x0000000100050b5c
- (void)registerForNetworkConfigurationChangeEvents;	// IMP=0x0000000100050540
- (void)requestUninstallForSession:(id)arg1;	// IMP=0x0000000100050184
- (void)requestInstallForSession:(id)arg1 withParentSession:(id)arg2 exclusive:(_Bool)arg3;	// IMP=0x000000010004f99c
- (void)deregisterSession:(id)arg1;	// IMP=0x000000010004f448
- (void)registerSession:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010004d4a8
- (void)dealloc;	// IMP=0x000000010004d43c
- (void)deregisterForUserEvents;	// IMP=0x000000010004d340
- (void)registerForUserEvents;	// IMP=0x000000010004cf34
- (void)deregisterForPowerEvents;	// IMP=0x000000010004ce68
- (void)registerForPowerEvents;	// IMP=0x000000010004cd54
- (void)deregisterForInterfaceEvents;	// IMP=0x000000010004cb60
- (void)registerForInterfaceEvents;	// IMP=0x000000010004c794
- (void)prohibitVPNOnParameters:(id)arg1;	// IMP=0x000000010004c710
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010004b888
- (void)snapshotNetworksChanged:(_Bool)arg1;	// IMP=0x000000010004b5ec
- (void)satisfyCellularPathForSession:(id)arg1;	// IMP=0x000000010004b3b8
- (void)satisfyPathForSession:(id)arg1;	// IMP=0x000000010004b184
- (id)copyInterfaceInfoFromNWIState:(struct _nwi_state *)arg1;	// IMP=0x000000010004af5c
- (void)processInterfaceChanges:(id)arg1;	// IMP=0x000000010004a2d4
- (void)ackSleep;	// IMP=0x000000010004a114
- (void)handleWakeup;	// IMP=0x0000000100049eb4
- (void)handleSleepTime:(double)arg1;	// IMP=0x0000000100049c44
- (_Bool)handleSleep;	// IMP=0x0000000100049974
- (_Bool)canSleep;	// IMP=0x00000001000496fc
- (void)handleAgentClientConnection:(id)arg1 initialMessage:(id)arg2;	// IMP=0x00000001000493cc
- (void)addSessionClientWithConnection:(id)arg1 initialMessage:(id)arg2;	// IMP=0x000000010004911c
- (void)addPendingSessionRequestForConfigurationIdentifier:(id)arg1 sessionType:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100048cd8
- (void)addPendingSessionRequestOnQueueForConfigurationIdentifier:(id)arg1 sessionType:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100048bc8
- (void)removeSessionWithType:(int)arg1 andConfigurationIdentifier:(id)arg2;	// IMP=0x00000001000488b4
- (void)loadSessionWithType:(int)arg1 andConfigurationIdentifier:(id)arg2;	// IMP=0x0000000100048328
- (void)setupFileHandles;	// IMP=0x0000000100047bac
- (void)loadPendingSessions;	// IMP=0x00000001000478ec
- (void)acceptNewContentFilterConnection:(id)arg1;	// IMP=0x00000001000476b8
- (void)acceptNewConnection:(id)arg1;	// IMP=0x0000000100047234
- (void)stopWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100046de8
- (void)start;	// IMP=0x0000000100046a58
- (id)initPrivate;	// IMP=0x0000000100045f6c
- (id)init;	// IMP=0x0000000100045f44
