...
- (void).cxx_destruct;	// IMP=0x000000010000bb60
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000b9e4
- (unsigned long long)hash;	// IMP=0x000000010000b938
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000b804
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000b700
- (void)copyTo:(id)arg1;	// IMP=0x000000010000b648
- (void)writeTo:(id)arg1;	// IMP=0x000000010000b5a0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000b28c
- (id)dictionaryRepresentation;	// IMP=0x000000010000b10c
- (id)description;	// IMP=0x000000010000b058
