...
- (void).cxx_destruct;	// IMP=0x0000000100041bb8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100041a80
- (unsigned long long)hash;	// IMP=0x00000001000419d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000418ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000417b0
- (void)copyTo:(id)arg1;	// IMP=0x00000001000416e4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100041620
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010004121c
- (id)dictionaryRepresentation;	// IMP=0x0000000100041078
- (id)description;	// IMP=0x0000000100040fc4
