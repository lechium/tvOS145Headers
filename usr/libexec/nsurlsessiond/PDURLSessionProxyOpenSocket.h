...
- (void).cxx_destruct;	// IMP=0x0000000100006030
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100005ee4
- (unsigned long long)hash;	// IMP=0x0000000100005e38
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100005d04
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100005c00
- (void)copyTo:(id)arg1;	// IMP=0x0000000100005b48
- (void)writeTo:(id)arg1;	// IMP=0x0000000100005aa0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000057a8
- (id)dictionaryRepresentation;	// IMP=0x0000000100005670
- (id)description;	// IMP=0x00000001000055bc
