...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100051610
- (void).cxx_destruct;	// IMP=0x0000000100051604
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000514a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000513b4
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x00000001000512d0
