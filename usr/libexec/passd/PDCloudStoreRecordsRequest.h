...
- (void).cxx_destruct;	// IMP=0x00000001001c30d8
...
- (id)description;	// IMP=0x00000001001c2c24
- (void)callCompletionsWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x00000001001c2ab8
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001001c2a70
- (id)initWithRequestType:(unsigned long long)arg1 storeChanges:(_Bool)arg2 returnRecords:(_Bool)arg3 qualityOfService:(long long)arg4 groupName:(id)arg5 groupNameSuffix:(id)arg6;	// IMP=0x00000001001c2984
