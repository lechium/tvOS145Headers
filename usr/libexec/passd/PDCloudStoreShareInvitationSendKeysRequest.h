...
@interface PDCloudStoreShareInvitationSendKeysRequest : PDCloudStoreShareInvitationRequest
{
    PKCloudStoreZoneInvitation *_invitation;	// 48 = 0x30
    NSString *_recipientHandle;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x00000001000f0308
...
- (id)description;	// IMP=0x00000001000f017c
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00000001000effcc
- (id)initWithInvitation:(id)arg1 recipientHandle:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000eff0c
