...
- (void).cxx_destruct;	// IMP=0x0000000100189050
...
- (id)description;	// IMP=0x0000000100188d14
- (_Bool)shouldReceiveNotificationsForPeerPaymentNotificationType:(unsigned long long)arg1;	// IMP=0x0000000100188c70
- (id)passUniqueIdentifier;	// IMP=0x0000000100188c60
