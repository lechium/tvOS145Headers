...
- (void).cxx_destruct;	// IMP=0x000000010017e0ac
...
- (void)sendEvent:(id)arg1;	// IMP=0x000000010017dcd4
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x000000010017d944
- (id)initWithStreamName:(id)arg1;	// IMP=0x000000010017d61c
