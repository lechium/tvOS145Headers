...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x000000010005a664
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005a5a4
- (void)dealloc;	// IMP=0x000000010005a544
