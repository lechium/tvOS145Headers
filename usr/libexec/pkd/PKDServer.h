...
+ (id)server;	// IMP=0x00000001000036d4
- (void).cxx_destruct;	// IMP=0x0000000100004c80
...
- (void)stop;	// IMP=0x00000001000048ec
- (void)unholdClient:(id)arg1;	// IMP=0x000000010000458c
- (void)unholdToken:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0000000100004284
- (void)addHold:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0000000100004174
- (id)holdOnPlugIn:(id)arg1;	// IMP=0x0000000100003e44
- (void)terminatePlugIns:(id)arg1 synchronously:(_Bool)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0000000100003820
- (void)removedPlugIns:(id)arg1;	// IMP=0x0000000100003730
- (void)run;	// IMP=0x00000001000036e0
- (id)initForService:(const char *)arg1 database:(const char *)arg2;	// IMP=0x000000010000320c
