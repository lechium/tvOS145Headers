...
+ (void)clearAllLogs;	// IMP=0x00000001000069d4
+ (void)updateMobileAssetMetadataWithXPCActivity:(id)arg1;	// IMP=0x000000010000684c
...
- (void)service:(id)arg1 account:(id)arg2 incomingResourceAtURL:(id)arg3 fromID:(id)arg4 context:(id)arg5;	// IMP=0x0000000100006314
- (void)_uploadToParsecWithUpload:(id)arg1;	// IMP=0x0000000100005e6c
- (_Bool)_writeUploadForTransparency:(id)arg1;	// IMP=0x00000001000059b8
- (void)uploadToParsec;	// IMP=0x0000000100005910
- (id)init;	// IMP=0x00000001000056e0
