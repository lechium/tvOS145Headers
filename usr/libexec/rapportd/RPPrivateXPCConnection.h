...
- (void).cxx_destruct;	// IMP=0x0000000100051ef4
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100051d70
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100051c48
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100051b30
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100051a08
- (void)xpcConnectionInvalidated;	// IMP=0x0000000100051880
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x0000000100051740
