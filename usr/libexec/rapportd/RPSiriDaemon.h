...
- (void).cxx_destruct;	// IMP=0x0000000100052c8c
@property(retain, nonatomic) id <RPMessageable> messenger; // @synthesize messenger=_messenger;
- (void)_handleSiriStop:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100052a1c
- (void)_handleSiriStart:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100052438
- (void)_handleSiriAudio:(id)arg1;	// IMP=0x00000001000523a0
- (void)invalidate;	// IMP=0x00000001000522b0
- (_Bool)activateAndReturnError:(id *)arg1;	// IMP=0x0000000100051fb0
- (id)init;	// IMP=0x0000000100051f48
