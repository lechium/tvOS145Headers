...
- (void).cxx_destruct;	// IMP=0x0000000100004cf4
...
- (void)dealloc;	// IMP=0x0000000100004b84
- (void)cancel;	// IMP=0x0000000100004b34
- (id)copyServiceDescription;	// IMP=0x0000000100004a08
- (id)initWithService:(id)arg1 forDevice:(id)arg2 withPort:(char *)arg3 onSocket:(int)arg4;	// IMP=0x00000001000045d4
