...
- (void).cxx_destruct;	// IMP=0x00000001000169f4
...
- (void)dealloc;	// IMP=0x0000000100016808
- (void)updateOnLinkActive;	// IMP=0x0000000100016188
- (id)initWithService:(unsigned int)arg1 notification:(struct IONotificationPort *)arg2 queue:(id)arg3 callback:(CDUnknownFunctionPointerType)arg4;	// IMP=0x0000000100015f80
