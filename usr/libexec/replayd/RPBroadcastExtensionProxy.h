...
- (void)processPayload:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000cb90
- (void)finishBroadcastWithError:(id)arg1;	// IMP=0x000000010000ca94
- (void)ping;	// IMP=0x000000010000c9b8
- (void)updateBroadcastURL:(id)arg1;	// IMP=0x000000010000c8c8
- (void)updateServiceInfo:(id)arg1;	// IMP=0x000000010000c7d8
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000c7b4
- (void)setupNewConnection:(id)arg1;	// IMP=0x000000010000c4ac
- (void)invalidateConnection;	// IMP=0x000000010000c2f4
- (void)establishConnectionWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010000bdf8
- (id)initWithBroadcastUploadListenerEndpoint:(id)arg1;	// IMP=0x000000010000bc9c
- (id)initWithBroadcastUploadExtension:(id)arg1;	// IMP=0x000000010000bad8
