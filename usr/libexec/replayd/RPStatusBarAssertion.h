...
- (void).cxx_destruct;	// IMP=0x000000010001616c
...
- (void)statusBarCoordinator:(id)arg1 invalidatedRegistrationWithError:(id)arg2;	// IMP=0x0000000100016004
- (void)updateStatusStringWithTimer:(id)arg1;	// IMP=0x0000000100016000
- (void)updateDoubleHeightStatusBarWithDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100015ffc
- (id)rpLocalizedRecordingDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100015ef8
- (id)stringWithTimeInterval:(double)arg1;	// IMP=0x0000000100015e0c
- (void)invalidateDoubleHeightStatusBar;	// IMP=0x0000000100015e08
- (void)startRepeatingTimer;	// IMP=0x0000000100015d0c
- (void)showDoubleHeightStatusBarWithPid:(int)arg1;	// IMP=0x0000000100015d08
- (void)acquireAssertionWithPid:(int)arg1;	// IMP=0x0000000100015cac
- (void)acquireAssertionWithPidWaitForCompletion:(int)arg1;	// IMP=0x0000000100015ca8
