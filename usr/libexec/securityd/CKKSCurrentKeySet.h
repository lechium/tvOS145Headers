...
+ (id)loadForZone:(id)arg1;	// IMP=0x00000001000947f4
- (void).cxx_destruct;	// IMP=0x0000000100094764
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x0000000100094408
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010009416c
- (id)description;	// IMP=0x0000000100093ee8
- (id)initForZoneName:(id)arg1;	// IMP=0x0000000100093e70
