...
- (void).cxx_destruct;	// IMP=0x00000001000b1210
...
- (void)cancel;	// IMP=0x00000001000b0f60
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00000001000b09f8
- (void)performFetch;	// IMP=0x00000001000b0310
- (void)groupStart;	// IMP=0x00000001000b00e8
- (void)queryClientsForChangeTokens;	// IMP=0x00000001000afc30
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clients:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00000001000af870
- (id)init;	// IMP=0x00000001000af858
