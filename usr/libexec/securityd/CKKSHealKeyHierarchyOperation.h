...
- (void).cxx_destruct;	// IMP=0x0000000100085660
...
- (void)cancel;	// IMP=0x0000000100085554
- (_Bool)ensureKeyPresent:(id)arg1;	// IMP=0x0000000100085070
- (void)groupStart;	// IMP=0x0000000100084dec
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x0000000100084cd8
- (id)init;	// IMP=0x0000000100084cc0
