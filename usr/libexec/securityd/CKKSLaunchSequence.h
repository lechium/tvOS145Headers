...
- (void).cxx_destruct;	// IMP=0x00000001001923d0
...
- (id)eventsByTime;	// IMP=0x0000000100192018
- (id)eventsRelativeTime;	// IMP=0x0000000100191e38
- (void)launch;	// IMP=0x0000000100191c74
- (void)reportMetric;	// IMP=0x00000001001919a4
- (void)addEvent:(id)arg1;	// IMP=0x00000001001917fc
- (void)addAttribute:(id)arg1 value:(id)arg2;	// IMP=0x00000001001916a8
- (void)addDependantLaunch:(id)arg1 child:(id)arg2;	// IMP=0x000000010019152c
@property _Bool firstLaunch;
- (id)initWithRocketName:(id)arg1;	// IMP=0x0000000100191354
