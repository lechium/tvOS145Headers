...
- (void).cxx_destruct;	// IMP=0x000000010009a0fc
...
- (void)cancel;	// IMP=0x0000000100099f4c
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00000001000999ec
- (void)trigger;	// IMP=0x000000010009991c
- (void)_onqueueTimerTick;	// IMP=0x00000001000995ec
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x000000010009950c
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x0000000100099484
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00000001000992a0
- (id)makeOperationDependency;	// IMP=0x00000001000991c4
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x0000000100099134
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x0000000100098f50
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x0000000100098f28
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000100098f0c
