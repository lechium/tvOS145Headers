...
+ (id)createFromProvider:(id)arg1;	// IMP=0x000000010010ec74
+ (id)noPeersState:(id)arg1;	// IMP=0x000000010010eb40
- (void).cxx_destruct;	// IMP=0x000000010010eae0
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x000000010010ddc0
- (id)findPeersMissingTLKSharesFor:(id)arg1 error:(id *)arg2;	// IMP=0x000000010010c874
- (id)description;	// IMP=0x000000010010c734
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x000000010010c4bc
