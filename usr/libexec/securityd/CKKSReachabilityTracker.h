...
+ (_Bool)isNetworkFailureError:(id)arg1;	// IMP=0x00000001000ed41c
+ (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000ed2e0
- (void).cxx_destruct;	// IMP=0x00000001000ecf58
...
- (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000ececc
- (void)setNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000ece40
- (void)_onqueueSetNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000ecd78
- (void)_onQueueResetReachabilityDependency;	// IMP=0x00000001000eca34
- (void)_onQueueRunReachabilityDependency;	// IMP=0x00000001000ec8ec
@property(readonly) _Bool currentReachability;
- (id)description;	// IMP=0x00000001000ec7b4
- (id)init;	// IMP=0x00000001000ec590
