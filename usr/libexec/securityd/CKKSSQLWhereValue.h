...
+ (id)op:(unsigned long long)arg1 value:(id)arg2;	// IMP=0x000000010002ec18
- (void).cxx_destruct;	// IMP=0x000000010002ec0c
@property(retain) NSString *value; // @synthesize value=_value;
@property unsigned long long sqlOp; // @synthesize sqlOp=_sqlOp;
- (id)initWithOperation:(unsigned long long)arg1 value:(id)arg2;	// IMP=0x000000010002eb68
