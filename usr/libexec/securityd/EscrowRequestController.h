...
- (void).cxx_destruct;	// IMP=0x00000001000359a0
...
- (void)storePrerecordsInEscrowRPC:(CDUnknownBlockType)arg1;	// IMP=0x000000010003578c
- (void)triggerEscrowUpdateRPC:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000100034f88
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x00000001000345d8
- (id)initWithLockStateTracker:(id)arg1;	// IMP=0x000000010003439c
