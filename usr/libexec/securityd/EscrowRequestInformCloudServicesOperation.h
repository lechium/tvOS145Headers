...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100190f6c
- (void).cxx_destruct;	// IMP=0x0000000100190f18
...
- (void)main;	// IMP=0x00000001001906f4
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x000000010019060c
