...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000a5630
...
- (void)groupStart;	// IMP=0x00000001000a4870
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x00000001000a46e4
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x00000001000a45ec
