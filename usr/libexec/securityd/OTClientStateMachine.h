...
- (void).cxx_destruct;	// IMP=0x000000010017bc54
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x000000010017b7f8
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000010017b4c0
- (void)notifyContainerChange;	// IMP=0x000000010017b318
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x000000010017ae84
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x000000010017ade0
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x000000010017ad00
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x000000010017aaa8
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x000000010017aa14
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x000000010017a87c
- (void)startOctagonStateMachine;	// IMP=0x000000010017a800
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x000000010017a6a4
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x000000010017a364
