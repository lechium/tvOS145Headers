...
- (void)setupDeviceNameListener;	// IMP=0x0000000100035d84
- (id)serialNumber;	// IMP=0x0000000100035c90
- (id)osVersion;	// IMP=0x0000000100035c8c
- (void)registerForDeviceNameUpdates:(id)arg1;	// IMP=0x0000000100035bd4
- (id)deviceName;	// IMP=0x0000000100035ba8
- (id)modelID;	// IMP=0x0000000100035b68
- (void)dealloc;	// IMP=0x0000000100035af0
