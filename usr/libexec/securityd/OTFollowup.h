...
- (void).cxx_destruct;	// IMP=0x00000001001469d0
...
- (id)sfaStatus;	// IMP=0x0000000100146620
- (id)sysdiagnoseStatus;	// IMP=0x0000000100146344
- (_Bool)clearFollowUp:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x000000010014615c
- (_Bool)postFollowUp:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x0000000100145f44
- (id)createCDPFollowupContext:(unsigned char)arg1;	// IMP=0x0000000100145ef8
- (id)initWithFollowupController:(id)arg1;	// IMP=0x0000000100145e58
- (void)clearAllPostedFlags;	// IMP=0x0000000100146a88
- (_Bool)hasPosted:(unsigned char)arg1;	// IMP=0x0000000100146a00
