...
- (void).cxx_destruct;	// IMP=0x00000001000b5f50
...
- (void)resetViews:(id)arg1;	// IMP=0x00000001000b5ac8
- (void)proceedWithKeys:(id)arg1 incompleteKeySets:(id)arg2 pendingTLKShares:(id)arg3;	// IMP=0x00000001000b5624
- (void)groupStart;	// IMP=0x00000001000b5358
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00000001000b5270
