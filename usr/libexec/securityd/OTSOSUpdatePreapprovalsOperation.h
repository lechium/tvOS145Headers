...
- (void).cxx_destruct;	// IMP=0x00000001000b7cb4
...
- (void)groupStart;	// IMP=0x00000001000b76f0
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 sosNotPresentState:(id)arg3 errorState:(id)arg4;	// IMP=0x00000001000b75d4
