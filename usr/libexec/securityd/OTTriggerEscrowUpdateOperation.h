...
- (void).cxx_destruct;	// IMP=0x000000010005e1a0
...
- (void)groupStart;	// IMP=0x000000010005dd34
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x000000010005dc4c
