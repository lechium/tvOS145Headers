...
- (void).cxx_destruct;	// IMP=0x0000000100073cc8
...
- (void)proceedWithKeys:(id)arg1 filteredTLKShares:(id)arg2;	// IMP=0x00000001000738f0
- (void)noteMetric:(id)arg1 count:(long long)arg2;	// IMP=0x0000000100073764
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x0000000100073590
- (void)groupStart;	// IMP=0x0000000100072f10
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x0000000100072d84
