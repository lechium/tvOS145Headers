...
- (void).cxx_destruct;	// IMP=0x00000001000457f4
...
- (id)currentState;	// IMP=0x0000000100045770
- (void)sendTrustedPeerSetChangedUpdate;	// IMP=0x00000001000456ec
- (void)sendSelfPeerChangedUpdate;	// IMP=0x0000000100045668
- (void)registerForPeerChangeUpdates:(id)arg1;	// IMP=0x00000001000455fc
- (id)fetchTrustedPeers:(id *)arg1;	// IMP=0x00000001000453f8
- (id)fetchSelfPeers:(id *)arg1;	// IMP=0x00000001000450ac
- (id)fetchIdentity:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100044ee8
@property(readonly, copy) NSString *description;
- (id)initWithPeerID:(id)arg1 containerName:(id)arg2 contextID:(id)arg3 cuttlefishXPC:(id)arg4;	// IMP=0x0000000100044cec
