...
- (void).cxx_destruct;	// IMP=0x0000000100145bc4
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x0000000100144a10
- (void)groupStart;	// IMP=0x0000000100144800
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0000000100144718
