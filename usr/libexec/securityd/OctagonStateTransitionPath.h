...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00000001000b37dc
- (void).cxx_destruct;	// IMP=0x00000001000b37ac
...
- (id)asPathStep;	// IMP=0x00000001000b3674
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00000001000b35d0
