...
- (void).cxx_destruct;	// IMP=0x0000000100169590
...
- (id)timeout:(unsigned long long)arg1;	// IMP=0x0000000100169450
- (id)_onqueueStart;	// IMP=0x00000001001693c8
- (id)description;	// IMP=0x00000001001692f0
- (id)init:(id)arg1 sourceStates:(id)arg2 serialQueue:(id)arg3 timeout:(unsigned long long)arg4 transitionOp:(id)arg5;	// IMP=0x00000001001691cc
