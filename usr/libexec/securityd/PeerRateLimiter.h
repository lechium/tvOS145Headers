...
- (void).cxx_destruct;	// IMP=0x00000001001e0d88
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x00000001001e0c0c
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x00000001001e0b00
- (id)setUpConfigForPeer;	// IMP=0x00000001001e0a7c
