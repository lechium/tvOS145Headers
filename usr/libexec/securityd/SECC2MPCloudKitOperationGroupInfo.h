...
- (void).cxx_destruct;	// IMP=0x0000000100180250
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100180160
- (unsigned long long)hash;	// IMP=0x00000001001800d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010017ffc0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010017fee4
- (void)copyTo:(id)arg1;	// IMP=0x000000010017fe4c
- (void)writeTo:(id)arg1;	// IMP=0x000000010017fdc0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010017fdb8
- (id)dictionaryRepresentation;	// IMP=0x000000010017fcc8
- (id)description;	// IMP=0x000000010017fc14
