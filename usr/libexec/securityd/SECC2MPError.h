...
- (void).cxx_destruct;	// IMP=0x000000010012e550
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010012e404
- (unsigned long long)hash;	// IMP=0x000000010012e360
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012e228
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010012e124
- (void)copyTo:(id)arg1;	// IMP=0x000000010012e06c
- (void)writeTo:(id)arg1;	// IMP=0x000000010012dfc4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010012dfbc
- (id)dictionaryRepresentation;	// IMP=0x000000010012de84
- (id)description;	// IMP=0x000000010012ddd0
