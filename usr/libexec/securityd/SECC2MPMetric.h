...
- (void).cxx_destruct;	// IMP=0x0000000100096950
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010009667c
- (unsigned long long)hash;	// IMP=0x000000010009652c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010009631c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100096150
- (void)copyTo:(id)arg1;	// IMP=0x0000000100095fd8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100095e84
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100095858
- (id)dictionaryRepresentation;	// IMP=0x0000000100095504
- (id)description;	// IMP=0x0000000100095450
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000100095224
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00000001000951ac
