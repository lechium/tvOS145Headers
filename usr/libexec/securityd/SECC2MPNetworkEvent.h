...
- (void).cxx_destruct;	// IMP=0x0000000100170030
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010016f66c
- (unsigned long long)hash;	// IMP=0x000000010016f02c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016e89c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010016e1d8
- (void)copyTo:(id)arg1;	// IMP=0x000000010016db98
- (void)writeTo:(id)arg1;	// IMP=0x000000010016d5fc
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010016d5f4
- (id)dictionaryRepresentation;	// IMP=0x000000010016ca64
- (id)description;	// IMP=0x000000010016c9b0
