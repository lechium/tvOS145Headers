...
- (void).cxx_destruct;	// IMP=0x00000001001ab354
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x00000001001ab1c8
- (void)requestSyncWith:(id)arg1;	// IMP=0x00000001001ab100
- (void)finish;	// IMP=0x00000001001a98e8
- (void)restart;	// IMP=0x00000001001a98b4
- (void)start;	// IMP=0x00000001001a948c
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00000001001a93f8
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00000001001a9128
- (unsigned long long)currentTrustBitmask;	// IMP=0x00000001001a9020
