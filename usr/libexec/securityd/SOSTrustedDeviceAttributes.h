...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001ba43c
- (void).cxx_destruct;	// IMP=0x00000001001ba40c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001ba378
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001ba294
