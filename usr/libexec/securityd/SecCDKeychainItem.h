...
- (void).cxx_destruct;	// IMP=0x0000000100042aec
...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x00000001000425a8
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x0000000100041f14
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x0000000100041b3c
- (id)primaryKeys;	// IMP=0x0000000100041b2c
...
- (id)description;	// IMP=0x0000000100041958
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100041868
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100041560
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x00000001000413f8
