...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010003bf98
- (void).cxx_destruct;	// IMP=0x000000010003bf5c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010003beb4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010003bc54
- (id)initWithCiphertext:(id)arg1 wrappedKeyData:(id)arg2 refKeyBlob:(id)arg3;	// IMP=0x000000010003bb64
