...
+ (id)lookupTupleWithManagedLookupEntry:(id)arg1;	// IMP=0x0000000100040a8c
+ (id)lookupTupleWithKey:(id)arg1 value:(id)arg2;	// IMP=0x0000000100040a18
...
- (id)description;	// IMP=0x0000000100040898
- (unsigned long long)hash;	// IMP=0x000000010004083c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010004072c
- (id)initWithKey:(id)arg1 value:(id)arg2;	// IMP=0x0000000100040588
