...
- (void).cxx_destruct;	// IMP=0x0000000100091d18
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100091b88
- (unsigned long long)hash;	// IMP=0x0000000100091acc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100091968
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010009183c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100091764
- (void)writeTo:(id)arg1;	// IMP=0x00000001000916a0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100091384
- (id)dictionaryRepresentation;	// IMP=0x0000000100091228
- (id)description;	// IMP=0x0000000100091174
