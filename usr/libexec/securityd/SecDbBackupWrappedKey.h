...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000b8740
- (void).cxx_destruct;	// IMP=0x00000001000b8710
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000b8604
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000b854c
