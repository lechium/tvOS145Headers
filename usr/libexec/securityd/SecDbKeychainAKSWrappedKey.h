...
- (void).cxx_destruct;	// IMP=0x00000001000e8fe8
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e8e8c
- (id)initRefKeyWrappedKeyWithData:(id)arg1 refKeyBlob:(id)arg2;	// IMP=0x00000001000e8db4
- (id)initRegularWrappedKeyWithData:(id)arg1;	// IMP=0x00000001000e8d10
