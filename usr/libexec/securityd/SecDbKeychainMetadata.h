...
- (void).cxx_destruct;	// IMP=0x00000001000e95a8
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e91e8
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000e8ff4
