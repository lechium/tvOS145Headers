...
- (void).cxx_destruct;	// IMP=0x00000001000e9b0c
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e981c
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 backupWrappedKey:(id)arg4 error:(id *)arg5;	// IMP=0x00000001000e95b4
