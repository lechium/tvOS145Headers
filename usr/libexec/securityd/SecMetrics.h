...
+ (id)managerObject;	// IMP=0x000000010012b934
+ (id)c2MetricsEndpoint;	// IMP=0x000000010012b7a0
- (void).cxx_destruct;	// IMP=0x000000010012b764
...
- (id)generateDeviceInfo;	// IMP=0x000000010012b558
- (id)gzipEncode:(id)arg1;	// IMP=0x000000010012b394
- (id)requestForGenericEvent:(id)arg1;	// IMP=0x000000010012b120
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010012acc8
- (id)getEvent:(id)arg1;	// IMP=0x000000010012abc8
- (void)sendEvent:(id)arg1 pushTopic:(id)arg2;	// IMP=0x000000010012a850
- (void)submitEvent:(id)arg1;	// IMP=0x000000010012a83c
- (id)init;	// IMP=0x000000010012a730
