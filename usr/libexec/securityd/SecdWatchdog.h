...
+ (_Bool)triggerOSFaults;	// IMP=0x000000010000bf20
+ (_Bool)watchdogrusage:(struct rusage_info_v5 *)arg1;	// IMP=0x000000010000beec
+ (id)watchdog;	// IMP=0x000000010000be78
- (void).cxx_destruct;	// IMP=0x000000010000bb54
@property(readonly) _Bool diskUsageHigh; // @synthesize diskUsageHigh=_diskUsageHigh;
- (_Bool)setWatchdogParameters:(id)arg1 error:(id *)arg2;	// IMP=0x000000010000b8d0
- (id)watchdogParameters;	// IMP=0x000000010000b73c
- (void)activateTimer;	// IMP=0x000000010000b56c
- (void)runWatchdog;	// IMP=0x000000010000b298
- (unsigned long long)secondsFromMachTime:(unsigned long long)arg1;	// IMP=0x000000010000b22c
- (id)init;	// IMP=0x000000010000b1ac
