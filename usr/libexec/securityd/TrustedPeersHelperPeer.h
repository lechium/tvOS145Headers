...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100179988
- (void).cxx_destruct;	// IMP=0x0000000100179940
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001797c0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001795c0
- (id)description;	// IMP=0x00000001001794bc
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 viewList:(id)arg4;	// IMP=0x00000001001793c0
