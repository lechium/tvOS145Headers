...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001793b8
- (void).cxx_destruct;	// IMP=0x0000000100179388
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001791b0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100179048
- (id)description;	// IMP=0x0000000100178f00
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6;	// IMP=0x0000000100178e2c
