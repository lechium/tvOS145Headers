...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100165548
- (unsigned long long)hash;	// IMP=0x0000000100165454
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001652a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100165140
- (void)copyTo:(id)arg1;	// IMP=0x0000000100164ffc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100164ec4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100164ebc
- (id)dictionaryRepresentation;	// IMP=0x00000001001645bc
- (id)description;	// IMP=0x0000000100164508
