...
- (void).cxx_destruct;	// IMP=0x000000010008b6e8
...
- (void)service:(id)arg1 nearbyDevicesChanged:(id)arg2;	// IMP=0x000000010008b5d8
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x000000010008b458
- (void)nearbyServiceDevicesChanged:(id)arg1;	// IMP=0x000000010008af9c
- (void)activityServiceDevicesChanged:(id)arg1;	// IMP=0x000000010008af98
- (id)idsDeviceFromBTIdentifier:(id)arg1;	// IMP=0x000000010008ac58
- (void)stop;	// IMP=0x000000010008ac54
- (_Bool)restart;	// IMP=0x000000010008ac4c
- (void)start;	// IMP=0x000000010008ac48
- (id)init;	// IMP=0x000000010008abac
