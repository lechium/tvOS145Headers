...
- (void).cxx_destruct;	// IMP=0x00000001000523c0
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000514b4
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000514a0
- (id)description;	// IMP=0x00000001000513b0
- (id)initWithDevice:(id)arg1;	// IMP=0x0000000100051314
