...
- (void).cxx_destruct;	// IMP=0x0000000100129c80
...
- (unsigned long long)hash;	// IMP=0x0000000100129a84
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001299ac
- (id)description;	// IMP=0x00000001001298a8
- (void)dealloc;	// IMP=0x00000001001297f0
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x00000001001295fc
