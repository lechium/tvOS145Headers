...
- (void).cxx_destruct;	// IMP=0x00000001000bd0a4
...
- (void)dealloc;	// IMP=0x00000001000bcfa8
- (void)stop;	// IMP=0x00000001000bcf50
- (void)start;	// IMP=0x00000001000bcecc
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000bcbbc
- (id)init;	// IMP=0x00000001000bcb68
