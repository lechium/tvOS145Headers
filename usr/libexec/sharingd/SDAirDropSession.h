...
- (void).cxx_destruct;	// IMP=0x000000010003c024
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003bc30
- (void)handleConversionProgress:(id)arg1;	// IMP=0x000000010003bb40
- (void)startProgress;	// IMP=0x000000010003b890
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x000000010003b88c
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x000000010003b11c
- (void)removeClientAlerts;	// IMP=0x000000010003aff4
- (void)dealloc;	// IMP=0x000000010003af68
- (void)stop;	// IMP=0x000000010003add4
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x000000010003aac8
- (void)serversChanged:(id)arg1;	// IMP=0x000000010003a7f4
- (_Bool)send;	// IMP=0x000000010003a6c8
- (void)start;	// IMP=0x000000010003a4d8
- (void)releaseSandboxExtensions;	// IMP=0x000000010003a3c4
- (void)consumeSandboxExtensions;	// IMP=0x000000010003a158
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x000000010003a134
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0000000100039f40
