...
- (void).cxx_destruct;	// IMP=0x00000001000cd768
...
- (void)sendProxyTrigger;	// IMP=0x00000001000cd27c
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001000cd1a8
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001000ccf38
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001000ccdc0
- (id)results;	// IMP=0x00000001000ccc40
- (void)removeObservers;	// IMP=0x00000001000ccbf0
- (void)addObservers;	// IMP=0x00000001000ccb88
- (void)invalidate;	// IMP=0x00000001000ccaa0
- (void)_start;	// IMP=0x00000001000cc9e8
- (void)start;	// IMP=0x00000001000cc95c
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001000cc8b4
