...
- (void).cxx_destruct;	// IMP=0x00000001000eb660
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000eb37c
- (unsigned long long)hash;	// IMP=0x00000001000eb1f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000eaf7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000ead64
- (void)copyTo:(id)arg1;	// IMP=0x00000001000eaba8
- (void)writeTo:(id)arg1;	// IMP=0x00000001000eaa18
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000eaa10
- (id)dictionaryRepresentation;	// IMP=0x00000001000ea198
- (id)description;	// IMP=0x00000001000ea0e4
