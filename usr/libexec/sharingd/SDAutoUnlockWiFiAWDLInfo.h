...
- (void).cxx_destruct;	// IMP=0x000000010005de08
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010005dc6c
- (unsigned long long)hash;	// IMP=0x000000010005db80
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005da00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005d8a8
- (void)copyTo:(id)arg1;	// IMP=0x000000010005d794
- (void)writeTo:(id)arg1;	// IMP=0x000000010005d690
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010005d688
- (id)dictionaryRepresentation;	// IMP=0x000000010005d014
- (id)description;	// IMP=0x000000010005cf60
