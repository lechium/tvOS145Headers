...
+ (id)sharedManager;	// IMP=0x00000001000e6b34
- (void).cxx_destruct;	// IMP=0x00000001000e7ce0
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00000001000e7b84
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00000001000e7b74
- (void)appleAccountSignedOut;	// IMP=0x00000001000e7af4
- (void)appleAccountSignedIn;	// IMP=0x00000001000e7a74
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e79ec
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e7724
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000e73ac
- (void)cleanUpConnections;	// IMP=0x00000001000e710c
- (void)start;	// IMP=0x00000001000e6cf8
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00000001000e6ba0
