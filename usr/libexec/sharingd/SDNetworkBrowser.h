...
- (void).cxx_destruct;	// IMP=0x000000010006115c
...
- (void)invalidate;	// IMP=0x0000000100060f50
- (int)closeNode:(struct __SFNode *)arg1;	// IMP=0x0000000100060ec8
- (int)removeNode:(struct __SFNode *)arg1;	// IMP=0x0000000100060e60
- (int)addNode:(struct __SFNode *)arg1;	// IMP=0x0000000100060df8
@property(copy) NSDictionary *options;
@property long long mode;
- (id)sidebarChildren;	// IMP=0x0000000100060cc4
- (id)childrenForNode:(struct __SFNode *)arg1;	// IMP=0x0000000100060c54
- (struct __SFNode *)copyRootNode;	// IMP=0x0000000100060c44
- (int)openNode:(struct __SFNode *)arg1 forProtocol:(id)arg2 flags:(unsigned long long)arg3;	// IMP=0x0000000100060ac4
- (void)nodeBrowser:(id)arg1 nodesChangedForParent:(struct __SFNode *)arg2 protocol:(id)arg3 error:(int)arg4;	// IMP=0x0000000100060a4c
- (void)dealloc;	// IMP=0x00000001000609e8
- (id)initWithKind:(id)arg1 rootNode:(struct __SFNode *)arg2;	// IMP=0x0000000100060908
