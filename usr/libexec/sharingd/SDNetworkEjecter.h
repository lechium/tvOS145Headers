...
- (void).cxx_destruct;	// IMP=0x000000010010c8b4
...
- (void)stop;	// IMP=0x000000010010c820
- (int)start;	// IMP=0x000000010010c770
- (void)eject;	// IMP=0x000000010010c53c
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x000000010010c538
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x000000010010c3b8
- (void)dealloc;	// IMP=0x000000010010c370
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x000000010010c2fc
