...
- (void).cxx_destruct;	// IMP=0x00000001000d17dc
...
- (void)stop;	// IMP=0x00000001000d1738
- (int)start;	// IMP=0x00000001000d144c
- (void)mount;	// IMP=0x00000001000d1448
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x00000001000d1190
- (void)mountDiskImageAsync;	// IMP=0x00000001000d118c
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x00000001000d1058
- (void)dealloc;	// IMP=0x00000001000d1010
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00000001000d0f90
