...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00000001001630a0
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100162e60
- (void)disableService:(id)arg1;	// IMP=0x0000000100162dd8
- (void)enableService:(id)arg1;	// IMP=0x0000000100162d54
- (id)streamHandlerForService:(id)arg1;	// IMP=0x0000000100162cf0
- (void)stop;	// IMP=0x0000000100162afc
- (void)start;	// IMP=0x0000000100162aac
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x00000001001629a4
