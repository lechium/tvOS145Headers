...
- (void).cxx_destruct;	// IMP=0x0000000100130728
...
- (id)trimHeader:(id)arg1;	// IMP=0x00000001001304b0
- (unsigned int)parseHeader:(id)arg1;	// IMP=0x0000000100130410
- (void)handleMessageWritten:(id)arg1;	// IMP=0x0000000100130328
- (void)handleSpaceForMessage;	// IMP=0x000000010012fe44
- (void)resetReadState;	// IMP=0x000000010012fe00
- (void)handleMessageRead;	// IMP=0x000000010012fd90
- (void)handleHeaderRead;	// IMP=0x000000010012fc5c
- (void)handleBytesForMessage;	// IMP=0x000000010012f984
- (id)headerWithLength:(unsigned int)arg1;	// IMP=0x000000010012f910
- (id)messageWithData:(id)arg1;	// IMP=0x000000010012f894
- (void)sendMessage:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010012f598
- (void)sendMessage:(id)arg1 withErrorHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010012f550
- (void)handleSpaceForStream;	// IMP=0x000000010012f238
- (void)handleBytesForStream;	// IMP=0x000000010012efa0
- (void)writeToStreamWithData:(id)arg1;	// IMP=0x000000010012ee10
- (void)handleSpaceAvailable;	// IMP=0x000000010012ecec
- (void)handleBytesAvailable;	// IMP=0x000000010012ebc8
- (void)handleOpenedStream:(id)arg1;	// IMP=0x000000010012e9cc
- (void)setTCPProperties:(id)arg1;	// IMP=0x000000010012e8d8
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x000000010012e774
- (_Bool)evaluateCert;	// IMP=0x000000010012e4b8
- (void)applySSLSettings:(id)arg1;	// IMP=0x000000010012e18c
- (void)invalidateOpenTimer;	// IMP=0x000000010012e0f8
- (void)openTimerFired:(id)arg1;	// IMP=0x000000010012df24
- (void)startOpenTimer;	// IMP=0x000000010012de38
- (void)logTransfer;	// IMP=0x000000010012dc70
@property _Bool shouldReadNetwork; // @synthesize shouldReadNetwork=_shouldReadNetwork;
- (void)_stop;	// IMP=0x000000010012d944
- (void)stopIfReady;	// IMP=0x000000010012d8f4
- (void)stop;	// IMP=0x000000010012d8a4
- (void)start;	// IMP=0x000000010012d59c
- (void)dealloc;	// IMP=0x000000010012d4c8
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 isClient:(_Bool)arg3;	// IMP=0x000000010012d324
