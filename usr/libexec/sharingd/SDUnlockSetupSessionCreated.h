...
- (void).cxx_destruct;	// IMP=0x0000000100169cb4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100169a2c
- (unsigned long long)hash;	// IMP=0x00000001001698b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100169678
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100169488
- (void)copyTo:(id)arg1;	// IMP=0x00000001001692dc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100169158
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100169150
- (id)dictionaryRepresentation;	// IMP=0x00000001001687ac
- (id)description;	// IMP=0x00000001001686f8
