...
- (void).cxx_destruct;	// IMP=0x00000001000a6c78
...
- (_Bool)stateIsNearby;	// IMP=0x00000001000a68ec
- (_Bool)stateIsMedium;	// IMP=0x00000001000a68a8
- (_Bool)stateIsClose;	// IMP=0x00000001000a6894
- (void)resetTicks;	// IMP=0x00000001000a66e8
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x00000001000a63a4
- (_Bool)canTransition:(int)arg1;	// IMP=0x00000001000a62a8
- (id)description;	// IMP=0x00000001000a5f0c
