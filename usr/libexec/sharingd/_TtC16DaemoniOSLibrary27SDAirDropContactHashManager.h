...
+ (id)shared;	// IMP=0x00000001001dec78
- (void).cxx_destruct;	// IMP=0x00000001001e6b5c
- (id)init;	// IMP=0x00000001001e05c4
- (_Bool)acquireTokenForIdentifier:(unsigned long long)arg1;	// IMP=0x00000001001decb8
