...
- (void).cxx_destruct;	// IMP=0x0000000100004928
...
- (void)setCap:(unsigned long long)arg1 downsampleRatio:(unsigned long long)arg2 forQuery:(id)arg3;	// IMP=0x0000000100004798
- (id)newChildInstance;	// IMP=0x0000000100004770
- (id)keyForChildren:(id)arg1;	// IMP=0x0000000100004740
- (id)entryForQuery:(id)arg1;	// IMP=0x0000000100004644
