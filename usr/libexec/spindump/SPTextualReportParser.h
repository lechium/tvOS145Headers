...
+ (_Bool)isSpindumpFile:(const char *)arg1;	// IMP=0x000000010001956c
...
- (_Bool)parseSpindumpFile:(const char *)arg1 andReportToStream:(struct __sFILE *)arg2;	// IMP=0x0000000100019638
