...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000131c0
- (void).cxx_destruct;	// IMP=0x0000000100013b60
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100013288
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000131c8
