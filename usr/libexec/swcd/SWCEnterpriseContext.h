...
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x000000010000f820
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x000000010000f640
- (id)init;	// IMP=0x000000010000f570
- (void)_loadEnterpriseData;	// IMP=0x000000010000fc4c
