...
- (_Bool)renewCredentials;	// IMP=0x00000001000086c8
- (id)publicURLForConfigurationWithService:(id)arg1;	// IMP=0x00000001000085d8
@property(readonly, nonatomic) NSString *apsEnvironment;
- (id)initWithAccount:(id)arg1 sydAccount:(id)arg2;	// IMP=0x0000000100008290
