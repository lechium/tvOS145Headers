...
- (void).cxx_destruct;	// IMP=0x0000000100052504
...
- (void)sendReply:(id)arg1;	// IMP=0x0000000100052228
...
- (void)_translateMessageIfNecessary;	// IMP=0x0000000100051f20
- (id)description;	// IMP=0x0000000100051eac
- (id)initWithPeer:(id)arg1 andMessage:(id)arg2 activity:(id)arg3;	// IMP=0x0000000100051ddc
