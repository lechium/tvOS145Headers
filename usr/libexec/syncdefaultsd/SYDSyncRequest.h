...
- (void).cxx_destruct;	// IMP=0x000000010004c7c8
...
- (id)initWithType:(long long)arg1 reason:(int)arg2 apps:(id)arg3 soon:(_Bool)arg4 message:(id)arg5;	// IMP=0x000000010004c6ac
