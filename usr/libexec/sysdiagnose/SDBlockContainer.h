...
+ (id)containerWithName:(id)arg1 forBlock:(CDUnknownBlockType)arg2 withTimeout:(double)arg3 withDelegate:(id)arg4;	// IMP=0x000000010003e008
...
- (_Bool)execute;	// IMP=0x000000010003e118
