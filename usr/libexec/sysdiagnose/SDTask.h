...
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 asUID:(unsigned int)arg3 outputFile:(id)arg4;	// IMP=0x0000000100036ff4
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 inBootstrapDomainOfUID:(unsigned int)arg3 outputFile:(id)arg4;	// IMP=0x0000000100036fdc
+ (id)shellTaskWithCommand:(id)arg1 outputFile:(id)arg2;	// IMP=0x0000000100036ed8
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 withRuntimeChecks:(unsigned long long)arg4;	// IMP=0x0000000100036e80
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3;	// IMP=0x0000000100036e64
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 withSubDir:(id)arg4;	// IMP=0x0000000100036e4c
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 taskDelegate:(id)arg4;	// IMP=0x0000000100036e30
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 withSubDir:(id)arg4 taskDelegate:(id)arg5;	// IMP=0x0000000100036d18
- (void).cxx_destruct;	// IMP=0x000000010003b040
...
- (int)signalRunningTask:(int)arg1;	// IMP=0x000000010003ad50
- (_Bool)resume;	// IMP=0x000000010003ad28
- (_Bool)suspend;	// IMP=0x000000010003ad00
- (void)interrupt;	// IMP=0x000000010003acf0
- (void)terminate;	// IMP=0x000000010003ace0
- (int)_launch;	// IMP=0x000000010003a340
- (void)_waitForExitInformation;	// IMP=0x0000000100039e88
- (void)_stop;	// IMP=0x0000000100039180
- (int)_start;	// IMP=0x00000001000378e8
- (id)fileHandleForError;	// IMP=0x0000000100037648
- (id)fileHandleForOutput;	// IMP=0x0000000100037048
- (id)description;	// IMP=0x0000000100036c74
- (id)init;	// IMP=0x0000000100036a2c
- (void *)SDTaskPOSIXSpawnAttributes;	// IMP=0x00000001000366d0
