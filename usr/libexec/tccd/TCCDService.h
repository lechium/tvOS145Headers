...
+ (id)subsequentRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000293d4
+ (id)subsequentRequestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000293bc
+ (id)subsequentRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000293a4
+ (id)requestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x000000010002938c
+ (id)requestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0000000100029374
+ (id)requestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x000000010002935c
+ (id)requestAdditionalTextForSubsequentRequestsKeyNameForServiceName:(id)arg1;	// IMP=0x0000000100029344
+ (id)requestAdditionalTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x000000010002932c
+ (id)requestAdditionalTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0000000100029314
+ (id)requestTitleTextForSubsequentRequestsLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000292fc
+ (id)requestTitleTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000292e4
+ (id)requestTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000292cc
+ (id)localizationKeyName:(id)arg1 forServiceName:(id)arg2;	// IMP=0x0000000100029294
+ (id)versionStringFromDYLDVersionNumber:(id)arg1;	// IMP=0x000000010002921c
+ (id)tccdPlatformNameForDYLDPlatformName:(id)arg1;	// IMP=0x0000000100029148
+ (id)serviceDescriptionsForPlatformName:(id)arg1;	// IMP=0x0000000100028e84
+ (id)serviceAll;	// IMP=0x0000000100028de4
+ (id)allServices;	// IMP=0x00000001000258b8
- (void).cxx_destruct;	// IMP=0x000000010002a948
...
- (long long)developmentAuthorizationValue;	// IMP=0x000000010002a30c
...
- (id)descriptionForAuthorizationValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x000000010002a224
- (id)authorizationRightStateForValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x000000010002a1a8
- (_Bool)isAuthorizationValue:(unsigned long long)arg1 equalToRight:(unsigned long long)arg2;	// IMP=0x000000010002a168
- (long long)compare:(id)arg1;	// IMP=0x000000010002a0cc
- (id)descriptionDictionary;	// IMP=0x00000001000297fc
- (id)description;	// IMP=0x00000001000297f0
- (id)initWithName:(id)arg1 availability:(id)arg2;	// IMP=0x00000001000293ec
