...
- (void).cxx_destruct;	// IMP=0x0000000100004098
...
- (void)dealloc;	// IMP=0x0000000100003f70
- (void)stop;	// IMP=0x0000000100003eec
- (_Bool)start;	// IMP=0x0000000100003c98
- (id)initWithSrcIfIndex:(unsigned int)arg1 dstIfIndex:(unsigned int)arg2 name:(id)arg3 type:(id)arg4 domain:(id)arg5 hostTarget:(id)arg6 port:(unsigned short)arg7 txtRecord:(id)arg8;	// IMP=0x0000000100003af4
