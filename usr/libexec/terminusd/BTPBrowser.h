...
- (void)handleReplyName:(id)arg1 type:(id)arg2 domain:(id)arg3 ifIndex:(unsigned int)arg4 add:(_Bool)arg5;	// IMP=0x00000001000030e8
- (void)dealloc;	// IMP=0x0000000100003064
- (void)stop;	// IMP=0x0000000100002f04
- (_Bool)start;	// IMP=0x0000000100002d6c
- (id)initWithSrcIfIndex:(unsigned int)arg1 dstIfIndex:(unsigned int)arg2 bonjourType:(id)arg3;	// IMP=0x0000000100002c70
