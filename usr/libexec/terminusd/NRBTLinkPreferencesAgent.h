...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100035084
+ (id)agentDomain;	// IMP=0x0000000100035054
+ (id)agentType;	// IMP=0x0000000100035010
- (void).cxx_destruct;	// IMP=0x0000000100034dac
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100034c14
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100034b94
- (_Bool)registerAgent;	// IMP=0x0000000100034774
- (_Bool)unregisterAgent;	// IMP=0x00000001000345dc
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x00000001000345cc
- (void)dealloc;	// IMP=0x0000000100034580
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000100034290
