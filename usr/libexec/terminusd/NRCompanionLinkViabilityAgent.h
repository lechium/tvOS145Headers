...
+ (id)agentFromData:(id)arg1;	// IMP=0x00000001000366dc
+ (id)agentDomain;	// IMP=0x0000000100036698
+ (id)agentType;	// IMP=0x0000000100036654
- (void).cxx_destruct;	// IMP=0x0000000100036588
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x000000010003644c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100036404
- (_Bool)registerAgentWithActivate:(_Bool)arg1;	// IMP=0x0000000100035e60
- (void)activateAgent;	// IMP=0x0000000100035d38
- (void)suspendAgent;	// IMP=0x0000000100035c10
- (_Bool)unregisterAgent;	// IMP=0x0000000100035a1c
- (id)copyAgentData;	// IMP=0x0000000100035a14
- (id)description;	// IMP=0x000000010003589c
- (void)dealloc;	// IMP=0x00000001000357f8
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2;	// IMP=0x000000010003531c
