...
- (void).cxx_destruct;	// IMP=0x00000001000a0c2c
...
- (id)initDTLSWithQueue:(id)arg1 server:(_Bool)arg2 delegate:(id)arg3;	// IMP=0x00000001000a06d4
- (void)startDTLS;	// IMP=0x00000001000a0208
- (void)handleIsReady;	// IMP=0x00000001000a0174
- (void)readOnDTLSConnection;	// IMP=0x00000001000a006c
- (void)readOnUDPConnection;	// IMP=0x000000010009ff64
- (void)retransmitOutboundEncryptedData:(id)arg1 retransmitCount:(unsigned int)arg2;	// IMP=0x000000010009fe74
- (void)processInboundEncryptedData:(id)arg1;	// IMP=0x000000010009fd50
- (void)processOutboundUnencryptedData:(id)arg1;	// IMP=0x000000010009fc40
- (id)description;	// IMP=0x000000010009fbac
