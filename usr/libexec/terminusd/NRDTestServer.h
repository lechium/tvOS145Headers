...
- (void).cxx_destruct;	// IMP=0x000000010002e2cc
...
- (void)sendTokenOnConnection:(id)arg1 connection:(id)arg2;	// IMP=0x000000010002dfe4
- (void)pushDownloadOnConnection:(id)arg1;	// IMP=0x000000010002dfd0
- (void)setReadHandlerOnConnection:(id)arg1 forService:(id)arg2;	// IMP=0x000000010002df14
- (void)handleNewConnection:(id)arg1 forPeerEndpoint:(id)arg2 forService:(id)arg3 forServiceConnector:(id)arg4;	// IMP=0x000000010002dcbc
- (void)setupTestServer;	// IMP=0x000000010002dbd8
- (id)createServiceConnector:(_Bool)arg1;	// IMP=0x000000010002dad8
- (void)cancel;	// IMP=0x000000010002da84
- (id)copyStatusString;	// IMP=0x000000010002d960
- (void)start;	// IMP=0x000000010002d8d0
- (void)dealloc;	// IMP=0x000000010002d798
- (id)initTestServerWithQueue:(id)arg1;	// IMP=0x000000010002d580
