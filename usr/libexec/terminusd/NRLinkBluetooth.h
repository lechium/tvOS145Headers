...
- (void).cxx_destruct;	// IMP=0x000000010004c720
...
- (void)attemptPairingUsingOutOfBandKey:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010004aa28
- (void)setPacketReceiver:(id)arg1;	// IMP=0x000000010004a7c0
- (_Bool)sendPacketData:(id)arg1;	// IMP=0x000000010004a678
- (void)requestConfigurationForListener:(id)arg1 session:(id)arg2 sessionConfig:(id)arg3 childConfig:(id)arg4 validateAuthBlock:(CDUnknownBlockType)arg5 responseBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000010004977c
- (id)respondToIKESession:(id)arg1 dataProtectionClass:(unsigned char)arg2 validateAuthBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000100049354
- (void)listener:(id)arg1 receivedNewSession:(id)arg2;	// IMP=0x0000000100049258
- (_Bool)setupIPsec;	// IMP=0x000000010004902c
- (void)restartIKESessionForDataProtectionClass:(unsigned char)arg1;	// IMP=0x0000000100048e64
- (void)scheduleIKESessionClassADueToConnectFailure;	// IMP=0x0000000100048c40
- (void)restartIKESessionClassA;	// IMP=0x0000000100048c30
- (void)restartIKESessionClassC;	// IMP=0x0000000100048c20
- (void)restartIKESessionClassD;	// IMP=0x0000000100048c10
- (void)setupIPsecInitiatorIfNecessary:(unsigned char)arg1;	// IMP=0x0000000100048564
- (void)setupIPsecForPairingInitiatorIfNecessary;	// IMP=0x0000000100048294
- (void)setupIKECallbacksPairing;	// IMP=0x0000000100047e30
- (void)sendlocalPublicClassAKeysEncryptedWithIDS;	// IMP=0x0000000100047be4
- (void)sendlocalPublicClassCKeysEncryptedWithIDS;	// IMP=0x0000000100047998
- (void)setupIKECallbacksClassA;	// IMP=0x0000000100047988
- (void)setupIKECallbacksClassC;	// IMP=0x0000000100047978
- (void)setupIKECallbacksClassD;	// IMP=0x0000000100047968
- (void)setupIKECallbacks:(unsigned char)arg1;	// IMP=0x00000001000473b4
- (void)reportRegistrationFailureIfNeededWithFailureCode:(long long)arg1 errorDescription:(id)arg2;	// IMP=0x0000000100047398
- (void)handleNotifyCode:(unsigned short)arg1 payload:(id)arg2;	// IMP=0x000000010004599c
- (void)sendNotifyPayload;	// IMP=0x0000000100045998
- (_Bool)sendAlwaysOnWiFiUpdate;	// IMP=0x0000000100045788
- (id)copyNotifyPayloadsToSendWithProxy:(_Bool)arg1;	// IMP=0x0000000100044ff8
- (_Bool)sendControlData:(id)arg1;	// IMP=0x0000000100044da8
- (_Bool)handleIncomingIKEData:(id)arg1;	// IMP=0x0000000100044b58
- (_Bool)sendIKEData:(id)arg1;	// IMP=0x000000010004484c
- (void)handleRequestToActivateNexus:(id)arg1 fromFlow:(id)arg2;	// IMP=0x0000000100044848
- (void)acceptNewFlow:(id)arg1 fromNexus:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000447b8
- (_Bool)appendEncapsulatedData:(id)arg1 type:(unsigned char)arg2;	// IMP=0x0000000100044444
- (void)appendlinkOutgoingData:(id)arg1;	// IMP=0x00000001000443d4
- (_Bool)sendData;	// IMP=0x00000001000443c4
- (_Bool)sendDataWithCount:(unsigned int)arg1;	// IMP=0x000000010004417c
- (void)stopReadingPackets;	// IMP=0x000000010004416c
- (void)stopReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100043fe0
- (void)resumeReadingPackets;	// IMP=0x0000000100043fd0
- (void)resumeReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100043e38
- (unsigned long long)writeBytesToChannel:(const char *)arg1 length:(unsigned long long)arg2;	// IMP=0x0000000100043bf0
- (void)readDataFromChannelWithIsUrgent:(_Bool)arg1;	// IMP=0x0000000100043984
- (void)readIncomingData:(char *)arg1 length:(unsigned long long)arg2 isUrgentLink:(_Bool)arg3;	// IMP=0x00000001000436e8
- (void)handleIncoming6LoWPANData:(const char *)arg1 tlvBufferLength:(unsigned short)arg2 length:(unsigned short)arg3 tlvType:(unsigned char)arg4;	// IMP=0x0000000100043398
- (void)handPacketToNexus:(id)arg1;	// IMP=0x000000010004338c
- (void)writePacketToNexusChannel:(id)arg1;	// IMP=0x0000000100043290
- (void)handleReadData:(_Bool)arg1;	// IMP=0x0000000100040e84
- (void)flushPipeWithReason:(id)arg1;	// IMP=0x0000000100040df0
- (void)cleanupLinkReadBufferWithExtra:(unsigned int)arg1;	// IMP=0x0000000100040c6c
- (void)armLinkStatsTimer;	// IMP=0x0000000100040b4c
- (_Bool)setupNexus;	// IMP=0x0000000100040584
- (void)checkProxyAgentWithForceUpdate:(_Bool)arg1;	// IMP=0x00000001000404b8
- (void)addVirtualInterfaceRoutes;	// IMP=0x0000000100040304
- (void)handlePongSequenceNumber:(unsigned long long)arg1 receiveTime:(unsigned long long)arg2;	// IMP=0x000000010003ff2c
- (void)measureLatencyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010003fb04
- (void)updateDatagramPipe:(id)arg1;	// IMP=0x000000010003f08c
- (void)updateUrgentPipe:(id)arg1;	// IMP=0x000000010003e6bc
- (void)cleanupUrgentPipeState;	// IMP=0x000000010003e398
- (_Bool)setQosMarkingEnabled;	// IMP=0x000000010003e0c8
- (_Bool)setMPKLLoggingWithEnabled:(_Bool)arg1;	// IMP=0x000000010003de80
- (_Bool)setupNexusChannelVoice:(id)arg1;	// IMP=0x000000010003d830
- (_Bool)setupNexusChannelBestEffort:(id)arg1;	// IMP=0x000000010003d1e0
- (_Bool)setupNexusChannelBackground:(id)arg1;	// IMP=0x000000010003cb90
- (_Bool)setupNexusChannelVideo:(id)arg1;	// IMP=0x000000010003c540
- (_Bool)validateChannelAttributes:(struct channel_attr *)arg1;	// IMP=0x000000010003b964
- (_Bool)setupNexusChannel;	// IMP=0x000000010003b6ec
- (void)pipeDidDisconnect;	// IMP=0x000000010003b6d8
- (_Bool)resume;	// IMP=0x000000010003b5dc
- (_Bool)suspend;	// IMP=0x000000010003b470
- (_Bool)cancelBecausePipeDisconnected;	// IMP=0x000000010003b300
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x000000010003adb0
- (unsigned short)metric;	// IMP=0x000000010003ada8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003abd0
- (void)refreshCompanionProxyAgent;	// IMP=0x000000010003ab48
- (void)dealloc;	// IMP=0x000000010003aaac
- (void)invalidateLink;	// IMP=0x000000010003a698
- (void)invalidateNexusChannels;	// IMP=0x000000010003a054
- (void)invalidateIKESessionClassA;	// IMP=0x000000010003a044
- (void)invalidateIKESessionClassC;	// IMP=0x000000010003a034
- (void)invalidateIKESessionClassD;	// IMP=0x000000010003a024
- (id *)ikeSessionPointerForDataProtectionClass:(unsigned char)arg1;	// IMP=0x0000000100039ecc
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x0000000100039e60
- (_Bool)start;	// IMP=0x00000001000382f4
- (id)copyShortDescriptionInner;	// IMP=0x0000000100038204
- (id)copyDescriptionInner;	// IMP=0x0000000100038080
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3 pipe:(id)arg4 remoteDeviceName:(id)arg5;	// IMP=0x0000000100037b0c
@property(readonly, nonatomic) _Bool hasValidPipe;
- (id)copyStatusString;	// IMP=0x0000000100036724
