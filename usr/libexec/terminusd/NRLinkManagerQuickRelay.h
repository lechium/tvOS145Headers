...
- (void).cxx_destruct;	// IMP=0x00000001000936a4
...
- (void)connection:(id)arg1 didChangeConnectedStatus:(_Bool)arg2;	// IMP=0x00000001000934a8
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x00000001000933fc
- (void)checkEnabledDevices;	// IMP=0x00000001000931e8
- (void)linkDidReceiveData:(id)arg1 data:(id)arg2;	// IMP=0x0000000100093080
- (void)linkIsUnavailable:(id)arg1;	// IMP=0x0000000100092f30
- (void)linkIsReady:(id)arg1;	// IMP=0x0000000100092e28
- (void)linkIsSuspended:(id)arg1;	// IMP=0x0000000100092d20
- (void)linkIsAvailable:(id)arg1;	// IMP=0x0000000100092be4
- (void)createLinkForNRUUID:(id)arg1;	// IMP=0x0000000100092b14
- (void)createLinkIfApplicable;	// IMP=0x00000001000926dc
- (void)setup;	// IMP=0x0000000100092270
- (id)copyStatusString;	// IMP=0x0000000100092160
- (id)copyName;	// IMP=0x0000000100092154
- (void)dealloc;	// IMP=0x00000001000920d4
- (void)invalidateManager;	// IMP=0x0000000100091fc0
- (void)cancel;	// IMP=0x0000000100091f88
- (id)initManagerWithQueue:(id)arg1 managerDelegate:(id)arg2 quickRelayManagerDelegate:(id)arg3;	// IMP=0x0000000100091d84
