...
+ (id)agentFromData:(id)arg1;	// IMP=0x00000001000308c8
+ (id)agentType;	// IMP=0x0000000100030884
+ (id)agentDomain;	// IMP=0x0000000100030840
- (void).cxx_destruct;	// IMP=0x0000000100030178
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x000000010002ffe8
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x000000010002ff44
- (_Bool)startAgentWithOptions:(id)arg1;	// IMP=0x000000010002fea4
- (_Bool)unregisterAgent;	// IMP=0x000000010002fce8
- (void)activateAgent;	// IMP=0x000000010002fc18
- (_Bool)registerAgentOnQueue:(id)arg1;	// IMP=0x000000010002faf0
- (id)copyAgentData;	// IMP=0x000000010002fae8
- (id)description;	// IMP=0x000000010002fa00
- (void)dealloc;	// IMP=0x000000010002f94c
- (id)init;	// IMP=0x000000010002f6a4
