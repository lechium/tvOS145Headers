...
- (void).cxx_destruct;	// IMP=0x0000000100024d88
...
- (id)copyClientDescription;	// IMP=0x0000000100024c30
- (id)initWithRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x0000000100024984
