...
+ (id)copySharedServer;	// IMP=0x000000010002d508
- (void).cxx_destruct;	// IMP=0x0000000100027364
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x0000000100026ffc
- (void)startXPCListener;	// IMP=0x0000000100026cbc
- (void)registerHandlerFunctions;	// IMP=0x000000010002574c
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(unsigned long long)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000100025310
- (id)initInternal;	// IMP=0x0000000100024f48
