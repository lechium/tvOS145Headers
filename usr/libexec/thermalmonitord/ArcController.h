...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x00000001000289e0
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x00000001000289cc
- (int)numberOfFields;	// IMP=0x00000001000289c4
- (void)overrideParam:(id)arg1 value:(int)arg2;	// IMP=0x0000000100028878
- (void)updateInternal;	// IMP=0x00000001000286fc
- (void)update;	// IMP=0x0000000100028690
- (id)initWithParams:(id)arg1 product:(id)arg2;	// IMP=0x00000001000283e8
- (id)init;	// IMP=0x00000001000283d4
