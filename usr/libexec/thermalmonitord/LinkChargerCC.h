...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x000000010000e1a0
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x000000010000e0c0
- (int)numberOfFields;	// IMP=0x000000010000e088
- (void)setChargerType:(int)arg1;	// IMP=0x000000010000e078
- (_Bool)canSystemSleep;	// IMP=0x000000010000df64
- (_Bool)isOnCharger;	// IMP=0x000000010000df54
- (_Bool)isCurrentlyCloaked;	// IMP=0x000000010000df44
- (void)refreshTGraphTelemetry;	// IMP=0x000000010000df20
- (_Bool)updateCloakingState:(_Bool)arg1;	// IMP=0x000000010000dd8c
- (void)defaultAction;	// IMP=0x000000010000d8f4
- (id)initWithParams:(struct __CFDictionary *)arg1 aggdController:(id)arg2;	// IMP=0x000000010000d66c
