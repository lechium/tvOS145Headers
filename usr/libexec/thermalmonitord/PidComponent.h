...
- (void)applySeedToIntegratorFromControlEffort:(int)arg1 currentTemperature:(float)arg2;	// IMP=0x0000000100007a1c
- (_Bool)isIntegratorAtMin;	// IMP=0x0000000100007a0c
- (_Bool)isEqualMType:(int)arg1;	// IMP=0x00000001000079fc
- (void)calculateControlEffort:(float)arg1;	// IMP=0x000000010000797c
- (void)dealloc;	// IMP=0x0000000100007930
- (id)initPIDWith:(struct __CFDictionary *)arg1;	// IMP=0x000000010000781c
