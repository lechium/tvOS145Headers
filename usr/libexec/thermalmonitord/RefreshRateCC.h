...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x000000010000d5a4
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x000000010000d508
- (int)numberOfFields;	// IMP=0x000000010000d4d4
- (void)refreshTGraphTelemetry;	// IMP=0x000000010000d4d0
- (void)initRefreshRateTable:(struct __CFArray *)arg1;	// IMP=0x000000010000d28c
- (void)defaultAction;	// IMP=0x000000010000d1e0
- (id)initWithParams:(struct __CFDictionary *)arg1;	// IMP=0x000000010000d0d0
