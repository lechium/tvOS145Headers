...
- (_Bool)isMachTimeValid:(unsigned long long)arg1;	// IMP=0x000000010001291c
...
- (void)montonicTimeForMachTime:(unsigned long long)arg1 toQueue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010001219c
- (void)dealloc;	// IMP=0x0000000100012154
- (id)initWithSyncInterval:(double)arg1;	// IMP=0x00000001000120a0
- (id)init;	// IMP=0x0000000100012040
