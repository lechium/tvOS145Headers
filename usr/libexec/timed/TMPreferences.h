...
- (id)description;	// IMP=0x0000000100016c7c
- (void)setAccurateThresholds:(_Bool)arg1;	// IMP=0x00000001000169fc
...
- (id)init;	// IMP=0x00000001000168f0
- (id)initWithDefaults:(id)arg1;	// IMP=0x0000000100016300
- (void)dealloc;	// IMP=0x00000001000162b8
