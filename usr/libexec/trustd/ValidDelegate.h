...
- (void).cxx_destruct;	// IMP=0x0000000100025568
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00000001000251c0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100024f80
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000249f0
- (long long)versionFromTask:(id)arg1;	// IMP=0x0000000100024994
- (void)updateDb:(unsigned long long)arg1;	// IMP=0x00000001000247c8
- (void)reschedule;	// IMP=0x00000001000245d0
