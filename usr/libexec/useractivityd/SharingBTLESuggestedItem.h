...
+ (id)statusString;	// IMP=0x00000001000603f4
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x000000010005b2e8
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x000000010005b1b8
- (void).cxx_destruct;	// IMP=0x00000001000605a8
...
- (id)description;	// IMP=0x0000000100060294
- (void)setWhen:(id)arg1;	// IMP=0x0000000100060170
- (id)when;	// IMP=0x0000000100060088
- (id)statusString;	// IMP=0x000000010005faac
- (void)clearPayload;	// IMP=0x000000010005f884
- (void)resignCurrent;	// IMP=0x000000010005f80c
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010005d9fc
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x000000010005d46c
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x000000010005c81c
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x000000010005c744
