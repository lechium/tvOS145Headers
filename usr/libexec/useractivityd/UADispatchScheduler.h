...
+ (id)dispatchScheduler:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00000001000297ac
- (void).cxx_destruct;	// IMP=0x000000010002a704
...
- (id)nextRunTimeString;	// IMP=0x000000010002a67c
- (void)waitUntilComplete;	// IMP=0x000000010002a608
- (void)suspend;	// IMP=0x000000010002a5a0
- (void)resume;	// IMP=0x000000010002a568
- (void)reset;	// IMP=0x000000010002a38c
- (void)updateFrequency:(double)arg1;	// IMP=0x000000010002a194
- (void)_doIt;	// IMP=0x0000000100029ebc
- (void)doIt;	// IMP=0x0000000100029e30
- (_Bool)scheduleAt:(id)arg1;	// IMP=0x0000000100029db4
- (_Bool)scheduleNext:(double)arg1;	// IMP=0x0000000100029874
- (id)init:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0000000100029478
