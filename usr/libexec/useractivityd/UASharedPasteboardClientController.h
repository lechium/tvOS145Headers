...
- (void).cxx_destruct;	// IMP=0x0000000100037280
...
- (id)localPBStatus;	// IMP=0x00000001000369a8
- (id)statusString;	// IMP=0x000000010003699c
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x0000000100036450
- (void)showProgressUI:(id)arg1;	// IMP=0x0000000100035e30
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000100035180
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0000000100034600
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000328f4
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x0000000100032778
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x000000010003276c
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100030280
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002e4b4
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002e158
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x000000010002e058
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x000000010002dd94
- (void)clearLocalPasteboardInformation;	// IMP=0x000000010002dcc0
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x000000010002d5c0
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d4e8
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d474
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d35c
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x000000010002cf9c
- (id)currentPasteboardActivityInfo;	// IMP=0x000000010002ccd0
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x000000010002cb80
- (id)items;	// IMP=0x000000010002cb74
- (void)startConnection:(int)arg1;	// IMP=0x000000010002cac8
...
- (id)uuid;	// IMP=0x000000010002c814
- (void)dealloc;	// IMP=0x000000010002c744
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x000000010002c04c
