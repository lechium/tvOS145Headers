...
- (void).cxx_destruct;	// IMP=0x00000001000617e0
...
- (void)shutdownStream;	// IMP=0x0000000100061584
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x00000001000614b4
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0000000100060d54
- (id)headerForData:(id)arg1;	// IMP=0x0000000100060c78
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010006087c
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x00000001000606c4
