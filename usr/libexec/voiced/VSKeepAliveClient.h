...
- (void).cxx_destruct;	// IMP=0x00000001000182c0
- (oneway void)cancel;	// IMP=0x0000000100018230
- (oneway void)maintainWithAudioType:(long long)arg1 keepAudioSessionActive:(_Bool)arg2;	// IMP=0x0000000100018158
- (_Bool)_shouldChangeAudioSession;	// IMP=0x0000000100018138
- (void)setManager:(id)arg1;	// IMP=0x000000010001812c
- (void)dealloc;	// IMP=0x00000001000180b0
