...
- (void).cxx_destruct;	// IMP=0x00000001000ed16c
...
- (id)description;	// IMP=0x00000001000ecefc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000ec890
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x00000001000ec724
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x00000001000ed1a8
