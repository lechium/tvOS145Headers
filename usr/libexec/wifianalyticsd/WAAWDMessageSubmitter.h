...
- (void).cxx_destruct;	// IMP=0x0000000100027968
...
- (id)submitMessage:(id)arg1;	// IMP=0x00000001000273a4
@property(retain, nonatomic) NSArray *configuredMetricIDs;
@property(retain, nonatomic) NSArray *interestedMetricIDs;
- (void)iterateConfigChange;	// IMP=0x0000000100026d1c
- (id)initWithMessageGroupType:(long long)arg1 andConfigChangeDelegate:(id)arg2 onQueue:(id)arg3;	// IMP=0x000000010002684c
- (id)init;	// IMP=0x000000010002679c
