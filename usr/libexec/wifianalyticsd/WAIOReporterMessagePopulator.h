...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100019690
+ (id)getInterfaceNameTempFile;	// IMP=0x0000000100019234
+ (id)getIORPopAvailabeIOReportersTempFile;	// IMP=0x00000001000191c8
- (void).cxx_destruct;	// IMP=0x000000010001a1a4
...
- (void)persistCachedMessage;	// IMP=0x00000001000199f4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000197b4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100019698
- (void)_clearIOReporterCache;	// IMP=0x0000000100019544
- (void)_removePersistenceFile;	// IMP=0x00000001000192ac
- (id)getInfraInterfaceName;	// IMP=0x00000001000192a0
- (void)_prepopulateMessage:(id)arg1 forProcess:(id)arg2 groupType:(long long)arg3 andReply:(CDUnknownBlockType)arg4 isResubscribe:(_Bool)arg5;	// IMP=0x00000001000167cc
- (void)prepopulateMessage:(id)arg1 forProcess:(id)arg2 groupType:(long long)arg3 andReply:(CDUnknownBlockType)arg4;	// IMP=0x00000001000167bc
- (_Bool)doesMessageNeedPrepopulation:(id)arg1;	// IMP=0x0000000100016778
- (id)determineChannelsPerIORPopulatable;	// IMP=0x0000000100014e3c
- (id)_getDriverServiceDictionary;	// IMP=0x0000000100014e20
- (id)init;	// IMP=0x0000000100014d68
