...
+ (id)getAllGeoTagsFromMOC:(id)arg1;	// IMP=0x00000001001294ac
+ (id)copyFetchRequest;	// IMP=0x00000001001291b0
+ (id)fetchRequest;	// IMP=0x00000001001306d4
- (void)updateWithLocation:(id)arg1 bssid:(id)arg2;	// IMP=0x0000000100129314
- (double)getDistanceFromLocation:(id)arg1;	// IMP=0x00000001001291dc
