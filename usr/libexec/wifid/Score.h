...
+ (id)generateNewScoreObjectFromMOC:(id)arg1;	// IMP=0x0000000100128c70
+ (id)copyFetchRequest;	// IMP=0x0000000100128c44
+ (id)fetchRequest;	// IMP=0x0000000100130728
- (void)updateScoreForSwitch:(_Bool)arg1;	// IMP=0x00000001001290ec
- (_Bool)checkIncrementForOverflowWithMuliplier:(long long)arg1 multiplier:(long long)arg2;	// IMP=0x00000001001290e4
- (id)copyScoreLog;	// IMP=0x0000000100128fac
- (long long)getTotalScore;	// IMP=0x0000000100128de4
