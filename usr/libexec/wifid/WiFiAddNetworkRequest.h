...
- (void)setNetworkMatchingPrefix:(struct __WiFiNetwork *)arg1;	// IMP=0x00000001000af7c0
- (void)dealloc;	// IMP=0x00000001000af748
- (struct __CFDictionary *)_createAlertDictionary;	// IMP=0x00000001000af434
- (id)initWithClient:(struct __WiFiClient *)arg1 network:(struct __WiFiNetwork *)arg2 bundleId:(id)arg3 localizedAppName:(id)arg4 originator:(int)arg5 poweredOff:(_Bool)arg6 wapi:(_Bool)arg7 sessionBased:(_Bool)arg8 useSSIDPrefix:(_Bool)arg9 callback:(CDUnknownFunctionPointerType)arg10 context:(void *)arg11;	// IMP=0x00000001000af2a8
- (id)init;	// IMP=0x00000001000af270
