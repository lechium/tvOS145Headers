...
- (void)blacklistDidUpdate;	// IMP=0x000000010013066c
- (_Bool)isUserModeInteractive;	// IMP=0x000000010013064c
- (_Bool)retrieveBatteryInfo:(_Bool *)arg1 batteryLevel:(unsigned int *)arg2;	// IMP=0x0000000100130514
- (void)dealloc;	// IMP=0x00000001001304cc
- (id)initWithArgs:(struct __WiFiDeviceManager *)arg1;	// IMP=0x0000000100130380
