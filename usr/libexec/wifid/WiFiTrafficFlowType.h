...
- (_Bool)canTrigger11axPerfStudy;	// IMP=0x000000010012b91c
- (id)copyStringRepresentationWithFlowClassification:(unsigned int)arg1;	// IMP=0x000000010012b3cc
- (id)copyStringRepresentationWithFlowProperty:(unsigned int)arg1 flowPropertyString:(id)arg2;	// IMP=0x000000010012b254
- (void)processFlowClassifications:(unsigned int)arg1;	// IMP=0x000000010012af8c
- (void)processCombinedFlowProperties:(unsigned long long)arg1;	// IMP=0x000000010012ad80
- (void)dealloc;	// IMP=0x000000010012ad30
- (id)initWithType:(_Bool)arg1;	// IMP=0x000000010012acb8
