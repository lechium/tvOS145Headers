...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100039104
- (unsigned long long)hash;	// IMP=0x00000001000390f4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003908c
- (_Bool)isEqualToLogItemRequestInternal:(id)arg1;	// IMP=0x0000000100039050
- (id)description;	// IMP=0x0000000100038e10
- (void)dealloc;	// IMP=0x0000000100038da0
