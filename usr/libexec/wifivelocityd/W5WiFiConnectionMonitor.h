...
- (void)resumeMonitoringAfterDelay:(double)arg1;	// IMP=0x00000001000188ac
- (void)pauseMonitoring;	// IMP=0x0000000100018804
- (void)stopMonitoring;	// IMP=0x0000000100018758
- (void)startMonitoring;	// IMP=0x00000001000186a8
- (id)__followupTests;	// IMP=0x0000000100018574
- (id)__initialTests;	// IMP=0x0000000100018458
- (void)__runDiagnosticsTests:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000010001813c
- (void)dealloc;	// IMP=0x0000000100017fe8
- (id)init;	// IMP=0x0000000100017fb0
- (id)initWithStatusManager:(id)arg1 diagnosticsManager:(id)arg2;	// IMP=0x0000000100017950
